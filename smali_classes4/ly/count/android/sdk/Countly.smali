...
.field public static final COUNTLY_SDK_VERSION_STRING:Ljava/lang/String; = "18.08.1"
...
.method private doPushConsentSpecialAction(Z)V
    ...
    const-string v2, "Doing push consent special action: ["
...
.method public static onCreate(Landroid/app/Activity;)V
    ...
    const-string v2, "Data in activity created intent: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v2, " (appLaunchDeepLink "
    ...
    iget-boolean v2, v2, Lly/count/android/sdk/Countly;->appLaunchDeepLink:Z
...
.method private reportViewDuration()V
    ...
    const-string v2, "Last view start value is not normal: ["
...
.method public addAppCrawlerName(Ljava/lang/String;)V
    ...
    const-string v2, "Adding app crawler name: ["
...
.method public changeDeviceId(Ljava/lang/String;)V
    ...
    const-string v1, "Changing device ID"
    ...
    const-string v0, "Can\'t change Device ID if no consent is given"
...
.method public changeDeviceId(Lly/count/android/sdk/DeviceId$Type;Ljava/lang/String;)V
    ...
    const-string p2, "Can\'t change Device ID if no consent is given"
...
.method public clearAutomaticStarRatingSessionCount()V
    ...
    const-string v1, "Clearing star rating session count"
...
.method public declared-synchronized init(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lly/count/android/sdk/DeviceId$Type;ILly/count/android/sdk/CountlyStarRating$RatingCallback;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lly/count/android/sdk/Countly;
    ...
    const-string v2, "Initializing Countly SDk version 18.08.1"
...
.method public declared-synchronized initMessaging(Landroid/app/Activity;Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;Lly/count/android/sdk/Countly$CountlyMessagingMode;ZIII)Lly/count/android/sdk/Countly;
    ...
    :try_start_0
    const-string v3, "ly.count.android.sdk.messaging.CountlyPush"
    ...
    const-string v4, "Please remove initMessaging() call, for FCM integration you need to use CountlyPush class"
    ...
    const-string v3, "you need to include sdk-messaging library instead of sdk if you want to use Countly Messaging"
    ...
    .line 533
    :cond_0
    iput-object v2, v1, Lly/count/android/sdk/Countly;->messagingMode_:Lly/count/android/sdk/Countly$CountlyMessagingMode;
    ...
    iget-boolean v2, v1, Lly/count/android/sdk/Countly;->addMetadataToPushIntents:Z
    ...
    invoke-static/range {v4 .. v12}, Lly/count/android/sdk/MessagingAdapter;->init(Landroid/app/Activity;Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/Boolean;II)Z
    ...
    const-string v3, "couldn\'t initialize Countly Messaging"
    ...
    invoke-virtual {v2}, Lly/count/android/sdk/ConnectionQueue;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v3, v1, Lly/count/android/sdk/Countly;->connectionQueue_:Lly/count/android/sdk/ConnectionQueue;

    invoke-virtual {v3}, Lly/count/android/sdk/ConnectionQueue;->getServerURL()Ljava/lang/String;

    move-result-object v3

    iget-object v4, v1, Lly/count/android/sdk/Countly;->connectionQueue_:Lly/count/android/sdk/ConnectionQueue;

    invoke-virtual {v4}, Lly/count/android/sdk/ConnectionQueue;->getAppKey()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lly/count/android/sdk/DeviceId;->getId()Ljava/lang/String;

    move-result-object v5

    iget-object v6, v1, Lly/count/android/sdk/Countly;->connectionQueue_:Lly/count/android/sdk/ConnectionQueue;

    invoke-virtual {v6}, Lly/count/android/sdk/ConnectionQueue;->getDeviceId()Lly/count/android/sdk/DeviceId;

    move-result-object v6

    invoke-virtual {v6}, Lly/count/android/sdk/DeviceId;->getType()Lly/count/android/sdk/DeviceId$Type;

    move-result-object v6

    invoke-static {v2, v3, v4, v5, v6}, Lly/count/android/sdk/MessagingAdapter;->storeConfiguration(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lly/count/android/sdk/DeviceId$Type;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized recordEvent(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;IDD)V
    ...
    .line 836
    :try_start_0
    invoke-virtual {v1}, Lly/count/android/sdk/Countly;->isInitialized()Z
    ...
    const-string v3, "Countly.sharedInstance().init must be called before recordEvent"
    ...
    const-string v3, "Countly event count should be greater than zero"
    ...
    const-string v10, "Recording event with key: ["
    ...
    const-string v3, "Countly event segmentation value cannot be null or empty"
    ...
    const-string v3, "Countly event segmentation key cannot be null or empty"
    ...
    const-string v3, "Countly event segmentation value cannot be null"
    ...
    :cond_11
    const-string v2, "[CLY]_star_rating"
    ...
    invoke-virtual {v2, v8}, Lly/count/android/sdk/Countly;->getConsent(Ljava/lang/String;)Z
    ...
    .line 893
    invoke-virtual {v1}, Lly/count/android/sdk/Countly;->sendEventsForced()V
    ...
    .line 899
    invoke-virtual {v1}, Lly/count/android/sdk/Countly;->sendEventsIfNeeded()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v3, "Valid Countly event key is required"
...
.method public declared-synchronized setConsent([Ljava/lang/String;Z)Lly/count/android/sdk/Countly;
    ...
    .line 2184
    :cond_8
    iput-boolean v11, p0, Lly/count/android/sdk/Countly;->delayedLocationErasure:Z
...
.method public declared-synchronized showFeedbackPopup(Ljava/lang/String;Ljava/lang/String;Landroid/app/Activity;Lly/count/android/sdk/CountlyStarRating$FeedbackRatingCallback;)Lly/count/android/sdk/Countly;
    ...
    invoke-static/range {v0 .. v5}, Lly/count/android/sdk/CountlyStarRating;->showFeedbackPopup(Ljava/lang/String;Ljava/lang/String;Landroid/app/Activity;Lly/count/android/sdk/Countly;Lly/count/android/sdk/ConnectionQueue;Lly/count/android/sdk/CountlyStarRating$FeedbackRatingCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
