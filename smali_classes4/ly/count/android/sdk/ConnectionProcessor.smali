...
.method protected static sha1Hash(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
...
.method public run()V
    ...
    .line 198
    iget-object v5, p0, Lly/count/android/sdk/ConnectionProcessor;->deviceId_:Lly/count/android/sdk/DeviceId;
    ...
    invoke-static {v5}, Lly/count/android/sdk/ConnectionProcessor;->urlEncodeString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lly/count/android/sdk/ConnectionProcessor;->store_:Lly/count/android/sdk/CountlyStore;

    invoke-virtual {v0, v2, v3}, Lly/count/android/sdk/DeviceId;->changeToDeveloperProvidedId(Lly/count/android/sdk/CountlyStore;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lly/count/android/sdk/CountlyStore;->removeConnection(Ljava/lang/String;)V
    :try_end_2
...
.method urlConnectionForEventData(Ljava/lang/String;)Ljava/net/URLConnection;
    ...
    sget-object v3, Lly/count/android/sdk/ConnectionProcessor;->salt:Ljava/lang/String;
    ...
    .line 82
    iget-object v3, p0, Lly/count/android/sdk/ConnectionProcessor;->sslContext_:Ljavax/net/ssl/SSLContext;
    ...
    .line 90
    invoke-static {v1}, Lly/count/android/sdk/UserData;->getPicturePathFromQuery(Ljava/net/URL;)Ljava/lang/String;
    ...
    const-string v7, "Got picturePath: "
    ...
    const-string v7, "Is the HTTP POST forced: "
    ...
    invoke-virtual {v7}, Lly/count/android/sdk/Countly;->isHttpPostForced()Z
    ...
    invoke-direct {v8, v6, v5}, Ljava/io/OutputStreamWriter;-><init>(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    .line 122
    invoke-virtual {v6, p1, v3, v5}, Ljava/io/OutputStream;->write([BII)V
    :try_end_0
