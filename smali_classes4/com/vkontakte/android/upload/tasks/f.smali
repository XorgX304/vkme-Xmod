.class public final Lcom/vkontakte/android/upload/tasks/f;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/upload/tasks/f$a;
    }
.end annotation
...
.method public constructor <init>(Ljava/lang/String;I)V
    ...
    iput p2, p0, Lcom/vkontakte/android/upload/tasks/f;->g:I

    return-void
.end method

.method public static final synthetic a(Lcom/vkontakte/android/upload/tasks/f;)I
    .locals 0

    .line 15
    iget p0, p0, Lcom/vkontakte/android/upload/tasks/f;->g:I
...
.method public bridge synthetic a(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/upload/tasks/f;->a(Lcom/vkontakte/android/attachments/GraffitiAttachment;)V
...
.method public a(Lcom/vkontakte/android/attachments/GraffitiAttachment;)V
    ...
    .line 64
    iget-object p1, p0, Lcom/vkontakte/android/upload/tasks/f;->b:Ljava/lang/String;
...
.method public a(Ljava/lang/String;)V
    ...
    .line 31
    :try_start_0
    invoke-super {p0, p1}, Lcom/vkontakte/android/upload/tasks/g;->a(Ljava/lang/String;)V
    :try_end_0
    ...
    .line 34
    invoke-virtual {p0}, Lcom/vkontakte/android/upload/tasks/f;->k()Ljava/lang/String;
...
.method protected b(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/vkontakte/android/upload/tasks/f;->f:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public k()Ljava/lang/String;
    ...
    iget v1, p0, Lcom/vkontakte/android/upload/tasks/f;->g:I
...
.method public synthetic l()Landroid/os/Parcelable;
    ...
    .line 15
    invoke-virtual {p0}, Lcom/vkontakte/android/upload/tasks/f;->r()Lcom/vkontakte/android/attachments/GraffitiAttachment;
...
.method public r()Lcom/vkontakte/android/attachments/GraffitiAttachment;
    .locals 4

    .line 51
    iget-object v0, p0, Lcom/vkontakte/android/upload/tasks/f;->f:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/vkontakte/android/upload/tasks/f;->f:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v0, v2}, Lcom/vkontakte/android/api/d/f$b;->b(Ljava/lang/String;)Lcom/vkontakte/android/api/d/f;
    ...
    check-cast v0, Lcom/vkontakte/android/api/d/i;

    if-eqz v0, :cond_2

    .line 54
    invoke-virtual {v0}, Lcom/vkontakte/android/api/d/i;->a()Lcom/vkontakte/android/api/Document;

    move-result-object v0

    .line 55
    iget v1, v0, Lcom/vkontakte/android/api/Document;->a:I

    iget v2, v0, Lcom/vkontakte/android/api/Document;->b:I

    iget-object v3, p0, Lcom/vkontakte/android/upload/tasks/g;->b:Ljava/lang/String;
    ...
    invoke-direct {v1, v0}, Lcom/vkontakte/android/attachments/GraffitiAttachment;-><init>(Lcom/vkontakte/android/api/Document;)V
