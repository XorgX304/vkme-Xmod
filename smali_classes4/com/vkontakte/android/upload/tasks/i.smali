.class public final Lcom/vkontakte/android/upload/tasks/i;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/upload/tasks/i$a;
    }
.end annotation
...
.method protected b(Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/vkontakte/android/upload/tasks/i;->g:Lcom/vkontakte/android/upload/h$g;
    :try_end_0
...
.method public k()Ljava/lang/String;
    ...
    .line 16
    new-instance v0, Lcom/vkontakte/android/api/photos/p;

    invoke-direct {v0}, Lcom/vkontakte/android/api/photos/p;-><init>()V
...
.method public synthetic l()Landroid/os/Parcelable;
    ...
    .line 12
    invoke-virtual {p0}, Lcom/vkontakte/android/upload/tasks/i;->r()Lcom/vkontakte/android/attachments/PhotoAttachment;
...
.method public r()Lcom/vkontakte/android/attachments/PhotoAttachment;
    ...
    .line 30
    iget-object v0, p0, Lcom/vkontakte/android/upload/tasks/i;->g:Lcom/vkontakte/android/upload/h$g;
    ...
    .line 31
    new-instance v0, Lcom/vkontakte/android/api/photos/ab;

    iget-object v2, p0, Lcom/vkontakte/android/upload/tasks/i;->g:Lcom/vkontakte/android/upload/h$g;
    ...
    :cond_0
    iget-object v2, v2, Lcom/vkontakte/android/upload/h$g;->a:Ljava/lang/String;

    iget-object v3, p0, Lcom/vkontakte/android/upload/tasks/i;->g:Lcom/vkontakte/android/upload/h$g;
    ...
    :cond_1
    iget-object v3, v3, Lcom/vkontakte/android/upload/h$g;->b:Ljava/lang/String;

    iget-object v4, p0, Lcom/vkontakte/android/upload/tasks/i;->g:Lcom/vkontakte/android/upload/h$g;
    ...
    :cond_2
    iget-object v4, v4, Lcom/vkontakte/android/upload/h$g;->c:Ljava/lang/String;

    invoke-direct {v0, v2, v3, v4}, Lcom/vkontakte/android/api/photos/ab;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
