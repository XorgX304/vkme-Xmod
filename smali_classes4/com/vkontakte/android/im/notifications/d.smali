...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/vkontakte/android/im/notifications/d;->b:Ljava/util/concurrent/ScheduledExecutorService;

    return-void
.end method

.method private final a(Lcom/vkontakte/android/im/notifications/h;)Lcom/vk/pushes/messages/url/MessageNotification$MessageNotificationContainer;
    .locals 14
    ...
    .line 127
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->c()Ljava/lang/String;

    move-result-object v1

    .line 128
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->d()Ljava/lang/String;

    move-result-object v2

    .line 129
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->i()Z
    ...
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->a()I
    ...
    .line 132
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->e()Ljava/lang/String;
    ...
    .line 134
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->b()I
    ...
    invoke-static {v0}, Lcom/vkontakte/android/im/m;->a(I)Z
    ...
    .line 137
    invoke-virtual {p1}, Lcom/vkontakte/android/im/notifications/h;->j()Z
...
.method private final a(Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V
    .locals 4
    ...
    .line 78
    :try_start_0
    iget-boolean v0, p0, Lcom/vkontakte/android/im/notifications/d;->c:Z
    :try_end_0
    ...
    .line 85
    invoke-direct {p0, p2}, Lcom/vkontakte/android/im/notifications/d;->a(Lcom/vkontakte/android/im/notifications/h;)Lcom/vk/pushes/messages/url/MessageNotification$MessageNotificationContainer;
    ...
    invoke-virtual {p2}, Lcom/vkontakte/android/im/notifications/h;->f()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lcom/vk/pushes/a/b;->a(Lcom/vk/pushes/messages/url/MessageNotification$MessageNotificationContainer;Ljava/lang/String;)V
    ...
    .line 90
    sget-object v0, Lcom/vkontakte/android/im/m;->a:Lcom/vkontakte/android/im/m;

    invoke-virtual {v0}, Lcom/vkontakte/android/im/m;->a()Z
    ...
    .line 91
    :goto_0
    iget-object v2, p0, Lcom/vkontakte/android/im/notifications/d;->b:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v3, Lcom/vkontakte/android/im/notifications/d$c;

    invoke-direct {v3, p0, p1, p2}, Lcom/vkontakte/android/im/notifications/d$c;-><init>(Lcom/vkontakte/android/im/notifications/d;Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V
...
.method public static final synthetic a(Lcom/vkontakte/android/im/notifications/d;Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V
    .locals 0

    .line 33
    invoke-direct {p0, p1, p2}, Lcom/vkontakte/android/im/notifications/d;->a(Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V

    return-void
.end method

.method public static final synthetic a(Lcom/vkontakte/android/im/notifications/d;Ljava/lang/Throwable;)V
    .locals 0

    .line 33
    invoke-direct {p0, p1}, Lcom/vkontakte/android/im/notifications/d;->a(Ljava/lang/Throwable;)V
...
.method private final a(Landroid/content/Context;I)Z
    ...
    .line 197
    :goto_1
    invoke-static {p1, p2}, Lcom/vkontakte/android/NotificationUtils;->b(Landroid/content/Context;Lcom/vkontakte/android/NotificationUtils$Type;)Z
...
.method private final b(Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V
    .locals 3
    ...
    invoke-virtual {v0, v1}, Lcom/vk/pushes/a/b;->a(Ljava/lang/Integer;)Ljava/util/List;
    ...
    .line 117
    invoke-virtual {p2}, Lcom/vkontakte/android/im/notifications/h;->h()Z

    move-result v2

    if-eqz v2, :cond_1

    new-instance v2, Lcom/vk/pushes/messages/url/b;

    invoke-virtual {p2}, Lcom/vkontakte/android/im/notifications/h;->g()Landroid/graphics/Bitmap;

    move-result-object p2

    invoke-direct {v2, p1, v1, p2, v0}, Lcom/vk/pushes/messages/url/b;-><init>(Landroid/content/Context;Lcom/vk/pushes/messages/url/MessageNotification$MessageNotificationContainer;Landroid/graphics/Bitmap;Ljava/util/List;)V
...
.method public static final synthetic b(Lcom/vkontakte/android/im/notifications/d;Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V
    .locals 0

    .line 33
    invoke-direct {p0, p1, p2}, Lcom/vkontakte/android/im/notifications/d;->b(Landroid/content/Context;Lcom/vkontakte/android/im/notifications/h;)V
...
.method private final c(Landroid/content/Context;Lcom/vk/im/engine/d;II)Lcom/vkontakte/android/im/notifications/h;
    ...
    .line 143
    invoke-direct {p0, p3}, Lcom/vkontakte/android/im/notifications/d;->a(I)Z
    ...
    .line 147
    :cond_0
    invoke-direct {p0}, Lcom/vkontakte/android/im/notifications/d;->b()Z

    move-result v0

    .line 148
    invoke-direct {p0, p1, p3}, Lcom/vkontakte/android/im/notifications/d;->a(Landroid/content/Context;I)Z
    ...
    invoke-virtual {v0, v2, v3}, Lcom/vkontakte/android/im/bridge/contentprovider/e;->a(Ljava/lang/String;I)Z
...
.method public final declared-synchronized a()V
    ...
    .line 66
    :try_start_0
    iput-boolean v0, p0, Lcom/vkontakte/android/im/notifications/d;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Landroid/content/Context;Lcom/vk/im/engine/d;II)V
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lcom/vkontakte/android/im/notifications/d;->a:Ljava/util/concurrent/ExecutorService;

    new-instance v7, Lcom/vkontakte/android/im/notifications/d$a;
...
.method public final b(Landroid/content/Context;Lcom/vk/im/engine/d;II)V
    ...
    new-instance v7, Lcom/vkontakte/android/im/notifications/d$b;
