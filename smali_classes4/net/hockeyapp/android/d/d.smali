.class public Lnet/hockeyapp/android/d/d;
...
.method synthetic constructor <init>(Lnet/hockeyapp/android/d/d$1;)V
    .locals 0
...
.method public static a()Lnet/hockeyapp/android/d/d;
    .locals 1

    .line 38
    sget-object v0, Lnet/hockeyapp/android/d/d$a;->a:Lnet/hockeyapp/android/d/d;
...
.method public a(Ljava/lang/String;)Lnet/hockeyapp/android/objects/FeedbackResponse;
    ...
    :try_start_3
    const-string v4, "Failed to parse \"name\" in feedback response"

    .line 128
    invoke-static {v4, v2}, Lnet/hockeyapp/android/d/e;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :try_start_5
    const-string v4, "Failed to parse \"email\" in feedback response"
    ...
    :try_start_7
    const-string v4, "Failed to parse \"id\" in feedback response"
    ...
    :try_start_9
    const-string v3, "Failed to parse \"created_at\" in feedback response"
    ...
    :try_start_d
    const-string v4, "Failed to parse \"status\" in feedback response"

    .line 154
    invoke-static {v4, v1}, Lnet/hockeyapp/android/d/e;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_d
    ...
    :try_start_f
    const-string v3, "Failed to parse \"token\" in feedback response"

    .line 161
    invoke-static {v3, v1}, Lnet/hockeyapp/android/d/e;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_f
    ...
    :goto_b
    const-string v3, "Failed to parse feedback response"
