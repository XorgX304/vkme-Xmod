...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/net/Uri;Z)V
    ...
    .line 74
    iput-object p2, p0, Lnet/hockeyapp/android/views/a;->c:Lnet/hockeyapp/android/objects/FeedbackAttachment;

    .line 75
    iput-object p3, p0, Lnet/hockeyapp/android/views/a;->d:Landroid/net/Uri;

    .line 76
    invoke-static {p1, p3}, Lnet/hockeyapp/android/d/m;->a(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object p2

    iput-object p2, p0, Lnet/hockeyapp/android/views/a;->e:Ljava/lang/String;

    const/16 p2, 0xa

    .line 78
    invoke-direct {p0, p2}, Lnet/hockeyapp/android/views/a;->a(I)V

    .line 79
    invoke-direct {p0, p1, p4}, Lnet/hockeyapp/android/views/a;->a(Landroid/content/Context;Z)V

    .line 81
    iget-object p1, p0, Lnet/hockeyapp/android/views/a;->g:Landroid/widget/TextView;

    iget-object p2, p0, Lnet/hockeyapp/android/views/a;->e:Ljava/lang/String;
    ...
    iget-object p2, p0, Lnet/hockeyapp/android/views/a;->g:Landroid/widget/TextView;
    ...
    .line 84
    new-instance p1, Lnet/hockeyapp/android/views/a$1;

    invoke-direct {p1, p0}, Lnet/hockeyapp/android/views/a$1;-><init>(Lnet/hockeyapp/android/views/a;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Lnet/hockeyapp/android/objects/FeedbackAttachment;Z)V
    ...
    .line 107
    iput-object p3, p0, Lnet/hockeyapp/android/views/a;->c:Lnet/hockeyapp/android/objects/FeedbackAttachment;

    const/4 p2, 0x0

    .line 108
    iput-object p2, p0, Lnet/hockeyapp/android/views/a;->d:Landroid/net/Uri;
    ...
    .line 114
    iput p1, p0, Lnet/hockeyapp/android/views/a;->m:I

    .line 115
    iget-object p1, p0, Lnet/hockeyapp/android/views/a;->g:Landroid/widget/TextView;

    sget p2, Lnet/hockeyapp/android/i$d;->hockeyapp_feedback_attachment_loading:I
...
.method private a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Lnet/hockeyapp/android/views/a;->a:Landroid/content/Context;
...
.method private a(I)V
    ...
    iput v2, p0, Lnet/hockeyapp/android/views/a;->l:I
    ...
    .line 183
    iget p1, p0, Lnet/hockeyapp/android/views/a;->l:I
    ...
    iput p1, p0, Lnet/hockeyapp/android/views/a;->h:I
    ...
    .line 191
    iget p1, p0, Lnet/hockeyapp/android/views/a;->h:I

    mul-int/lit8 p1, p1, 0x2

    iput p1, p0, Lnet/hockeyapp/android/views/a;->i:I

    .line 193
    iget p1, p0, Lnet/hockeyapp/android/views/a;->j:I

    iput p1, p0, Lnet/hockeyapp/android/views/a;->k:I
...
.method private a(Landroid/content/Context;Z)V
    ...
    invoke-virtual {p0, v3, v0, v3, v3}, Lnet/hockeyapp/android/views/a;->setPadding(IIII)V

    .line 202
    iget-object v0, p0, Lnet/hockeyapp/android/views/a;->b:Landroid/view/ViewGroup;

    iget-object v4, p0, Lnet/hockeyapp/android/views/a;->a:Landroid/content/Context;

    sget v5, Lnet/hockeyapp/android/i$d;->hockeyapp_feedback_attachment_added:I

    invoke-virtual {v4, v5}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v0, v4}, Lnet/hockeyapp/android/d/m;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iput-object v6, p0, Lnet/hockeyapp/android/views/a;->g:Landroid/widget/TextView;

    .line 217
    iget-object v6, p0, Lnet/hockeyapp/android/views/a;->g:Landroid/widget/TextView;
    ...
    .line 232
    sget v1, Lnet/hockeyapp/android/i$d;->hockeyapp_feedback_attachment_remove_description:I
    ...
    .line 233
    new-instance p1, Lnet/hockeyapp/android/views/a$2;

    invoke-direct {p1, p0}, Lnet/hockeyapp/android/views/a$2;-><init>(Lnet/hockeyapp/android/views/a;)V

    invoke-virtual {p2, p1}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 239
    new-instance p1, Lnet/hockeyapp/android/views/a$3;

    invoke-direct {p1, p0}, Lnet/hockeyapp/android/views/a$3;-><init>(Lnet/hockeyapp/android/views/a;)V
    ...
    .line 252
    iget-object p1, p0, Lnet/hockeyapp/android/views/a;->f:Landroid/widget/ImageView;

    invoke-virtual {p0, p1}, Lnet/hockeyapp/android/views/a;->addView(Landroid/view/View;)V
...
.method private a(Landroid/graphics/Bitmap;Z)V
    ...
    new-instance v0, Lnet/hockeyapp/android/views/a$4;

    invoke-direct {v0, p0, p2}, Lnet/hockeyapp/android/views/a$4;-><init>(Lnet/hockeyapp/android/views/a;Z)V
...
.method private a(Z)V
    ...
    new-instance v1, Lnet/hockeyapp/android/views/a$5;

    invoke-direct {v1, p0, p1}, Lnet/hockeyapp/android/views/a$5;-><init>(Lnet/hockeyapp/android/views/a;Z)V
...
.method static synthetic b(Lnet/hockeyapp/android/views/a;)Landroid/widget/TextView;
    .locals 0

    .line 36
    iget-object p0, p0, Lnet/hockeyapp/android/views/a;->g:Landroid/widget/TextView;
...
.method private c()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1}, Lnet/hockeyapp/android/d/g;->a(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-static {v2, v3, v0, v1}, Lnet/hockeyapp/android/d/g;->a(Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
...
.method static synthetic c(Lnet/hockeyapp/android/views/a;)Landroid/net/Uri;
    .locals 0

    .line 36
    iget-object p0, p0, Lnet/hockeyapp/android/views/a;->d:Landroid/net/Uri;

    return-object p0
.end method

.method static synthetic d(Lnet/hockeyapp/android/views/a;)Landroid/content/Context;
    .locals 0

    .line 36
    iget-object p0, p0, Lnet/hockeyapp/android/views/a;->a:Landroid/content/Context;
...
.method public a()V
    ...
    sget v2, Lnet/hockeyapp/android/i$d;->hockeyapp_feedback_attachment_removed:I

    invoke-virtual {v1, v2}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Lnet/hockeyapp/android/d/m;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public a(Landroid/graphics/Bitmap;I)V
    ...
    .line 163
    invoke-direct {p0, p2}, Lnet/hockeyapp/android/views/a;->a(Z)V
...
.method public getAttachment()Lnet/hockeyapp/android/objects/FeedbackAttachment;
    ...
    .line 121
    iget-object v0, p0, Lnet/hockeyapp/android/views/a;->c:Lnet/hockeyapp/android/objects/FeedbackAttachment;
