...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 662
    invoke-direct {p0, p1}, Lfr/castorflex/android/smoothprogressbar/c$a;->a(Landroid/content/Context;)V
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lfr/castorflex/android/smoothprogressbar/c$a;->a:Landroid/view/animation/Interpolator;

    .line 690
    sget v0, Lcom/vk/q/a$e;->spb_default_sections_count:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v0

    iput v0, p0, Lfr/castorflex/android/smoothprogressbar/c$a;->b:I
    ...
    sget v1, Lcom/vk/q/a$c;->spb_default_color:I
    ...
    .line 692
    sget v0, Lcom/vk/q/a$f;->spb_default_speed:I
    ...
    .line 695
    sget v0, Lcom/vk/q/a$b;->spb_default_reversed:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Lfr/castorflex/android/smoothprogressbar/c$a;->g:Z

    .line 696
    sget v0, Lcom/vk/q/a$d;->spb_default_stroke_separator_length:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lfr/castorflex/android/smoothprogressbar/c$a;->j:I

    .line 697
    sget v0, Lcom/vk/q/a$d;->spb_default_stroke_width:I
    ...
    .line 698
    sget v0, Lcom/vk/q/a$b;->spb_default_progressiveStart_activated:I
    ...
    .line 699
    iput-boolean v2, p0, Lfr/castorflex/android/smoothprogressbar/c$a;->m:Z
...
.method public a()Lfr/castorflex/android/smoothprogressbar/c;
    ...
    iget-object v3, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->a:Landroid/view/animation/Interpolator;

    iget v4, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->b:I

    iget v5, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->j:I

    iget-object v6, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->c:[I

    iget v7, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->i:F

    iget v8, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->d:F

    iget v9, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->e:F

    iget v10, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->f:F

    iget-boolean v11, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->g:Z

    iget-boolean v12, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->h:Z

    iget-object v13, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->o:Lfr/castorflex/android/smoothprogressbar/c$b;

    iget-boolean v14, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->k:Z

    iget-object v15, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->n:Landroid/graphics/drawable/Drawable;

    iget-boolean v2, v0, Lfr/castorflex/android/smoothprogressbar/c$a;->m:Z
    ...
    invoke-direct/range {v2 .. v17}, Lfr/castorflex/android/smoothprogressbar/c;-><init>(Landroid/view/animation/Interpolator;II[IFFFFZZLfr/castorflex/android/smoothprogressbar/c$b;ZLandroid/graphics/drawable/Drawable;ZLfr/castorflex/android/smoothprogressbar/c$1;)V
