...
.method protected a(Landroid/support/v4/app/x$c;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/app/x$c;->b(Z)Landroid/support/v4/app/x$c;

    invoke-virtual {p1, v2}, Landroid/support/v4/app/x$c;->b(I)Landroid/support/v4/app/x$c;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Landroid/support/v4/app/x$c;->e(Z)Landroid/support/v4/app/x$c;

    const-string v0, "msg"

    invoke-virtual {p1, v0}, Landroid/support/v4/app/x$c;->a(Ljava/lang/String;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/app/x$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/x$c;

    invoke-virtual {p1, v3, v2, v2}, Landroid/support/v4/app/x$c;->a(III)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {p1, v3, v0, v0}, Landroid/support/v4/app/x$c;->a(III)Landroid/support/v4/app/x$c;
...
.method protected abstract c()Landroid/support/v4/app/x$c;
.end method
