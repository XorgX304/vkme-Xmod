...
.method protected final a(Landroid/support/v4/app/x$c;)V
    .locals 5

    invoke-super {p0, p1}, Lru/mail/libverify/notifications/e;->a(Landroid/support/v4/app/x$c;)V
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;

    iget-object v3, v0, Lru/mail/libverify/gcm/ServerNotificationMessage$Message;->public_text:Ljava/lang/String;

    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;

    iget-object v3, v0, Lru/mail/libverify/gcm/ServerNotificationMessage$Message;->public_text:Ljava/lang/String;

    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->d(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/x$c;->a(J)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$c;

    sget v3, Lru/mail/libverify/R$drawable;->libverify_ic_sms_white:I

    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->a(I)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$c;
    ...
    new-instance v3, Landroid/support/v4/app/x$b;

    invoke-direct {v3}, Landroid/support/v4/app/x$b;-><init>()V

    iget-object v4, v0, Lru/mail/libverify/gcm/ServerNotificationMessage$Message;->public_text:Ljava/lang/String;

    invoke-virtual {v3, v4}, Landroid/support/v4/app/x$b;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$b;

    move-result-object v3

    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$c;->a(Landroid/support/v4/app/x$g;)Landroid/support/v4/app/x$c;

    invoke-virtual {v1}, Landroid/support/v4/app/x$c;->b()Landroid/app/Notification;

    move-result-object v1

    invoke-virtual {p1, v1}, Landroid/support/v4/app/x$c;->a(Landroid/app/Notification;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {p1, v1}, Landroid/support/v4/app/x$c;->d(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {p1, v3, v4}, Landroid/support/v4/app/x$c;->a(J)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {p1, v1}, Landroid/support/v4/app/x$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {p1, v1}, Landroid/support/v4/app/x$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$c;
    ...
    new-instance v1, Landroid/support/v4/app/x$b;

    invoke-direct {v1}, Landroid/support/v4/app/x$b;-><init>()V

    iget-object v0, v0, Lru/mail/libverify/gcm/ServerNotificationMessage$Message;->text:Ljava/lang/String;

    invoke-virtual {v1, v0}, Landroid/support/v4/app/x$b;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$b;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/support/v4/app/x$c;->a(Landroid/support/v4/app/x$g;)Landroid/support/v4/app/x$c;
...
.method protected final c()Landroid/support/v4/app/x$c;
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lru/mail/libverify/notifications/g;->a(Landroid/support/v4/app/x$c;)V
...
.method public final g()Ljava/lang/Long;
    ...
    const-string v14, "notification %s, local diff %d, server diff %d, ongoing timeout %d"
    ...
    invoke-static {v1, v14, v15}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
