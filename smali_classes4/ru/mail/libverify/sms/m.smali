...
.field private i:Landroid/support/v4/f/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lru/mail/libverify/sms/l;)V
    ...
    iput-object v0, p0, Lru/mail/libverify/sms/m;->i:Landroid/support/v4/f/f;
...
.method private a(J)Ljava/util/List;
    ...
    iget-object v0, p0, Lru/mail/libverify/sms/m;->i:Landroid/support/v4/f/f;
    ...
    iget-object p1, p0, Lru/mail/libverify/sms/m;->i:Landroid/support/v4/f/f;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/support/v4/f/f;->keyAt(I)J
    ...
    iget-object v2, p0, Lru/mail/libverify/sms/m;->i:Landroid/support/v4/f/f;

    iget-wide v3, v1, Lru/mail/libverify/sms/b;->a:J

    invoke-virtual {v2, v3, v4}, Landroid/support/v4/f/f;->get(J)Ljava/lang/Object;
...
.method private a(Landroid/net/Uri;)V
    ...
    invoke-virtual {v2, v0, v1}, Landroid/support/v4/f/f;->remove(J)V
    :try_end_0
...
.method private a(Lru/mail/libverify/sms/b;)V
    ...
    invoke-virtual {v0, v1, v2, p1}, Landroid/support/v4/f/f;->put(JLjava/lang/Object;)V
...
.method static synthetic a(Lru/mail/libverify/sms/m;J)V
    ...
    iget-object v1, p0, Lru/mail/libverify/sms/m;->i:Landroid/support/v4/f/f;

    invoke-virtual {v1}, Landroid/support/v4/f/f;->size()I

    move-result v1

    add-int/lit8 v1, v1, -0x1

    invoke-virtual {v0, v1}, Landroid/support/v4/f/f;->keyAt(I)J
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/f/f;->removeAt(I)V
