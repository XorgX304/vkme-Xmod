.class public Lcom/vk/notifications/d;
...
# static fields
.field public static final af:Lcom/vk/notifications/d$b;
...
.field private al:Lcom/vk/notifications/c;

.field private final am:Lcom/vk/notifications/l;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/vk/notifications/d$b;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/vk/notifications/d$b;-><init>(Lkotlin/jvm/internal/h;)V

    sput-object v0, Lcom/vk/notifications/d;->af:Lcom/vk/notifications/d$b;
...
.method public constructor <init>()V
    ...
    .line 49
    new-instance v0, Lcom/vk/notifications/l;

    invoke-direct {v0}, Lcom/vk/notifications/l;-><init>()V

    iput-object v0, p0, Lcom/vk/notifications/d;->am:Lcom/vk/notifications/l;

    const/4 v0, -0x1

    .line 51
    iput v0, p0, Lcom/vk/notifications/d;->an:I

    return-void
.end method

.method public static final synthetic a(Lcom/vk/notifications/d;)I
    .locals 0

    .line 31
    iget p0, p0, Lcom/vk/notifications/d;->an:I

    return p0
.end method

.method public static final synthetic a(Lcom/vk/notifications/d;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 0

    .line 31
    invoke-direct {p0, p1}, Lcom/vk/notifications/d;->a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method private final a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    new-instance v5, Lcom/vk/notifications/d$c;

    invoke-direct {v5, p0, v3}, Lcom/vk/notifications/d$c;-><init>(Lcom/vk/notifications/d;Lcom/vk/dto/notifications/NotificationItem;)V
...
.method public static final synthetic a(Lcom/vk/notifications/d;I)V
    .locals 0

    .line 31
    iput p1, p0, Lcom/vk/notifications/d;->an:I

    return-void
.end method

.method private final au()Lcom/vk/notifications/d$d;
    .locals 1

    .line 166
    new-instance v0, Lcom/vk/notifications/d$d;

    invoke-direct {v0, p0}, Lcom/vk/notifications/d$d;-><init>(Lcom/vk/notifications/d;)V

    return-object v0
.end method

.method public static final synthetic b(Lcom/vk/notifications/d;)Lcom/vk/notifications/l;
    .locals 0

    .line 31
    iget-object p0, p0, Lcom/vk/notifications/d;->am:Lcom/vk/notifications/l;
...
.method public B_()V
    ...
    iput-object v1, p0, Lcom/vk/notifications/d;->ag:Landroid/support/v7/widget/Toolbar;
    ...
    iput-object v1, p0, Lcom/vk/notifications/d;->ai:Lcom/vk/lists/RecyclerPaginatedView;

    .line 99
    move-object v1, v0

    check-cast v1, Lcom/vk/notifications/c;

    iput-object v1, p0, Lcom/vk/notifications/d;->al:Lcom/vk/notifications/c;

    .line 100
    iget-object v1, p0, Lcom/vk/notifications/d;->ah:Lcom/vk/lists/s;
    ...
    iput-object v0, p0, Lcom/vk/notifications/d;->ah:Lcom/vk/lists/s;
...
.method public I()V
    ...
    .line 186
    iget-object v0, p0, Lcom/vk/notifications/d;->am:Lcom/vk/notifications/l;
...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 62
    invoke-virtual {p0}, Lcom/vk/notifications/d;->l()Landroid/os/Bundle;
    ...
    invoke-virtual {p0, p3}, Lcom/vk/notifications/d;->c(I)Ljava/lang/String;

    move-result-object v1

    .line 64
    :cond_3
    iget-object p3, p0, Lcom/vk/notifications/d;->ag:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-direct {v2, p0}, Lcom/vk/notifications/GroupedNotificationsFragment$onCreateView$1;-><init>(Lcom/vk/notifications/d;)V
    ...
    :goto_1
    invoke-virtual {p0}, Lcom/vk/notifications/d;->q()Landroid/support/v4/app/FragmentActivity;
    ...
    :goto_2
    invoke-virtual {p0, p3, v1}, Lcom/vk/notifications/d;->a(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    iput-object p2, p0, Lcom/vk/notifications/d;->ai:Lcom/vk/lists/RecyclerPaginatedView;

    .line 73
    iget-object p2, p0, Lcom/vk/notifications/d;->ai:Lcom/vk/lists/RecyclerPaginatedView;
    ...
    .line 74
    :cond_8
    new-instance p2, Lcom/vk/notifications/c;

    invoke-direct {p2}, Lcom/vk/notifications/c;-><init>()V

    iput-object p2, p0, Lcom/vk/notifications/d;->al:Lcom/vk/notifications/c;
    ...
    iget-object p3, p0, Lcom/vk/notifications/d;->al:Lcom/vk/notifications/c;
    ...
    new-instance v1, Lcom/vk/notifications/d$e;

    invoke-direct {v1, p0}, Lcom/vk/notifications/d$e;-><init>(Lcom/vk/notifications/d;)V

    check-cast v1, Lme/grishka/appkit/views/a$a;

    invoke-virtual {p3, v1}, Lme/grishka/appkit/views/a;->a(Lme/grishka/appkit/views/a$a;)Lme/grishka/appkit/views/a;
    ...
    invoke-direct {p0}, Lcom/vk/notifications/d;->au()Lcom/vk/notifications/d$d;
    ...
    .line 82
    :cond_c
    iget-object p2, p0, Lcom/vk/notifications/d;->ag:Landroid/support/v7/widget/Toolbar;

    if-eqz p2, :cond_e

    iget-object p3, p0, Lcom/vk/notifications/d;->ai:Lcom/vk/lists/RecyclerPaginatedView;
    ...
    .line 86
    invoke-virtual {p2, p3}, Lcom/vk/lists/s$a;->b(I)Lcom/vk/lists/s$a;
    ...
    .line 87
    invoke-virtual {p2, p3}, Lcom/vk/lists/s$a;->d(I)Lcom/vk/lists/s$a;

    move-result-object p2

    .line 88
    new-instance p3, Lcom/vk/notifications/d$f;

    invoke-direct {p3, p0}, Lcom/vk/notifications/d$f;-><init>(Lcom/vk/notifications/d;)V
    ...
    iput-object p2, p0, Lcom/vk/notifications/d;->ah:Lcom/vk/lists/s;
...
.method public a(Lcom/vk/lists/s;Z)Lio/reactivex/j;
    ...
    .line 112
    invoke-virtual {p0, p2, p1}, Lcom/vk/notifications/d;->a(Ljava/lang/String;Lcom/vk/lists/s;)Lio/reactivex/j;

    move-result-object p1

    new-instance p2, Lcom/vk/notifications/d$i;

    invoke-direct {p2, p0}, Lcom/vk/notifications/d$i;-><init>(Lcom/vk/notifications/d;)V
...
.method public a(Ljava/lang/String;Lcom/vk/lists/s;)Lio/reactivex/j;
    ...
    .line 114
    new-instance v0, Lcom/vk/api/p/h;

    iget-object v1, p0, Lcom/vk/notifications/d;->ae:Ljava/lang/String;

    invoke-virtual {p2}, Lcom/vk/lists/s;->e()I

    move-result p2

    invoke-direct {v0, v1, p1, p2}, Lcom/vk/api/p/h;-><init>(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    :cond_0
    iget p1, p0, Lcom/vk/notifications/d;->an:I

    :goto_0
    invoke-virtual {v0, p1}, Lcom/vk/api/p/h;->a(I)Lcom/vk/api/p/h;
...
.method public a(Lio/reactivex/j;ZLcom/vk/lists/s;)V
    ...
    .line 120
    new-instance v0, Lcom/vk/notifications/d$g;

    invoke-direct {v0, p0, p3}, Lcom/vk/notifications/d$g;-><init>(Lcom/vk/notifications/d;Lcom/vk/lists/s;)V

    check-cast v0, Lio/reactivex/b/g;

    .line 136
    new-instance p3, Lcom/vk/notifications/d$h;

    invoke-direct {p3, p0, p2}, Lcom/vk/notifications/d$h;-><init>(Lcom/vk/notifications/d;Z)V
...
.method protected final as()Lcom/vk/lists/s;
    .locals 1

    .line 46
    iget-object v0, p0, Lcom/vk/notifications/d;->ah:Lcom/vk/lists/s;

    return-object v0
.end method

.method protected final at()Lcom/vk/notifications/c;
    .locals 1

    .line 48
    iget-object v0, p0, Lcom/vk/notifications/d;->al:Lcom/vk/notifications/c;
...
.method public b(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-object p1, p0, Lcom/vk/notifications/d;->ae:Ljava/lang/String;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 107
    iget-object p1, p0, Lcom/vk/notifications/d;->ai:Lcom/vk/lists/RecyclerPaginatedView;
