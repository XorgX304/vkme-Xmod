...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vk/pushes/messages/url/MessageNotification;->a:[Lkotlin/f/h;

    new-instance v0, Lcom/vk/pushes/messages/url/MessageNotification$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/vk/pushes/messages/url/MessageNotification$a;-><init>(Lkotlin/jvm/internal/h;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/vk/pushes/messages/url/MessageNotification$MessageNotificationContainer;Landroid/graphics/Bitmap;Ljava/util/List;)V
    ...
    iput-object p2, p0, Lcom/vk/pushes/messages/url/MessageNotification;->i:Lcom/vkontakte/android/NotificationUtils$Type;
    ...
    iput-object p2, p0, Lcom/vk/pushes/messages/url/MessageNotification;->n:Lkotlin/d;
    ...
    iput-object p1, p0, Lcom/vk/pushes/messages/url/MessageNotification;->o:Lkotlin/d;
...
.method public static final synthetic a(Lcom/vk/pushes/messages/url/MessageNotification;)Landroid/support/v4/app/x$g;
    .locals 0

    .line 28
    invoke-direct {p0}, Lcom/vk/pushes/messages/url/MessageNotification;->z()Landroid/support/v4/app/x$g;
...
.method private final a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 192
    :goto_0
    invoke-static {p1}, Lcom/vk/core/util/aq;->a(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method private final v()Z
    ...
    iget-object v0, p0, Lcom/vk/pushes/messages/url/MessageNotification;->o:Lkotlin/d;

    sget-object v1, Lcom/vk/pushes/messages/url/MessageNotification;->a:[Lkotlin/f/h;
...
.method private final w()Landroid/support/v4/app/x$a;
    .locals 6
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/app/ac$a;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/ac$a;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ac$a;

    move-result-object v0

    .line 107
    invoke-virtual {v0}, Landroid/support/v4/app/ac$a;->a()Landroid/support/v4/app/ac;
    ...
    .line 113
    new-instance v3, Landroid/support/v4/app/x$a$c;

    invoke-direct {v3}, Landroid/support/v4/app/x$a$c;-><init>()V

    const/4 v4, 0x0

    .line 114
    invoke-virtual {v3, v4}, Landroid/support/v4/app/x$a$c;->a(Z)Landroid/support/v4/app/x$a$c;
    ...
    .line 115
    invoke-virtual {v3, v4}, Landroid/support/v4/app/x$a$c;->b(Z)Landroid/support/v4/app/x$a$c;

    move-result-object v3

    .line 117
    new-instance v4, Landroid/support/v4/app/x$a$a;
    ...
    invoke-direct {v4, v5, v2, v1}, Landroid/support/v4/app/x$a$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    .line 118
    invoke-virtual {v4, v0}, Landroid/support/v4/app/x$a$a;->a(Landroid/support/v4/app/ac;)Landroid/support/v4/app/x$a$a;

    move-result-object v0

    .line 119
    check-cast v3, Landroid/support/v4/app/x$a$b;

    invoke-virtual {v0, v3}, Landroid/support/v4/app/x$a$a;->a(Landroid/support/v4/app/x$a$b;)Landroid/support/v4/app/x$a$a;
...
.method private final x()Landroid/support/v4/app/x$a;
    .locals 4
...
.method private final y()Landroid/support/v4/app/x$a;
    .locals 6
    ...
    invoke-virtual {v0, v1, v2}, Lcom/vk/pushes/a/a;->a(Landroid/content/Context;Ljava/lang/Integer;)Lcom/vk/pushes/a/a$a;
    ...
    .line 138
    invoke-virtual {v0}, Lcom/vk/pushes/a/a$a;->a()I
    ...
    invoke-virtual {v0}, Lcom/vk/pushes/a/a$a;->b()Ljava/lang/String;
    ...
    .line 140
    invoke-direct {v2, v3, v0, v1}, Landroid/support/v4/app/x$a$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/x$a$c;->a(Z)Landroid/support/v4/app/x$a$c;

    move-result-object v0

    check-cast v0, Landroid/support/v4/app/x$a$b;

    invoke-virtual {v2, v0}, Landroid/support/v4/app/x$a$a;->a(Landroid/support/v4/app/x$a$b;)Landroid/support/v4/app/x$a$a;
...
.method private final z()Landroid/support/v4/app/x$g;
    .locals 7
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/app/x$f;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/x$f;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$f;
    ...
    invoke-virtual {v0, v3, v4, v5, v2}, Landroid/support/v4/app/x$f;->a(Ljava/lang/CharSequence;JLjava/lang/CharSequence;)Landroid/support/v4/app/x$f;
    ...
    :goto_2
    sget-object v2, Lcom/vk/pushes/messages/base/b;->e:Lcom/vk/pushes/messages/base/b$a;

    invoke-virtual {v2}, Lcom/vk/pushes/messages/base/b$a;->a()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/x$e;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$e;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/x$e;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$e;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/x$e;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$e;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/x$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$b;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/x$b;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$b;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/x$b;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$b;
...
.method public a(Landroid/app/NotificationManager;)V
    ...
    .line 48
    invoke-super {p0, p1}, Lcom/vk/pushes/messages/url/m;->a(Landroid/app/NotificationManager;)V

    .line 51
    sget-object v0, Lcom/vk/pushes/a/e;->a:Lcom/vk/pushes/a/e;

    invoke-virtual {v0}, Lcom/vk/pushes/a/e;->a()Z
    ...
    invoke-virtual {v0, p1}, Lcom/vk/pushes/a/c;->a(Landroid/app/NotificationManager;)I
    ...
    .line 54
    new-instance v1, Lcom/vk/pushes/messages/a/a;
    ...
    invoke-direct {v1, v2, v0, v3}, Lcom/vk/pushes/messages/a/a;-><init>(Landroid/content/Context;ILjava/lang/String;)V

    invoke-virtual {v1, p1}, Lcom/vk/pushes/messages/a/a;->a(Landroid/app/NotificationManager;)V
...
.method protected a(Landroid/support/v4/app/x$c;)V
    ...
    .line 60
    invoke-super {p0, p1}, Lcom/vk/pushes/messages/url/m;->a(Landroid/support/v4/app/x$c;)V
    ...
    .line 70
    invoke-virtual {p1, v0}, Landroid/support/v4/app/x$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;
...
.method protected a(Landroid/support/v4/app/x$h;)V
    ...
    .line 82
    invoke-direct {p0}, Lcom/vk/pushes/messages/url/MessageNotification;->w()Landroid/support/v4/app/x$a;
    ...
    new-array v0, v0, [Landroid/support/v4/app/x$a;

    const/4 v1, 0x0

    invoke-direct {p0}, Lcom/vk/pushes/messages/url/MessageNotification;->x()Landroid/support/v4/app/x$a;
    ...
    invoke-direct {p0}, Lcom/vk/pushes/messages/url/MessageNotification;->y()Landroid/support/v4/app/x$a;

    move-result-object v2

    aput-object v2, v0, v1

    invoke-static {v0}, Lkotlin/sequences/l;->a([Ljava/lang/Object;)Lkotlin/sequences/i;

    move-result-object v0

    invoke-static {p1, v0}, Lkotlin/collections/m;->a(Ljava/util/Collection;Lkotlin/sequences/i;)Z
...
.method protected i()Lcom/vkontakte/android/NotificationUtils$Type;
    ...
    .line 34
    iget-object v0, p0, Lcom/vk/pushes/messages/url/MessageNotification;->i:Lcom/vkontakte/android/NotificationUtils$Type;
...
.method protected o()Landroid/support/v4/app/x$g;
    ...
    iget-object v0, p0, Lcom/vk/pushes/messages/url/MessageNotification;->n:Lkotlin/d;
...
.method protected r()Landroid/content/Intent;
    ...
    .line 146
    invoke-super {p0}, Lcom/vk/pushes/messages/url/m;->r()Landroid/content/Intent;
