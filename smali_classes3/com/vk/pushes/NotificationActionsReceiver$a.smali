...
.method private final a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 101
    invoke-static {v1, v0, v2, v0}, Lcom/vk/api/base/e;->a(Lcom/vk/api/base/e;Lcom/vk/api/base/f;ILjava/lang/Object;)Lio/reactivex/j;
...
.method private final a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, p1}, Lcom/vk/pushes/a/e;->d(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lcom/vk/api/base/g;->a(Landroid/content/Context;Lcom/vk/api/sdk/exceptions/VKApiExecutionException;)Ljava/lang/String;
    ...
    invoke-static {p3, p1}, Lcom/vkontakte/android/utils/L;->e(Ljava/lang/Throwable;[Ljava/lang/Object;)V
...
.method private final a(Landroid/content/Context;Landroid/content/Intent;Z)V
    ...
    .line 340
    new-instance v1, Lcom/vkontakte/android/api/account/m;

    invoke-direct {v1, v0, p3}, Lcom/vkontakte/android/api/account/m;-><init>(Ljava/lang/String;Z)V
    ...
    .line 341
    invoke-static {v1, p3, v0, p3}, Lcom/vk/api/base/e;->a(Lcom/vk/api/base/e;Lcom/vk/api/base/f;ILjava/lang/Object;)Lio/reactivex/j;
    ...
    invoke-virtual {p3, v0, v1}, Lio/reactivex/j;->a(Lio/reactivex/b/g;Lio/reactivex/b/g;)Lio/reactivex/disposables/b;
...
.method private final b(Landroid/content/Context;Landroid/content/Intent;Z)V
    ...
    invoke-direct {p3, p1, p2}, Lcom/vk/pushes/NotificationActionsReceiver$a;->r(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private final c(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 121
    new-instance v2, Lcom/vkontakte/android/api/groups/r;

    invoke-direct {v2, v0, v1}, Lcom/vkontakte/android/api/groups/r;-><init>(IZ)V

    .line 122
    invoke-virtual {v2}, Lcom/vkontakte/android/api/groups/r;->g()Lio/reactivex/j;
...
.method private final d(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 131
    new-instance v1, Lcom/vkontakte/android/api/groups/s;

    invoke-direct {v1, v0}, Lcom/vkontakte/android/api/groups/s;-><init>(I)V

    .line 132
    invoke-virtual {v1}, Lcom/vkontakte/android/api/groups/s;->g()Lio/reactivex/j;
...
.method private final e(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 144
    new-instance v0, Lcom/vk/api/k/a;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/vk/api/k/a;-><init>(Ljava/lang/String;IILjava/lang/String;ILkotlin/jvm/internal/h;)V
...
.method private final f(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 154
    new-instance v3, Lcom/vkontakte/android/api/photos/b;

    invoke-direct {v3, v0, v2, v1}, Lcom/vkontakte/android/api/photos/b;-><init>(III)V
...
.method private final g(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 167
    new-instance v3, Lcom/vkontakte/android/api/photos/z;

    invoke-direct {v3, v0, v2, v1}, Lcom/vkontakte/android/api/photos/z;-><init>(III)V
...
.method private final h(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 177
    invoke-static {p1, v0, v2, v1}, Lcom/vk/common/links/h;->a(Landroid/content/Context;ILcom/vk/common/links/e;Ljava/lang/String;)Z
    ...
    .line 179
    sget-object p2, Lcom/vk/pushes/a/e;->a:Lcom/vk/pushes/a/e;

    invoke-virtual {p2, p1}, Lcom/vk/pushes/a/e;->d(Landroid/content/Context;)V
...
.method private final i(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 204
    sget-object p2, Lcom/vk/pushes/a/c;->a:Lcom/vk/pushes/a/c;

    invoke-virtual {p2, p1}, Lcom/vk/pushes/a/c;->a(Landroid/content/Context;)V
...
.method private final j(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1, v1, p2}, Lcom/vk/pushes/a/e;->a(Landroid/content/Context;Ljava/lang/String;I)V
...
.method private final m(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 237
    invoke-static/range {p2 .. p2}, Landroid/support/v4/app/ac;->a(Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    .line 247
    invoke-static/range {v4 .. v12}, Lcom/vk/common/links/h;->a(IZILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/vk/common/links/e;ILjava/lang/Object;)Z

    .line 248
    sget-object v3, Lcom/vk/pushes/a/e;->a:Lcom/vk/pushes/a/e;

    invoke-virtual {v3, v0}, Lcom/vk/pushes/a/e;->d(Landroid/content/Context;)V
...
.method private final n(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v1, v0}, Lcom/vk/pushes/a/b;->b(I)V
...
.method private final o(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 290
    invoke-static {v8, v0, v1}, Lcom/vk/extensions/e;->a(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v15 .. v21}, Lcom/vk/common/links/c$b;-><init>(ZZZLjava/lang/String;ILkotlin/jvm/internal/h;)V
    ...
    invoke-virtual {v0, v7}, Lcom/vk/pushes/a/e;->d(Landroid/content/Context;)V
    ...
    .line 306
    :goto_1
    sget-object v9, Lcom/vk/api/v/a;->a:Lcom/vk/api/v/a$a;

    invoke-virtual/range {v9 .. v14}, Lcom/vk/api/v/a$a;->a(Ljava/lang/String;IILjava/lang/String;I)Lcom/vk/api/v/a;
...
.method private final p(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 322
    invoke-static {p1, v1, v0}, Lcom/vkontakte/android/fragments/money/f;->a(Landroid/content/Context;Ljava/lang/String;I)V
...
.method private final q(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 329
    invoke-static {p2, v1, v2}, Lcom/vk/extensions/e;->a(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 330
    invoke-static {p2, v2, v3}, Lcom/vk/extensions/e;->a(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .line 332
    new-instance v3, Lcom/vkontakte/android/fragments/money/a$a;

    const/4 v4, 0x0

    invoke-direct {v3, v0, v4, v1, v4}, Lcom/vkontakte/android/fragments/money/a$a;-><init>(ILcom/vkontakte/android/UserProfile;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v3, v2}, Lcom/vkontakte/android/fragments/money/a$a;->a(Ljava/lang/String;)Lcom/vkontakte/android/fragments/money/a$a;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/vkontakte/android/fragments/money/a$a;->c(Landroid/content/Context;)V
