.class public Lcom/vk/messengerageloader/i;
...
.field private static final d:Lcom/vk/messengerageloader/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vk/messengerageloader/i;->a:[Ljava/lang/String;

    .line 72
    new-instance v0, Lcom/vk/messengerageloader/l;

    invoke-direct {v0}, Lcom/vk/messengerageloader/l;-><init>()V

    sput-object v0, Lcom/vk/messengerageloader/i;->d:Lcom/vk/messengerageloader/l;
...
.method public static a(Landroid/net/Uri;Lcom/facebook/imagepipeline/request/ImageRequest$CacheChoice;)Lcom/facebook/imagepipeline/g/d;
    ...
    invoke-virtual {p1}, Lcom/vk/messengerageloader/c;->d()Lcom/facebook/imagepipeline/d/g;
    ...
    .line 155
    :try_start_0
    invoke-static {}, Lcom/vk/messengerageloader/i;->c()Lcom/facebook/imagepipeline/c/e;
...
.method public static a(Z)Lcom/vk/messengerageloader/ImageSize;
    .locals 0

    if-eqz p0, :cond_0

    .line 99
    sget-object p0, Lcom/vk/messengerageloader/ImageSize;->VERY_BIG:Lcom/vk/messengerageloader/ImageSize;

    goto :goto_0

    :cond_0
    sget-object p0, Lcom/vk/messengerageloader/ImageSize;->SMALL:Lcom/vk/messengerageloader/ImageSize;

    :goto_0
    return-object p0
.end method

.method public static a(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)Lio/reactivex/j;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/net/Uri;",
            "III",
            "Lcom/vk/messengerageloader/k;",
            "Lcom/vk/messengerageloader/j;",
    ...
    .line 331
    new-instance v8, Lcom/vk/messengerageloader/i$5;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/vk/messengerageloader/i$5;-><init>(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)V

    invoke-static {v8}, Lio/reactivex/j;->c(Ljava/util/concurrent/Callable;)Lio/reactivex/j;

    move-result-object p0

    invoke-static {p0}, Lcom/vk/messengerageloader/i;->a(Lio/reactivex/j;)Lio/reactivex/j;
...
.method public static a(Landroid/net/Uri;Lcom/facebook/imagepipeline/request/b;)Lio/reactivex/j;
    ...
    .line 313
    invoke-static/range {v0 .. v6}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)Lio/reactivex/j;
...
.method public static a(Landroid/net/Uri;Lcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;)Lio/reactivex/j;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 321
    sget-object v0, Lcom/vk/messengerageloader/ImageSize;->VERY_BIG:Lcom/vk/messengerageloader/ImageSize;
    ...
    invoke-static/range {v1 .. v7}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)Lio/reactivex/j;
...
.method private static a(Lio/reactivex/j;)Lio/reactivex/j;
    ...
    .line 347
    new-instance v0, Lcom/vk/messengerageloader/i$6;

    invoke-direct {v0}, Lcom/vk/messengerageloader/i$6;-><init>()V
...
.method public static a(Ljava/lang/String;I)Lio/reactivex/j;
    ...
    invoke-static {p0}, Lcom/vk/messengerageloader/i;->f(Landroid/net/Uri;)Lio/reactivex/j;

    move-result-object p0

    new-instance v0, Lcom/vk/messengerageloader/i$4;

    invoke-direct {v0, p1}, Lcom/vk/messengerageloader/i$4;-><init>(I)V
...
.method public static a(Landroid/net/Uri;)Ljava/io/File;
    ...
    .line 105
    :try_start_0
    invoke-static {p0}, Lcom/vk/messengerageloader/i;->e(Landroid/net/Uri;)Lcom/facebook/datasource/b;
    ...
    .line 107
    new-instance v3, Lcom/vk/messengerageloader/i$2;

    invoke-direct {v3, v2}, Lcom/vk/messengerageloader/i$2;-><init>(Ljava/util/concurrent/CountDownLatch;)V
...
.method public static a()V
    ...
    .line 169
    sget-object v0, Lcom/vk/messengerageloader/i;->c:Landroid/support/v4/f/g;
...
.method public static a(I)V
    ...
    .line 164
    sget-object v0, Lcom/vk/messengerageloader/i;->d:Lcom/vk/messengerageloader/l;

    invoke-virtual {v0, p0}, Lcom/vk/messengerageloader/l;->a(I)V

    return-void
.end method

.method public static a(Landroid/content/Context;Lcom/vk/messengerageloader/f$a;)V
    .locals 2

    .line 75
    new-instance v0, Lcom/vk/messengerageloader/f;

    invoke-direct {v0}, Lcom/vk/messengerageloader/f;-><init>()V

    .line 76
    invoke-virtual {v0, p1}, Lcom/vk/messengerageloader/f;->a(Lcom/vk/messengerageloader/f$a;)V
    ...
    .line 81
    invoke-static {}, Lcom/vk/messengerageloader/h;->b()Lcom/vk/messengerageloader/h;
    ...
    .line 83
    new-instance v0, Lcom/vk/messengerageloader/VKImageBitmapPool;
    ...
    invoke-direct {v0, p0, v1}, Lcom/vk/messengerageloader/VKImageBitmapPool;-><init>(Landroid/content/Context;Lcom/facebook/imagepipeline/memory/ab;)V
    ...
    .line 84
    invoke-static {p1, p0}, Lcom/vk/messengerageloader/i;->a(Lcom/facebook/imagepipeline/d/h$a;Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/vk/messengerageloader/c;->a(Landroid/content/Context;Lcom/facebook/imagepipeline/d/h;)V

    .line 87
    new-instance p0, Lcom/vk/messengerageloader/i$1;

    const p1, 0x19bfcc0

    invoke-direct {p0, p1}, Lcom/vk/messengerageloader/i$1;-><init>(I)V

    sput-object p0, Lcom/vk/messengerageloader/i;->c:Landroid/support/v4/f/g;
...
.method public static a(Landroid/net/Uri;I)V
    ...
    .line 252
    invoke-static {p0, p1, v0}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;ILcom/facebook/imagepipeline/request/b;)V
...
.method public static a(Landroid/net/Uri;ILcom/facebook/imagepipeline/request/b;)V
    ...
    .line 261
    :cond_0
    sget-object p2, Lcom/vk/messengerageloader/view/VKImageView;->b_:Lcom/facebook/imagepipeline/common/e;
...
.method public static a(Landroid/net/Uri;Lcom/vk/messengerageloader/ImageSize;)V
    .locals 1

    const/4 v0, 0x0

    .line 242
    invoke-static {p0, p1, v0}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;Lcom/vk/messengerageloader/ImageSize;Lcom/facebook/imagepipeline/request/b;)V

    return-void
.end method

.method public static a(Landroid/net/Uri;Lcom/vk/messengerageloader/ImageSize;Lcom/facebook/imagepipeline/request/b;)V
    .locals 0
    ...
    :goto_0
    invoke-static {p0, p1, p2}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;ILcom/facebook/imagepipeline/request/b;)V
...
.method public static a(Ljava/lang/String;Lcom/vk/messengerageloader/ImageSize;)V
    .locals 0
    ...
    invoke-static {p0, p1}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;Lcom/vk/messengerageloader/ImageSize;)V
...
.method public static a(Ljava/lang/String;)Z
    ...
    .line 182
    invoke-static {p0}, Lcom/vk/messengerageloader/i;->b(Ljava/lang/String;)Z

    move-result p0

    if-nez p0, :cond_1

    sget-object p0, Lcom/vk/messengerageloader/c;->a:Lcom/vk/messengerageloader/c;

    invoke-virtual {p0}, Lcom/vk/messengerageloader/c;->d()Lcom/facebook/imagepipeline/d/g;
...
.method static synthetic b(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)Landroid/graphics/Bitmap;
    .locals 0

    .line 54
    invoke-static/range {p0 .. p6}, Lcom/vk/messengerageloader/i;->c(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)Landroid/graphics/Bitmap;
...
.method public static b(Landroid/net/Uri;Lcom/vk/messengerageloader/ImageSize;)Lio/reactivex/j;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/net/Uri;",
            "Lcom/vk/messengerageloader/ImageSize;",
            ")",
            "Lio/reactivex/j<",
            "Landroid/graphics/Bitmap;",
            ">;"
...
.method public static b(Ljava/lang/String;)Z
    ...
    .line 190
    sget-object v2, Lcom/vk/messengerageloader/i;->c:Landroid/support/v4/f/g;
...
.method private static c(Landroid/net/Uri;IIILcom/vk/messengerageloader/k;Lcom/vk/messengerageloader/j;Lcom/facebook/imagepipeline/request/b;)Landroid/graphics/Bitmap;
    .locals 3
    ...
    .line 369
    :cond_0
    sget-object v1, Lcom/vk/messengerageloader/i;->c:Landroid/support/v4/f/g;
    ...
    .line 376
    invoke-static {p0}, Lcom/vk/messengerageloader/a;->a(Landroid/net/Uri;)Lcom/vk/messengerageloader/a;
    ...
    .line 398
    invoke-virtual {p4, p1}, Lcom/vk/messengerageloader/k;->a(Lcom/facebook/datasource/b;)V

    .line 400
    :cond_6
    new-instance p4, Lcom/vk/messengerageloader/i$7;

    invoke-direct {p4, p2, p3, p6, p5}, Lcom/vk/messengerageloader/i$7;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/vk/messengerageloader/j;)V
    ...
    .line 447
    sget-object p1, Lcom/vk/messengerageloader/i;->c:Landroid/support/v4/f/g;
...
.method public static c(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1}, Lcom/vk/messengerageloader/c;->d()Lcom/facebook/imagepipeline/d/g;
...
.method private static declared-synchronized c()Lcom/facebook/imagepipeline/c/e;
    ...
    const-class v0, Lcom/vk/messengerageloader/i;

    monitor-enter v0

    .line 477
    :try_start_0
    sget-object v1, Lcom/vk/messengerageloader/i;->b:Ljava/lang/reflect/Field;
    ...
    sput-object v1, Lcom/vk/messengerageloader/i;->b:Ljava/lang/reflect/Field;
...
.method public static c(Landroid/net/Uri;)Lcom/facebook/imagepipeline/g/d;
    ...
    invoke-static {p0, v0}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;Lcom/facebook/imagepipeline/request/ImageRequest$CacheChoice;)Lcom/facebook/imagepipeline/g/d;
...
.method public static d(Landroid/net/Uri;)V
    ...
    .line 237
    invoke-static {p0, v0}, Lcom/vk/messengerageloader/i;->a(Landroid/net/Uri;Lcom/vk/messengerageloader/ImageSize;)V
...
.method public static d(Ljava/lang/String;)Z
    ...
    .line 215
    :cond_0
    sget-object v1, Lcom/vk/messengerageloader/i;->a:[Ljava/lang/String;
...
.method public static f(Ljava/lang/String;)Lio/reactivex/j;
    ...
    new-instance v0, Lcom/vk/messengerageloader/i$3;

    invoke-direct {v0}, Lcom/vk/messengerageloader/i$3;-><init>()V
...
.method public static g(Ljava/lang/String;)Lio/reactivex/j;
    ...
    invoke-static {p0, v0}, Lcom/vk/messengerageloader/i;->a(Ljava/lang/String;I)Lio/reactivex/j;
