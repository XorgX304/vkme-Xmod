...
.field public static final enum FEATURE_ARTICLE_AUTHOR_PAGE:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_DEVELOPERS:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_FEED_LIKES_TAB:Lcom/vk/toggle/Features$Type;
...
.field public static final enum FEATURE_MUSIC_SUBSCRIPTION_REDESIGN:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_NEW_PLAYLIST_SNIPPETS:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_NEW_PLAYLIST_SNIPPETS_BETA:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_PLAYLIST_REDESIGN:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_STORY_VIDEO:Lcom/vk/toggle/Features$Type;

.field public static final enum FEATURE_VOIP_MASKS:Lcom/vk/toggle/Features$Type;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "FEATURE_NEW_PLAYLIST_SNIPPETS"

    const-string v4, "mus_playlist_snip"
    ...
    .line 16
    invoke-direct/range {v1 .. v7}, Lcom/vk/toggle/Features$Type;-><init>(Ljava/lang/String;ILjava/lang/String;ZILkotlin/jvm/internal/h;)V

    sput-object v8, Lcom/vk/toggle/Features$Type;->FEATURE_NEW_PLAYLIST_SNIPPETS:Lcom/vk/toggle/Features$Type;
    ...
    const-string v10, "FEATURE_MUSIC_SUBSCRIPTION_REDESIGN"

    const-string v12, "mus_subscription"
    ...
    .line 17
    invoke-direct/range {v9 .. v15}, Lcom/vk/toggle/Features$Type;-><init>(Ljava/lang/String;ILjava/lang/String;ZILkotlin/jvm/internal/h;)V

    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_MUSIC_SUBSCRIPTION_REDESIGN:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_NEW_PLAYLIST_SNIPPETS_BETA"

    const-string v6, "mus_playlists_beta"
    ...
    .line 18
    invoke-direct/range {v3 .. v9}, Lcom/vk/toggle/Features$Type;-><init>(Ljava/lang/String;ILjava/lang/String;ZILkotlin/jvm/internal/h;)V

    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_NEW_PLAYLIST_SNIPPETS_BETA:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_VOIP_MASKS"

    const-string v6, "voip_masks"
    ...
    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_VOIP_MASKS:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_ANALYTICS_APP"

    const-string v6, "analytics_app"
    ...
    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_ANALYTICS_APP:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_LIVE_VIDEO_ACTION_LINK"

    const-string v6, "live_act_link_add"
    ...
    const-string v4, "FEATURE_FEED_LIKES_TAB"

    const-string v6, "feed_likes_new_tab"
    ...
    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_FEED_LIKES_TAB:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_ARTICLE_AUTHOR_PAGE"

    const-string v6, "article_author_page"
    ...
    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_ARTICLE_AUTHOR_PAGE:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_STORY_VIDEO"

    const-string v6, "feature_story_video"
    ...
    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_STORY_VIDEO:Lcom/vk/toggle/Features$Type;
    ...
    const-string v4, "FEATURE_PLAYLIST_REDESIGN"

    const-string v6, "mus_playlist_red"
    ...
    sput-object v1, Lcom/vk/toggle/Features$Type;->FEATURE_PLAYLIST_REDESIGN:Lcom/vk/toggle/Features$Type;
