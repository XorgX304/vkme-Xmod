...
.field private final e:Lcom/vk/media/a$d;
...
.method private constructor <init>(Lcom/vk/stories/util/CameraVideoEncoder$a;Z)V
    ...
    iput-object p1, p0, Lcom/vk/stories/util/CameraVideoEncoder;->e:Lcom/vk/media/a$d;

    .line 77
    iget-object p1, p0, Lcom/vk/stories/util/CameraVideoEncoder;->f:Ljava/io/File;

    invoke-static {p1}, Lcom/vk/core/f/d;->f(Ljava/io/File;)V
...
.method private d()V
    ...
    invoke-static {v0}, Lcom/vk/core/f/d;->a(Ljava/io/File;)Z
    ...
    invoke-static {v0}, Lcom/vk/stories/l;->a(Ljava/io/File;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v1, v0, v2}, Lcom/vk/stories/util/CameraVideoEncoder$d;-><init>(Landroid/graphics/Bitmap;I)V
    ...
    .line 154
    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->g:Lcom/vk/stories/util/CameraVideoEncoder$Parameters;

    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->b(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)Ljava/io/File;
    ...
    :goto_1
    :try_start_0
    new-instance v5, Lcom/vk/media/a$a;

    iget-object v6, p0, Lcom/vk/stories/util/CameraVideoEncoder;->f:Ljava/io/File;

    iget-object v7, p0, Lcom/vk/stories/util/CameraVideoEncoder;->e:Lcom/vk/media/a$d;

    invoke-direct {v5, v4, v6, v7}, Lcom/vk/media/a$a;-><init>(Ljava/io/File;Ljava/io/File;Lcom/vk/media/a$d;)V

    if-eqz v0, :cond_4

    .line 159
    new-instance v0, Lcom/vk/media/a/b;

    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->h:Lcom/vk/stories/util/CameraVideoEncoder$d;

    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$d;->a(Lcom/vk/stories/util/CameraVideoEncoder$d;)Landroid/graphics/Bitmap;

    move-result-object v4

    iget-object v6, p0, Lcom/vk/stories/util/CameraVideoEncoder;->h:Lcom/vk/stories/util/CameraVideoEncoder$d;

    invoke-static {v6}, Lcom/vk/stories/util/CameraVideoEncoder$d;->b(Lcom/vk/stories/util/CameraVideoEncoder$d;)I
    ...
    invoke-direct {v0, v4, v6, v7, v8}, Lcom/vk/media/a/b;-><init>(Landroid/graphics/Bitmap;JLjava/io/File;)V
    :try_end_0
    ...
    .line 160
    :try_start_1
    invoke-virtual {v5, v0}, Lcom/vk/media/a$a;->a(Lcom/vk/media/a$c;)V

    const/4 v4, 0x2

    .line 161
    invoke-static {v4}, Lcom/vk/media/c;->a(I)I

    move-result v4

    invoke-virtual {v5, v4}, Lcom/vk/media/a$a;->a(I)V
    ...
    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->c(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)Z

    move-result v4

    invoke-virtual {v5, v4}, Lcom/vk/media/a$a;->b(Z)V

    .line 164
    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->g:Lcom/vk/stories/util/CameraVideoEncoder$Parameters;

    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->d(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)I

    move-result v4

    invoke-virtual {v5, v4}, Lcom/vk/media/a$a;->b(I)V

    .line 165
    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->g:Lcom/vk/stories/util/CameraVideoEncoder$Parameters;

    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->e(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)Z

    move-result v4

    invoke-virtual {v5, v4}, Lcom/vk/media/a$a;->a(Z)V

    .line 166
    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->g:Lcom/vk/stories/util/CameraVideoEncoder$Parameters;

    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->f(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)F

    move-result v4

    invoke-virtual {v5, v4}, Lcom/vk/media/a$a;->a(F)V

    .line 167
    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->g:Lcom/vk/stories/util/CameraVideoEncoder$Parameters;

    invoke-static {v4}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->a(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)I
    ...
    iget-object v6, p0, Lcom/vk/stories/util/CameraVideoEncoder;->g:Lcom/vk/stories/util/CameraVideoEncoder$Parameters;

    invoke-static {v6}, Lcom/vk/stories/util/CameraVideoEncoder$Parameters;->a(Lcom/vk/stories/util/CameraVideoEncoder$Parameters;)I

    move-result v6

    invoke-virtual {v4, v6}, Lcom/vk/stories/StoriesController$b;->a(I)Lcom/vk/stories/n;

    move-result-object v4

    invoke-virtual {v5, v4}, Lcom/vk/media/a$a;->a(Lcom/vk/media/a$b;)V

    .line 170
    :cond_5
    invoke-virtual {v5}, Lcom/vk/media/a$a;->m()Lcom/vk/media/a;
    ...
    .line 172
    invoke-interface {v4}, Lcom/vk/media/a;->a()Z
    ...
    .line 181
    invoke-interface {v4}, Lcom/vk/media/a;->b()V

    .line 183
    :cond_7
    iget-object v4, p0, Lcom/vk/stories/util/CameraVideoEncoder;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 186
    invoke-virtual {v0}, Lcom/vk/media/a/b;->e()V
    ...
    .line 177
    iput-object v3, p0, Lcom/vk/stories/util/CameraVideoEncoder;->f:Ljava/io/File;

    .line 178
    invoke-direct {p0, v4}, Lcom/vk/stories/util/CameraVideoEncoder;->a(Ljava/lang/Exception;)V
    :try_end_3
    ...
    .line 181
    invoke-interface {v0}, Lcom/vk/media/a;->b()V
    ...
    .line 186
    invoke-virtual {v5}, Lcom/vk/media/a/b;->e()V
    ...
    invoke-direct {p0, v3, v4}, Lcom/vk/stories/util/CameraVideoEncoder;->a(J)V
    ...
    .line 183
    :cond_a
    iget-object v2, p0, Lcom/vk/stories/util/CameraVideoEncoder;->c:Ljava/util/concurrent/atomic/AtomicReference;
