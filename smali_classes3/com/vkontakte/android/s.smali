...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/vkontakte/android/s;->a:J
...
.method private a(Landroid/content/Context;Lcom/vkontakte/android/UserProfile;)Landroid/content/pm/ShortcutInfo;
    .locals 4
    ...
    iget v3, p2, Lcom/vkontakte/android/UserProfile;->n:I
    ...
    iget-object v2, p2, Lcom/vkontakte/android/UserProfile;->o:Ljava/lang/String;
    ...
    iget-object v2, p2, Lcom/vkontakte/android/UserProfile;->p:Ljava/lang/String;
    ...
    .line 233
    invoke-direct {p0, p1, v0}, Lcom/vkontakte/android/s;->a(Landroid/content/Context;Landroid/content/Intent;)[Landroid/content/Intent;
    ...
    new-instance v2, Lcom/vkontakte/android/s$2;
...
.method public static a()Lcom/vkontakte/android/s;
    .locals 1

    .line 56
    invoke-static {}, Lcom/vkontakte/android/s$a;->a()Lcom/vkontakte/android/s;
...
.method static synthetic a(Lcom/vkontakte/android/s;Ljava/util/concurrent/Future;)Ljava/util/concurrent/Future;
    .locals 0

    .line 38
    iput-object p1, p0, Lcom/vkontakte/android/s;->c:Ljava/util/concurrent/Future;

    return-object p1
.end method

.method static synthetic a(Lcom/vkontakte/android/s;Landroid/content/Context;)V
    .locals 0

    .line 38
    invoke-direct {p0, p1}, Lcom/vkontakte/android/s;->c(Landroid/content/Context;)V
...
.method private a(Landroid/content/Context;Landroid/content/Intent;)[Landroid/content/Intent;
    ...
    .line 249
    invoke-direct {p0, p1}, Lcom/vkontakte/android/s;->f(Landroid/content/Context;)Landroid/content/Intent;
...
.method private c()V
    ...
    .line 86
    iget-object v0, p0, Lcom/vkontakte/android/s;->c:Ljava/util/concurrent/Future;
    ...
    new-instance v1, Lcom/vkontakte/android/s$1;

    invoke-direct {v1, p0}, Lcom/vkontakte/android/s$1;-><init>(Lcom/vkontakte/android/s;)V

    invoke-interface {v0, v1}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;

    move-result-object v0

    iput-object v0, p0, Lcom/vkontakte/android/s;->c:Ljava/util/concurrent/Future;
...
.method private c(Landroid/content/Context;)V
    ...
    .line 111
    invoke-direct {p0, p1}, Lcom/vkontakte/android/s;->e(Landroid/content/Context;)Landroid/content/pm/ShortcutInfo;
    ...
    .line 112
    invoke-direct {p0, p1}, Lcom/vkontakte/android/s;->d(Landroid/content/Context;)Landroid/content/pm/ShortcutInfo;
    ...
    .line 118
    invoke-direct {p0, p1, v3}, Lcom/vkontakte/android/s;->a(Landroid/content/Context;Lcom/vkontakte/android/UserProfile;)Landroid/content/pm/ShortcutInfo;
...
.method public a(Landroid/content/Context;)V
    ...
    sget-wide v2, Lcom/vkontakte/android/s;->b:J

    const/4 p1, 0x0

    sub-long/2addr v0, v2

    sget-wide v2, Lcom/vkontakte/android/s;->a:J
    ...
    sput-wide v0, Lcom/vkontakte/android/s;->b:J

    .line 78
    invoke-direct {p0}, Lcom/vkontakte/android/s;->c()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
