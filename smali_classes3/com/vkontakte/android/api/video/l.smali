.class public Lcom/vkontakte/android/api/video/l;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/api/video/l$a;
    }
.end annotation
...
# static fields
.field public static final a:Lcom/vkontakte/android/api/video/l$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/vkontakte/android/api/video/l$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/vkontakte/android/api/video/l$a;-><init>(Lkotlin/jvm/internal/h;)V

    sput-object v0, Lcom/vkontakte/android/api/video/l;->a:Lcom/vkontakte/android/api/video/l$a;
...
.method private constructor <init>(IILjava/lang/String;Ljava/lang/String;J)V
    ...
    iput p1, p0, Lcom/vkontakte/android/api/video/l;->b:I

    iput-wide p5, p0, Lcom/vkontakte/android/api/video/l;->d:J
    ...
    iget p6, p0, Lcom/vkontakte/android/api/video/l;->b:I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/vkontakte/android/api/video/l;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/e;

    const-string p1, "access_key"

    .line 25
    invoke-virtual {p0, p1, p3}, Lcom/vkontakte/android/api/video/l;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/e;
    ...
    iget p5, p0, Lcom/vkontakte/android/api/video/l;->b:I
    ...
    .line 29
    invoke-virtual {p0, p1, p4}, Lcom/vkontakte/android/api/video/l;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/e;

    const-string p1, "owner_id"

    .line 30
    iget p2, p0, Lcom/vkontakte/android/api/video/l;->b:I

    invoke-virtual {p0, p1, p2}, Lcom/vkontakte/android/api/video/l;->a(Ljava/lang/String;I)Lcom/vk/api/base/e;
...
.method public synthetic constructor <init>(IILjava/lang/String;Ljava/lang/String;JLkotlin/jvm/internal/h;)V
    .locals 0

    .line 14
    invoke-direct/range {p0 .. p6}, Lcom/vkontakte/android/api/video/l;-><init>(IILjava/lang/String;Ljava/lang/String;J)V
...
.method protected final a(Lorg/json/JSONObject;)Lkotlin/Triple;
    ...
    .line 41
    iget-wide v2, p0, Lcom/vkontakte/android/api/video/l;->d:J
    ...
    .line 44
    :cond_0
    sget-object p1, Lcom/vk/api/base/c;->e:Lcom/vk/api/base/c$a;

    const-string v2, "ApiConfig.callback"

    invoke-static {p1, v2}, Lkotlin/jvm/internal/l;->a(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-interface {p1}, Lcom/vk/api/base/c$a;->b()Z
    ...
    .line 52
    iget p1, p0, Lcom/vkontakte/android/api/video/l;->b:I
    ...
    .line 61
    :cond_5
    new-instance p1, Lcom/vkontakte/android/api/models/Group;

    invoke-direct {p1, v0}, Lcom/vkontakte/android/api/models/Group;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p1, v0}, Lcom/vkontakte/android/UserProfile;-><init>(Lorg/json/JSONObject;)V
    ...
    .line 57
    invoke-virtual {p1}, Lcom/vkontakte/android/UserProfile;->a()Z
