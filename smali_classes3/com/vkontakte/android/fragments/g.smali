.class public abstract Lcom/vkontakte/android/fragments/g;
...
.field private af:Lcom/vkontakte/android/fragments/g$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/vkontakte/android/fragments/g$a<",
            "TT;>;"
...
.method static synthetic a(Lcom/vkontakte/android/fragments/g;)Landroid/widget/ListAdapter;
    .locals 0

    .line 23
    iget-object p0, p0, Lcom/vkontakte/android/fragments/g;->ae:Landroid/widget/ListAdapter;

    return-object p0
.end method

.method static synthetic b(Lcom/vkontakte/android/fragments/g;)Lcom/vkontakte/android/fragments/g$a;
    .locals 0

    .line 23
    iget-object p0, p0, Lcom/vkontakte/android/fragments/g;->af:Lcom/vkontakte/android/fragments/g$a;
...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 34
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/g;->d()Landroid/app/Dialog;
    ...
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/g;->q()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 43
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/g;->l()Landroid/os/Bundle;
    ...
    .line 57
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/g;->as()Landroid/widget/ListAdapter;

    move-result-object v0

    iput-object v0, p0, Lcom/vkontakte/android/fragments/g;->ae:Landroid/widget/ListAdapter;

    .line 58
    iget-object v0, p0, Lcom/vkontakte/android/fragments/g;->ae:Landroid/widget/ListAdapter;

    invoke-virtual {p3, v0}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 59
    new-instance v0, Lcom/vkontakte/android/fragments/g$1;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/g$1;-><init>(Lcom/vkontakte/android/fragments/g;)V

    invoke-virtual {p2, v0}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 77
    iget-object p2, p0, Lcom/vkontakte/android/fragments/g;->ae:Landroid/widget/ListAdapter;
    ...
    .line 78
    new-instance p2, Lcom/vkontakte/android/fragments/g$2;

    invoke-direct {p2, p0}, Lcom/vkontakte/android/fragments/g$2;-><init>(Lcom/vkontakte/android/fragments/g;)V
...
.method public a(Lcom/vkontakte/android/fragments/g$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 93
    iput-object p1, p0, Lcom/vkontakte/android/fragments/g;->af:Lcom/vkontakte/android/fragments/g$a;

    return-void
.end method

.method public abstract as()Landroid/widget/ListAdapter;
.end method
...
.method public b(Landroid/os/Bundle;)V
    ...
    .line 30
    invoke-virtual {p0, p1, v0}, Lcom/vkontakte/android/fragments/g;->a(II)V
