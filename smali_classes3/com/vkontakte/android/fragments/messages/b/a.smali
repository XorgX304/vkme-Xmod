.class public final Lcom/vkontakte/android/fragments/messages/b/a;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/fragments/messages/b/a$a;
    }
.end annotation
...
.method private final a()Landroid/content/Context;
    ...
    .line 33
    iget-object v0, p0, Lcom/vkontakte/android/fragments/messages/b/a;->a:Lcom/vkontakte/android/fragments/messages/b/c;

    invoke-virtual {v0}, Lcom/vkontakte/android/fragments/messages/b/c;->q()Landroid/support/v4/app/FragmentActivity;
...
.method private final a(Lcom/vk/messenger/engine/models/attaches/AttachDoc;)V
    ...
    invoke-static {v1, v3, v4, v5, v6}, Lkotlin/text/l;->c(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
...
.method private final a(Lcom/vk/messenger/engine/models/messages/Msg;Lcom/vk/messenger/engine/models/messages/NestedMsg;Lcom/vk/messenger/engine/models/attaches/AttachImage;)V
    ...
    .line 83
    :cond_8
    iget-object p1, p0, Lcom/vkontakte/android/fragments/messages/b/a;->c:Lcom/vk/e/k;

    .line 85
    iget-object p3, p0, Lcom/vkontakte/android/fragments/messages/b/a;->a:Lcom/vkontakte/android/fragments/messages/b/c;

    invoke-virtual {p3}, Lcom/vkontakte/android/fragments/messages/b/c;->r()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 86
    new-instance v0, Lcom/vkontakte/android/fragments/messages/b/a$a;

    invoke-direct {v0, p0, p2}, Lcom/vkontakte/android/fragments/messages/b/a$a;-><init>(Lcom/vkontakte/android/fragments/messages/b/a;Ljava/util/List;)V

    check-cast v0, Lcom/vk/e/k$a;

    .line 83
    invoke-interface {p1, v1, p2, p3, v0}, Lcom/vk/e/k;->a(ILjava/util/List;Landroid/app/Activity;Lcom/vk/e/k$a;)V
...
.method private final b(Lcom/vk/messenger/engine/models/attaches/AttachDoc;)V
    ...
    .line 110
    iget-object v0, p0, Lcom/vkontakte/android/fragments/messages/b/a;->c:Lcom/vk/e/k;

    .line 111
    iget-object v1, p0, Lcom/vkontakte/android/fragments/messages/b/a;->a:Lcom/vkontakte/android/fragments/messages/b/c;

    invoke-virtual {v1}, Lcom/vkontakte/android/fragments/messages/b/c;->r()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 112
    new-instance v2, Lcom/vkontakte/android/fragments/messages/b/a$a;

    invoke-static {p1}, Lkotlin/collections/m;->a(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v3

    invoke-direct {v2, p0, v3}, Lcom/vkontakte/android/fragments/messages/b/a$a;-><init>(Lcom/vkontakte/android/fragments/messages/b/a;Ljava/util/List;)V
...
.method private final c(Lcom/vk/messenger/engine/models/attaches/AttachDoc;)V
    ...
    .line 119
    iget-object v2, p0, Lcom/vkontakte/android/fragments/messages/b/a;->a:Lcom/vkontakte/android/fragments/messages/b/c;

    invoke-virtual {v2}, Lcom/vkontakte/android/fragments/messages/b/c;->r()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 120
    new-instance v3, Lcom/vkontakte/android/fragments/messages/b/a$a;

    invoke-static {p1}, Lkotlin/collections/m;->a(Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    invoke-direct {v3, p0, p1}, Lcom/vkontakte/android/fragments/messages/b/a$a;-><init>(Lcom/vkontakte/android/fragments/messages/b/a;Ljava/util/List;)V
    ...
    .line 116
    invoke-interface {v0, p1, v1, v2, v3}, Lcom/vk/e/k;->b(ILjava/util/List;Landroid/app/Activity;Lcom/vk/e/k$a;)V
...
.method private final d(Lcom/vk/messenger/engine/models/attaches/AttachDoc;)V
    ...
    invoke-virtual {v1}, Lcom/vkontakte/android/fragments/messages/b/c;->q()Landroid/support/v4/app/FragmentActivity;
...
.method public a(Lcom/vk/messenger/engine/models/Member;)V
    ...
    invoke-direct {p0}, Lcom/vkontakte/android/fragments/messages/b/a;->a()Landroid/content/Context;
