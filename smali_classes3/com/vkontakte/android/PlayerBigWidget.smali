...
.method private static a(Landroid/content/Context;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p1, p0, v0}, Lcom/vk/core/d/d;-><init>(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {p1, v2, v2, v1, p0}, Lcom/vk/core/d/d;->setBounds(IIII)V
    ...
    invoke-virtual {p1, p0}, Lcom/vk/core/d/d;->draw(Landroid/graphics/Canvas;)V
...
.method public static a(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    .line 40
    new-instance v4, Lcom/vk/music/fragment/e$a;

    invoke-direct {v4}, Lcom/vk/music/fragment/e$a;-><init>()V

    invoke-virtual {v4, v0}, Lcom/vk/music/fragment/e$a;->a(Landroid/content/Context;)Landroid/content/Intent;
    ...
    const v11, 0x7f0a0c90

    const v13, 0x7f0a0c9c

    const v14, 0x7f0a0c9d

    const v15, 0x7f0a0c99

    const v12, 0x7f0a0c9f

    const v10, 0x7f0a0c9e
    ...
    .line 46
    :cond_0
    invoke-virtual {v4}, Lcom/vkontakte/android/audio/player/p;->a()Lcom/vk/dto/music/MusicTrack;
    ...
    .line 48
    new-array v7, v8, [Lcom/vkontakte/android/audio/PlayerAction;

    sget-object v16, Lcom/vkontakte/android/audio/PlayerAction;->playPause:Lcom/vkontakte/android/audio/PlayerAction;

    aput-object v16, v7, v5

    .line 49
    invoke-virtual {v4, v7}, Lcom/vkontakte/android/audio/player/p;->a([Lcom/vkontakte/android/audio/PlayerAction;)Z
    ...
    invoke-static {v0, v7}, Lcom/vkontakte/android/PlayerBigWidget;->a(Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    .line 52
    new-array v7, v7, [Lcom/vkontakte/android/audio/PlayerAction;

    sget-object v16, Lcom/vkontakte/android/audio/PlayerAction;->changeTrack:Lcom/vkontakte/android/audio/PlayerAction;

    aput-object v16, v7, v5

    sget-object v16, Lcom/vkontakte/android/audio/PlayerAction;->skipAd:Lcom/vkontakte/android/audio/PlayerAction;
    ...
    sget-object v16, Lcom/vkontakte/android/audio/PlayerAction;->shuffle:Lcom/vkontakte/android/audio/PlayerAction;
    ...
    .line 62
    invoke-static/range {p0 .. p0}, Lcom/vkontakte/android/audio/AudioFacade;->l(Landroid/content/Context;)Landroid/content/Intent;
    ...
    sget-object v16, Lcom/vkontakte/android/audio/PlayerAction;->repeat:Lcom/vkontakte/android/audio/PlayerAction;
    ...
    .line 66
    invoke-static/range {p0 .. p0}, Lcom/vkontakte/android/audio/AudioFacade;->m(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 69
    invoke-virtual {v4}, Lcom/vkontakte/android/audio/player/p;->m()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/vkontakte/android/audio/player/p;->k()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4}, Lcom/vkontakte/android/audio/player/p;->l()Ljava/lang/String;
    ...
    .line 75
    invoke-static {v3}, Lcom/vkontakte/android/PlayerBigWidget;->a(Landroid/widget/RemoteViews;)V
    ...
    .line 81
    :cond_a
    invoke-static {v4, v3}, Lcom/vkontakte/android/PlayerBigWidget;->a(Landroid/graphics/Bitmap;Landroid/widget/RemoteViews;)V
    ...
    .line 98
    invoke-static {v0, v4}, Lcom/vkontakte/android/PlayerBigWidget;->a(Landroid/content/Context;I)Landroid/graphics/Bitmap;
    ...
    .line 103
    :goto_11
    sget-object v4, Lcom/vkontakte/android/PlayerBigWidget$1;->a:[I

    invoke-static {}, Lcom/vkontakte/android/audio/AudioFacade;->k()Lcom/vkontakte/android/audio/player/LoopMode;

    move-result-object v5

    invoke-virtual {v5}, Lcom/vkontakte/android/audio/player/LoopMode;->ordinal()I
    ...
    const-class v4, Lcom/vkontakte/android/PlayerBigWidget;
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    .line 34
    invoke-static {p1, p2, p3}, Lcom/vkontakte/android/PlayerBigWidget;->a(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
