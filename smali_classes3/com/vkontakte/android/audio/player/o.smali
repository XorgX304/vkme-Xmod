...
# static fields
.field private static volatile b:Lcom/vkontakte/android/audio/player/o;
...
.method public static a()Lcom/vkontakte/android/audio/player/o;
    .locals 2

    .line 31
    sget-object v0, Lcom/vkontakte/android/audio/player/o;->b:Lcom/vkontakte/android/audio/player/o;

    if-nez v0, :cond_1

    .line 32
    const-class v0, Lcom/vkontakte/android/audio/player/o;

    monitor-enter v0

    .line 33
    :try_start_0
    sget-object v1, Lcom/vkontakte/android/audio/player/o;->b:Lcom/vkontakte/android/audio/player/o;

    if-nez v1, :cond_0

    .line 34
    new-instance v1, Lcom/vkontakte/android/audio/player/o;

    invoke-direct {v1}, Lcom/vkontakte/android/audio/player/o;-><init>()V

    sput-object v1, Lcom/vkontakte/android/audio/player/o;->b:Lcom/vkontakte/android/audio/player/o;
    ...
    invoke-direct {v0}, Lcom/vkontakte/android/audio/player/o;->q()Lcom/vkontakte/android/audio/player/o;
...
.method private q()Lcom/vkontakte/android/audio/player/o;
    .locals 4
    ...
    iget v1, v1, Lcom/vkontakte/android/audio/player/o;->c:I
    ...
    .line 45
    :cond_0
    iput v0, p0, Lcom/vkontakte/android/audio/player/o;->c:I
    ...
    iput-object v0, p0, Lcom/vkontakte/android/audio/player/o;->a:Ljava/lang/String;

    .line 47
    new-instance v0, Lcom/vk/core/preference/Preference$b;

    iget-object v1, p0, Lcom/vkontakte/android/audio/player/o;->a:Ljava/lang/String;

    invoke-direct {v0, v1}, Lcom/vk/core/preference/Preference$b;-><init>(Ljava/lang/String;)V

    const-string v1, "loop_mode"

    const-class v2, Lcom/vkontakte/android/audio/player/LoopMode;
...
.method public a(F)V
    ...
    .line 97
    iget-object v0, p0, Lcom/vkontakte/android/audio/player/o;->a:Ljava/lang/String;
...
.method public a(Lcom/vkontakte/android/audio/player/LoopMode;)V
    .locals 3
...
.method public f()Lcom/vkontakte/android/audio/player/LoopMode;
    .locals 4
