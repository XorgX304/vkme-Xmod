...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/vkontakte/android/attachments/SnippetAttachment;
...
.method public static a(Lorg/json/JSONObject;Ljava/lang/String;Landroid/util/SparseArray;)Lcom/vk/dto/common/Attachment;
    ...
    :pswitch_0
    :try_start_2
    sget-object v1, Lcom/vkontakte/android/attachments/NarrativeAttachment;->a:Lcom/vkontakte/android/attachments/NarrativeAttachment$a;

    if-eqz v2, :cond_1

    const-string v3, "owner_id"

    invoke-static {v8, v3, v6}, Lcom/vk/core/extensions/l;->a(Lorg/json/JSONObject;Ljava/lang/String;I)I
    ...
    :goto_2
    invoke-virtual {v1, v8, v5}, Lcom/vkontakte/android/attachments/NarrativeAttachment$a;->a(Lorg/json/JSONObject;Lcom/vk/dto/newsfeed/Owner;)Lcom/vkontakte/android/attachments/NarrativeAttachment;
    ...
    .line 239
    :pswitch_1
    invoke-static {v8, v2}, Lcom/vkontakte/android/attachments/PodcastAttachment;->a(Lorg/json/JSONObject;Landroid/util/SparseArray;)Lcom/vkontakte/android/attachments/PodcastAttachment;
    ...
    .line 237
    :pswitch_2
    new-instance v1, Lcom/vkontakte/android/attachments/PrettyCardAttachment;

    invoke-direct {v1, v8}, Lcom/vkontakte/android/attachments/PrettyCardAttachment;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {v1, v2}, Lcom/vkontakte/android/attachments/AudioArtistAttachment;-><init>(Lcom/vk/dto/music/Artist;)V
    ...
    .line 233
    :cond_2
    new-instance v2, Lcom/vkontakte/android/attachments/AudioPlaylistAttachment;

    invoke-direct {v2, v1}, Lcom/vkontakte/android/attachments/AudioPlaylistAttachment;-><init>(Lcom/vk/dto/music/Playlist;)V

    return-object v2

    .line 225
    :pswitch_5
    new-instance v1, Lcom/vkontakte/android/attachments/ChronicleAttachment;
    ...
    invoke-direct/range {v7 .. v15}, Lcom/vkontakte/android/attachments/ChronicleAttachment;-><init>(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 223
    new-instance v5, Lcom/vkontakte/android/attachments/StickerAttachment;
    ...
    invoke-direct {v5, v3, v1, v2, v7}, Lcom/vkontakte/android/attachments/StickerAttachment;-><init>(ILcom/vk/dto/common/NotificationImage;Ljava/lang/String;I)V

    return-object v5

    .line 217
    :pswitch_7
    new-instance v1, Lcom/vkontakte/android/attachments/WikiAttachment;
    ...
    invoke-direct {v1, v2, v3, v5, v7}, Lcom/vkontakte/android/attachments/WikiAttachment;-><init>(Ljava/lang/String;Ljava/lang/String;II)V

    return-object v1

    .line 215
    :pswitch_8
    new-instance v1, Lcom/vkontakte/android/attachments/NoteAttachment;
    ...
    invoke-direct {v1, v2, v3, v5}, Lcom/vkontakte/android/attachments/NoteAttachment;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v1, v8, v2}, Lcom/vkontakte/android/attachments/PollAttachment;-><init>(Lorg/json/JSONObject;Landroid/util/SparseArray;)V

    return-object v1

    .line 211
    :pswitch_a
    sget-object v1, Lcom/vkontakte/android/attachments/ArticleAttachment;->a:Lcom/vkontakte/android/attachments/ArticleAttachment$b;
    ...
    :goto_3
    invoke-virtual {v1, v8, v5}, Lcom/vkontakte/android/attachments/ArticleAttachment$b;->a(Lorg/json/JSONObject;Lcom/vk/dto/newsfeed/Owner;)Lcom/vkontakte/android/attachments/ArticleAttachment;
    ...
    .line 201
    invoke-static {v8, v2}, Lcom/vkontakte/android/attachments/VideoSnippetAttachment;->a(Lorg/json/JSONObject;Landroid/util/SparseArray;)Lcom/vkontakte/android/attachments/VideoSnippetAttachment;
    ...
    invoke-static {v8}, Lcom/vkontakte/android/attachments/SnippetAttachment;->a(Lorg/json/JSONObject;)Lcom/vk/dto/common/Attachment;
    ...
    invoke-direct {v1, v2, v3, v5, v7}, Lcom/vkontakte/android/attachments/LinkAttachment;-><init>(Lcom/vk/common/links/AwayLink;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v8}, Lcom/vkontakte/android/api/Document;-><init>(Lorg/json/JSONObject;)V

    invoke-direct {v1, v2}, Lcom/vkontakte/android/attachments/GraffitiAttachment;-><init>(Lcom/vkontakte/android/api/Document;)V
    ...
    invoke-direct {v1, v2}, Lcom/vkontakte/android/attachments/AudioMessageAttachment;-><init>(Lcom/vkontakte/android/api/Document;)V
    ...
    invoke-direct {v1, v2}, Lcom/vkontakte/android/attachments/DocumentAttachment;-><init>(Lcom/vkontakte/android/api/Document;)V
    ...
    invoke-direct {v2, v1}, Lcom/vkontakte/android/attachments/VideoAttachment;-><init>(Lcom/vk/dto/common/VideoFile;)V
    ...
    invoke-direct {v1, v2}, Lcom/vkontakte/android/attachments/MarketAlbumAttachment;-><init>(Lcom/vk/dto/common/GoodAlbum;)V
    ...
    invoke-direct {v1, v2}, Lcom/vkontakte/android/attachments/AudioAttachment;-><init>(Lcom/vk/dto/music/MusicTrack;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/vkontakte/android/attachments/AlbumAttachment;-><init>(Lcom/vk/dto/photo/Photo;I)V
    ...
    .line 167
    new-instance v2, Lcom/vkontakte/android/attachments/AlbumAttachment;
    ...
    invoke-direct {v2, v1, v3}, Lcom/vkontakte/android/attachments/AlbumAttachment;-><init>(Lcom/vk/dto/photo/Photo;I)V
    ...
    invoke-direct {v1, v3, v2}, Lcom/vkontakte/android/attachments/PhotoAttachment;-><init>(Lcom/vk/dto/photo/Photo;Landroid/util/SparseArray;)V
    ...
    invoke-direct {v1, v8}, Lcom/vkontakte/android/attachments/GraffitiAttachment;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {v1, v3}, Lcom/vkontakte/android/attachments/MarketAttachment;-><init>(Lcom/vk/dto/common/Good;)V
...
.method public static a(Lorg/json/JSONObject;)Lcom/vkontakte/android/attachments/GeoAttachment;
    ...
    invoke-direct {v0, v3}, Lcom/vkontakte/android/GeoPlace;-><init>(Lorg/json/JSONObject;)V
    ...
    iget-object v8, v0, Lcom/vkontakte/android/GeoPlace;->h:Ljava/lang/String;

    iget-object v1, v0, Lcom/vkontakte/android/GeoPlace;->j:Ljava/lang/String;
    ...
    :cond_5
    iget-object v1, v0, Lcom/vkontakte/android/GeoPlace;->k:Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/vkontakte/android/GeoPlace;->l:Ljava/lang/String;
    ...
    :goto_4
    iget v10, v0, Lcom/vkontakte/android/GeoPlace;->b:I

    iget-object v11, v0, Lcom/vkontakte/android/GeoPlace;->i:Ljava/lang/String;
...
.method public static a(Lcom/vk/dto/common/Attachment;)Z
    ...
    .line 367
    instance-of v0, p0, Lcom/vkontakte/android/attachments/e;
...
.method public static b(Ljava/util/List;)Ljava/util/List;
    ...
    .line 102
    invoke-static {p0}, Lcom/vkontakte/android/attachments/a;->a(Ljava/util/List;)V
...
.method public static c(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/vk/dto/common/Attachment;->bg_()Ljava/lang/String;
    ...
    .line 286
    :cond_1
    invoke-static {p0}, Lcom/vkontakte/android/attachments/a;->e(Ljava/util/List;)Z
