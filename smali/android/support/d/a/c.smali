.class public Landroid/support/d/a/c;
...
.field private c:Landroid/support/d/a/c$a;
...
.method constructor <init>()V
    ...
    .line 164
    invoke-direct {p0, v0, v0, v0}, Landroid/support/d/a/c;-><init>(Landroid/content/Context;Landroid/support/d/a/c$a;Landroid/content/res/Resources;)V
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 168
    invoke-direct {p0, p1, v0, v0}, Landroid/support/d/a/c;-><init>(Landroid/content/Context;Landroid/support/d/a/c$a;Landroid/content/res/Resources;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Landroid/support/d/a/c$a;Landroid/content/res/Resources;)V
    .locals 2
    ...
    .line 152
    iput-object v0, p0, Landroid/support/d/a/c;->e:Landroid/animation/ArgbEvaluator;

    .line 157
    iput-object v0, p0, Landroid/support/d/a/c;->f:Landroid/animation/Animator$AnimatorListener;

    .line 160
    iput-object v0, p0, Landroid/support/d/a/c;->g:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/d/a/c;->a:Landroid/graphics/drawable/Drawable$Callback;

    .line 174
    iput-object p1, p0, Landroid/support/d/a/c;->d:Landroid/content/Context;

    if-eqz p2, :cond_0

    .line 176
    iput-object p2, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;
    ...
    iget-object v1, p0, Landroid/support/d/a/c;->a:Landroid/graphics/drawable/Drawable$Callback;

    invoke-direct {v0, p1, p2, v1, p3}, Landroid/support/d/a/c$a;-><init>(Landroid/content/Context;Landroid/support/d/a/c$a;Landroid/graphics/drawable/Drawable$Callback;Landroid/content/res/Resources;)V

    iput-object v0, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;
...
.method private a(Landroid/animation/Animator;)V
    ...
    invoke-direct {p0, v2}, Landroid/support/d/a/c;->a(Landroid/animation/Animator;)V
    ...
    .line 659
    :cond_1
    iget-object v0, p0, Landroid/support/d/a/c;->e:Landroid/animation/ArgbEvaluator;
...
.method private a(Ljava/lang/String;Landroid/animation/Animator;)V
    ...
    .line 668
    iget-object v0, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;

    iget-object v0, v0, Landroid/support/d/a/c$a;->b:Landroid/support/d/a/i;

    invoke-virtual {v0, p1}, Landroid/support/d/a/i;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 671
    invoke-direct {p0, p2}, Landroid/support/d/a/c;->a(Landroid/animation/Animator;)V

    .line 673
    :cond_0
    iget-object v0, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;

    invoke-static {v0}, Landroid/support/d/a/c$a;->a(Landroid/support/d/a/c$a;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v1}, Landroid/support/d/a/c$a;->a(Landroid/support/d/a/c$a;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    iput-object v1, v0, Landroid/support/d/a/c$a;->d:Landroid/support/v4/f/a;
    ...
    iget-object v0, v0, Landroid/support/d/a/c$a;->d:Landroid/support/v4/f/a;
...
.method public applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    .line 508
    iget-object v0, p0, Landroid/support/d/a/c;->b:Landroid/graphics/drawable/Drawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 285
    iget-object p1, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;

    iget-object p1, p1, Landroid/support/d/a/c$a;->c:Landroid/animation/AnimatorSet;
...
.method public getChangingConfigurations()I
    ...
    iget-object v1, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;

    iget v1, v1, Landroid/support/d/a/c$a;->a:I
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    iget-object v1, p0, Landroid/support/d/a/c;->b:Landroid/graphics/drawable/Drawable;
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 448
    sget-object v0, Landroid/support/d/a/a;->e:[I

    .line 449
    invoke-static {p1, p4, p3, v0}, Landroid/support/v4/content/b/c;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 458
    invoke-static {p1, v3, p4}, Landroid/support/d/a/i;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/d/a/i;

    move-result-object v3

    .line 460
    invoke-virtual {v3, v4}, Landroid/support/d/a/i;->a(Z)V

    .line 461
    iget-object v4, p0, Landroid/support/d/a/c;->a:Landroid/graphics/drawable/Drawable$Callback;

    invoke-virtual {v3, v4}, Landroid/support/d/a/i;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 462
    iget-object v4, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;

    iget-object v4, v4, Landroid/support/d/a/c$a;->b:Landroid/support/d/a/i;
    ...
    invoke-virtual {v4, v5}, Landroid/support/d/a/i;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 465
    :cond_2
    iget-object v4, p0, Landroid/support/d/a/c;->c:Landroid/support/d/a/c$a;

    iput-object v3, v4, Landroid/support/d/a/c$a;->b:Landroid/support/d/a/i;
    ...
    .line 469
    sget-object v0, Landroid/support/d/a/a;->f:[I
    ...
    .line 479
    iget-object v5, p0, Landroid/support/d/a/c;->d:Landroid/content/Context;
    ...
    invoke-static {v5, v4}, Landroid/support/d/a/e;->a(Landroid/content/Context;I)Landroid/animation/Animator;

    move-result-object v4

    .line 484
    invoke-direct {p0, v3, v4}, Landroid/support/d/a/c;->a(Ljava/lang/String;Landroid/animation/Animator;)V
    ...
    invoke-virtual {p1}, Landroid/support/d/a/c$a;->a()V
...
.method public isRunning()Z
    ...
    iget-object v0, v0, Landroid/support/d/a/c$a;->c:Landroid/animation/AnimatorSet;
