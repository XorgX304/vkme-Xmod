...
.field private l:Landroid/support/v7/widget/l;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 162
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/widget/x;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, v2}, Landroid/support/design/widget/v;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {p1, p0}, Landroid/support/v7/widget/l;-><init>(Landroid/widget/ImageView;)V

    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->l:Landroid/support/v7/widget/l;

    .line 184
    iget-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->l:Landroid/support/v7/widget/l;
...
.method static synthetic a(Landroid/support/design/widget/FloatingActionButton;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 69
    invoke-super {p0, p1}, Landroid/support/design/widget/x;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    return-void
.end method

.method private c(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/i$c;
    .locals 1
...
.method private c()Landroid/support/design/widget/i;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/j;-><init>(Landroid/support/design/widget/x;Landroid/support/design/widget/n;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/i;-><init>(Landroid/support/design/widget/x;Landroid/support/design/widget/n;)V
...
.method a(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->c(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/i$c;
...
.method protected drawableStateChanged()V
    ...
    .line 507
    invoke-super {p0}, Landroid/support/design/widget/x;->drawableStateChanged()V
...
.method public jumpDrawablesToCurrentState()V
    ...
    .line 513
    invoke-super {p0}, Landroid/support/design/widget/x;->jumpDrawablesToCurrentState()V
...
.method protected onAttachedToWindow()V
    ...
    .line 495
    invoke-super {p0}, Landroid/support/design/widget/x;->onAttachedToWindow()V
...
.method protected onDetachedFromWindow()V
    ...
    .line 501
    invoke-super {p0}, Landroid/support/design/widget/x;->onDetachedFromWindow()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    :goto_0
    invoke-super {p0, p1}, Landroid/support/design/widget/x;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setImageResource(I)V
    ...
    .line 316
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->l:Landroid/support/v7/widget/l;
...
.method public bridge synthetic setVisibility(I)V
    ...
    .line 68
    invoke-super {p0, p1}, Landroid/support/design/widget/x;->setVisibility(I)V
