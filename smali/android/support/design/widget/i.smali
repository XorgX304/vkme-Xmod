...
.field f:Landroid/support/design/widget/e;
...
.field final n:Landroid/support/design/widget/x;

.field final o:Landroid/support/design/widget/n;

.field private final p:Landroid/support/design/widget/p;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/i;->a:Landroid/view/animation/Interpolator;
    ...
    sput-object v1, Landroid/support/design/widget/i;->j:[I
...
.method constructor <init>(Landroid/support/design/widget/x;Landroid/support/design/widget/n;)V
    .locals 1
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->r:Landroid/graphics/Rect;

    .line 90
    iput-object p1, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    .line 91
    iput-object p2, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/n;
    ...
    iput-object p1, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/p;

    .line 96
    iget-object p1, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/p;

    sget-object p2, Landroid/support/design/widget/i;->j:[I
    ...
    .line 97
    invoke-direct {p0, v0}, Landroid/support/design/widget/i;->a(Landroid/support/design/widget/i$e;)Landroid/animation/ValueAnimator;
    ...
    sget-object p2, Landroid/support/design/widget/i;->k:[I
    ...
    sget-object p2, Landroid/support/design/widget/i;->l:[I
    ...
    sget-object p2, Landroid/support/design/widget/i;->m:[I

    new-instance v0, Landroid/support/design/widget/i$a;

    invoke-direct {v0, p0}, Landroid/support/design/widget/i$a;-><init>(Landroid/support/design/widget/i;)V
    ...
    .line 107
    iget-object p1, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    invoke-virtual {p1}, Landroid/support/design/widget/x;->getRotation()F

    move-result p1

    iput p1, p0, Landroid/support/design/widget/i;->q:F

    return-void
.end method

.method private a(Landroid/support/design/widget/i$e;)Landroid/animation/ValueAnimator;
    .locals 3
    ...
    .line 415
    sget-object v1, Landroid/support/design/widget/i;->a:Landroid/view/animation/Interpolator;
...
.method private o()V
    ...
    .line 371
    iget-object v0, p0, Landroid/support/design/widget/i;->s:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    if-nez v0, :cond_0

    .line 372
    new-instance v0, Landroid/support/design/widget/i$3;

    invoke-direct {v0, p0}, Landroid/support/design/widget/i$3;-><init>(Landroid/support/design/widget/i;)V

    iput-object v0, p0, Landroid/support/design/widget/i;->s:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method private p()Z
    ...
    .line 505
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;
...
.method private q()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/x;->getLayerType()I
    ...
    invoke-virtual {v0, v2, v1}, Landroid/support/design/widget/x;->setLayerType(ILandroid/graphics/Paint;)V
    ...
    .line 527
    :cond_2
    iget-object v0, p0, Landroid/support/design/widget/i;->f:Landroid/support/design/widget/e;
...
.method a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/e;
    ...
    .line 347
    invoke-virtual {p0}, Landroid/support/design/widget/i;->i()Landroid/support/design/widget/e;
    ...
    .line 353
    invoke-virtual {v1, p1}, Landroid/support/design/widget/e;->a(F)V
...
.method a(FF)V
    ...
    .line 190
    iget-object p2, p0, Landroid/support/design/widget/i;->c:Landroid/support/design/widget/m;
    ...
    invoke-virtual {p2, p1, v0}, Landroid/support/design/widget/m;->a(FF)V

    .line 192
    invoke-virtual {p0}, Landroid/support/design/widget/i;->e()V
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object p2, p0, Landroid/support/design/widget/i;->e:Landroid/graphics/drawable/Drawable;

    .line 126
    iget-object p2, p0, Landroid/support/design/widget/i;->e:Landroid/graphics/drawable/Drawable;
    ...
    .line 130
    invoke-virtual {p0, p4, p1}, Landroid/support/design/widget/i;->a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/e;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/widget/i;->f:Landroid/support/design/widget/e;
    ...
    iget-object p4, p0, Landroid/support/design/widget/i;->f:Landroid/support/design/widget/e;

    aput-object p4, p1, v0

    iget-object p4, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/drawable/Drawable;

    aput-object p4, p1, p3

    iget-object p3, p0, Landroid/support/design/widget/i;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p2, p0, Landroid/support/design/widget/i;->g:Landroid/graphics/drawable/Drawable;

    .line 139
    new-instance p1, Landroid/support/design/widget/m;

    iget-object p2, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    .line 140
    invoke-virtual {p2}, Landroid/support/design/widget/x;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Landroid/support/design/widget/i;->g:Landroid/graphics/drawable/Drawable;

    iget-object p2, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/n;
    ...
    iget p2, p0, Landroid/support/design/widget/i;->h:F

    iget p3, p0, Landroid/support/design/widget/i;->i:F
    ...
    iput-object p1, p0, Landroid/support/design/widget/i;->c:Landroid/support/design/widget/m;

    .line 145
    iget-object p1, p0, Landroid/support/design/widget/i;->c:Landroid/support/design/widget/m;

    invoke-virtual {p1, v0}, Landroid/support/design/widget/m;->a(Z)V

    .line 146
    iget-object p1, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/n;
...
.method a(Landroid/support/design/widget/i$c;Z)V
    .locals 3
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/x;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    .line 212
    invoke-direct {p0}, Landroid/support/design/widget/i;->p()Z
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/design/widget/i$1;-><init>(Landroid/support/design/widget/i;ZLandroid/support/design/widget/i$c;)V
    ...
    :goto_0
    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/x;->a(IZ)V

    if-eqz p1, :cond_3

    .line 252
    invoke-interface {p1}, Landroid/support/design/widget/i$c;->b()V
...
.method a([I)V
    ...
    .line 197
    iget-object v0, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/p;
...
.method b(Landroid/support/design/widget/i$c;Z)V
    .locals 3
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/x;->getVisibility()I
    ...
    invoke-virtual {v0, v2}, Landroid/support/design/widget/x;->setAlpha(F)V

    .line 271
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    invoke-virtual {v0, v2}, Landroid/support/design/widget/x;->setScaleY(F)V

    .line 272
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    invoke-virtual {v0, v2}, Landroid/support/design/widget/x;->setScaleX(F)V
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/design/widget/i$2;-><init>(Landroid/support/design/widget/i;ZLandroid/support/design/widget/i$c;)V
    ...
    invoke-virtual {v0, v2, p2}, Landroid/support/design/widget/x;->a(IZ)V

    .line 297
    iget-object p2, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    invoke-virtual {p2, v1}, Landroid/support/design/widget/x;->setAlpha(F)V

    .line 298
    iget-object p2, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    invoke-virtual {p2, v1}, Landroid/support/design/widget/x;->setScaleY(F)V

    .line 299
    iget-object p2, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/x;

    invoke-virtual {p2, v1}, Landroid/support/design/widget/x;->setScaleX(F)V
...
.method final e()V
    ...
    .line 315
    iget-object v0, p0, Landroid/support/design/widget/i;->r:Landroid/graphics/Rect;
    ...
    .line 318
    iget-object v1, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/n;
...
.method f()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/x;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Landroid/support/design/widget/i;->s:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method j()V
    ...
    .line 366
    invoke-direct {p0}, Landroid/support/design/widget/i;->q()V
