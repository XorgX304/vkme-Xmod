...
.method private d()V
    ...
    .line 615
    invoke-direct {p0}, Landroid/support/a/b;->e()F
...
# virtual methods
.method public a(F)Landroid/support/a/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(F)TT;"
    ...
    .line 378
    iput p1, p0, Landroid/support/a/b;->p:F

    const/4 p1, 0x1

    .line 379
    iput-boolean p1, p0, Landroid/support/a/b;->q:Z
...
.method public a()V
    ...
    .line 579
    invoke-direct {p0}, Landroid/support/a/b;->d()V
...
.method public a(J)Z
    ...
    invoke-virtual {p0, p1}, Landroid/support/a/b;->e(F)V

    return v1

    .line 644
    :cond_0
    iget-wide v2, p0, Landroid/support/a/b;->w:J
    ...
    .line 646
    invoke-virtual {p0, v2, v3}, Landroid/support/a/b;->b(J)Z
    ...
    iget v0, p0, Landroid/support/a/b;->v:F
    ...
    invoke-virtual {p0, p2}, Landroid/support/a/b;->e(F)V

    if-eqz p1, :cond_1

    .line 654
    invoke-direct {p0, v1}, Landroid/support/a/b;->a(Z)V

    :cond_1
    return p1
.end method

.method public b(F)Landroid/support/a/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(F)TT;"
    ...
    .line 402
    iput p1, p0, Landroid/support/a/b;->o:F
...
.method public c(F)Landroid/support/a/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(F)TT;"
    ...
    .line 419
    iput p1, p0, Landroid/support/a/b;->u:F

    return-object p0
.end method

.method public d(F)Landroid/support/a/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(F)TT;"
    ...
    .line 432
    iput p1, p0, Landroid/support/a/b;->v:F
