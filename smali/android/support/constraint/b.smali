...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/support/constraint/b;->a:[I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintLeft_toLeftOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintLeft_toRightOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintRight_toLeftOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintRight_toRightOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintTop_toTopOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintTop_toBottomOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintBottom_toTopOf:I
    ...
    sget v2, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintBottom_toBottomOf:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintCircle:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintCircleRadius:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintCircleAngle:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintWidth_percent:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_layout_constraintHeight_percent:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_chainUseRtl:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_barrierDirection:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_constraint_referenced_ids:I
    ...
    sget v1, Landroid/support/constraint/e$b;->ConstraintSet_barrierAllowsGoneWidgets:I
...
.method private a(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/support/constraint/b$a;
    ...
    .line 2191
    invoke-direct {p0, v0, p1}, Landroid/support/constraint/b;->a(Landroid/support/constraint/b$a;Landroid/content/res/TypedArray;)V
...
.method private a(Landroid/support/constraint/b$a;Landroid/content/res/TypedArray;)V
    ...
    .line 2429
    :pswitch_1
    iget-boolean v3, p1, Landroid/support/constraint/b$a;->ar:Z

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p1, Landroid/support/constraint/b$a;->ar:Z
    ...
    iput-object v2, p1, Landroid/support/constraint/b$a;->av:Ljava/lang/String;

    goto/16 :goto_1

    .line 2423
    :pswitch_3
    iget v3, p1, Landroid/support/constraint/b$a;->as:I

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, p1, Landroid/support/constraint/b$a;->as:I
    ...
    iput v2, p1, Landroid/support/constraint/b$a;->aq:F
    ...
    iput v2, p1, Landroid/support/constraint/b$a;->ap:F
    ...
    .line 2361
    iput-boolean v3, p1, Landroid/support/constraint/b$a;->V:Z
    ...
    .line 2395
    :pswitch_18
    iget v3, p1, Landroid/support/constraint/b$a;->Q:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v2

    iput v2, p1, Landroid/support/constraint/b$a;->Q:F
...
.method private a(Landroid/view/View;Ljava/lang/String;)[I
    ...
    .line 2452
    :try_start_0
    const-class v6, Landroid/support/constraint/e$a;
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/constraint/b;->a(Landroid/support/constraint/ConstraintLayout;)V
...
.method public a(Landroid/support/constraint/ConstraintLayout;)V
    ...
    .line 715
    :cond_0
    iget-object v5, p0, Landroid/support/constraint/b;->b:Ljava/util/HashMap;
    ...
    check-cast v5, Landroid/support/constraint/b$a;

    .line 719
    invoke-static {v5, v4, v3}, Landroid/support/constraint/b$a;->a(Landroid/support/constraint/b$a;ILandroid/support/constraint/ConstraintLayout$a;)V
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->J:I
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->U:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->X:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->Y:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->Z:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->aa:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->ab:F
    ...
    .line 733
    :cond_2
    iput v3, v5, Landroid/support/constraint/b$a;->ac:F

    .line 734
    iput v4, v5, Landroid/support/constraint/b$a;->ad:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->ae:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->af:F
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->ag:F

    .line 741
    iget-boolean v3, v5, Landroid/support/constraint/b$a;->V:Z
    ...
    iput v3, v5, Landroid/support/constraint/b$a;->W:F
    ...
    iput-boolean v3, v5, Landroid/support/constraint/b$a;->ar:Z
    ...
    iput-object v3, v5, Landroid/support/constraint/b$a;->au:[I
    ...
    iput v2, v5, Landroid/support/constraint/b$a;->as:I
...
.method public a(Landroid/support/constraint/c;)V
    ...
    .line 764
    invoke-virtual {p1, v1}, Landroid/support/constraint/c;->getChildAt(I)Landroid/view/View;
    ...
    .line 777
    invoke-static {v5, v2, v4, v3}, Landroid/support/constraint/b$a;->a(Landroid/support/constraint/b$a;Landroid/support/constraint/a;ILandroid/support/constraint/c$a;)V

    .line 779
    :cond_2
    invoke-static {v5, v4, v3}, Landroid/support/constraint/b$a;->a(Landroid/support/constraint/b$a;ILandroid/support/constraint/c$a;)V
...
.method public b(Landroid/content/Context;I)V
    ...
    .line 2162
    iput-boolean v1, v2, Landroid/support/constraint/b$a;->a:Z

    .line 2164
    :cond_0
    iget-object v0, p0, Landroid/support/constraint/b;->b:Ljava/util/HashMap;

    iget v1, v2, Landroid/support/constraint/b$a;->d:I
...
.method c(Landroid/support/constraint/ConstraintLayout;)V
    ...
    iget-object v2, p0, Landroid/support/constraint/b;->b:Ljava/util/HashMap;
    ...
    .line 806
    :cond_0
    iget-object v7, p0, Landroid/support/constraint/b;->b:Ljava/util/HashMap;
    ...
    .line 810
    iput v4, v7, Landroid/support/constraint/b$a;->at:I

    .line 812
    :cond_1
    iget v8, v7, Landroid/support/constraint/b$a;->at:I

    if-eq v8, v3, :cond_4

    .line 813
    iget v3, v7, Landroid/support/constraint/b$a;->at:I
    ...
    .line 817
    iget v4, v7, Landroid/support/constraint/b$a;->as:I

    invoke-virtual {v3, v4}, Landroid/support/constraint/Barrier;->setType(I)V

    .line 818
    iget-boolean v4, v7, Landroid/support/constraint/b$a;->ar:Z

    invoke-virtual {v3, v4}, Landroid/support/constraint/Barrier;->setAllowsGoneWidget(Z)V

    .line 819
    iget-object v4, v7, Landroid/support/constraint/b$a;->au:[I
    ...
    .line 821
    :cond_3
    iget-object v4, v7, Landroid/support/constraint/b$a;->av:Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v4}, Landroid/support/constraint/b;->a(Landroid/view/View;Ljava/lang/String;)[I
    ...
    .line 831
    invoke-virtual {v7, v3}, Landroid/support/constraint/b$a;->a(Landroid/support/constraint/ConstraintLayout$a;)V

    .line 832
    invoke-virtual {v5, v3}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 833
    iget v3, v7, Landroid/support/constraint/b$a;->J:I
    ...
    .line 835
    iget v3, v7, Landroid/support/constraint/b$a;->U:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setAlpha(F)V

    .line 836
    iget v3, v7, Landroid/support/constraint/b$a;->X:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setRotation(F)V

    .line 837
    iget v3, v7, Landroid/support/constraint/b$a;->Y:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setRotationX(F)V

    .line 838
    iget v3, v7, Landroid/support/constraint/b$a;->Z:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setRotationY(F)V

    .line 839
    iget v3, v7, Landroid/support/constraint/b$a;->aa:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setScaleX(F)V

    .line 840
    iget v3, v7, Landroid/support/constraint/b$a;->ab:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setScaleY(F)V

    .line 841
    iget v3, v7, Landroid/support/constraint/b$a;->ac:F
    ...
    .line 844
    :cond_5
    iget v3, v7, Landroid/support/constraint/b$a;->ad:F
    ...
    .line 847
    :cond_6
    iget v3, v7, Landroid/support/constraint/b$a;->ae:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setTranslationX(F)V

    .line 848
    iget v3, v7, Landroid/support/constraint/b$a;->af:F
    ...
    .line 850
    iget v3, v7, Landroid/support/constraint/b$a;->ag:F

    invoke-virtual {v5, v3}, Landroid/view/View;->setTranslationZ(F)V

    .line 851
    iget-boolean v3, v7, Landroid/support/constraint/b$a;->V:Z

    if-eqz v3, :cond_7

    .line 852
    iget v3, v7, Landroid/support/constraint/b$a;->W:F
    ...
    check-cast v2, Landroid/support/constraint/b$a;

    .line 860
    iget v5, v2, Landroid/support/constraint/b$a;->at:I
    ...
    .line 865
    iget-object v6, v2, Landroid/support/constraint/b$a;->au:[I
    ...
    .line 867
    :cond_b
    iget-object v6, v2, Landroid/support/constraint/b$a;->av:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v6}, Landroid/support/constraint/b;->a(Landroid/view/View;Ljava/lang/String;)[I

    move-result-object v6

    iput-object v6, v2, Landroid/support/constraint/b$a;->au:[I
    ...
    :cond_c
    :goto_3
    iget v6, v2, Landroid/support/constraint/b$a;->as:I
    ...
    .line 876
    invoke-virtual {v2, v6}, Landroid/support/constraint/b$a;->a(Landroid/support/constraint/ConstraintLayout$a;)V
    ...
    :cond_d
    :goto_4
    iget-boolean v5, v2, Landroid/support/constraint/b$a;->a:Z
    ...
    .line 885
    invoke-virtual {v2, v1}, Landroid/support/constraint/b$a;->a(Landroid/support/constraint/ConstraintLayout$a;)V
