...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bb;->c:Landroid/support/v7/widget/RecyclerView$n;
...
.method private b()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bb;->c:Landroid/support/v7/widget/RecyclerView$n;
...
.method private b(Landroid/support/v7/widget/RecyclerView$i;II)Z
    ...
    .line 163
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bb;->b(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 168
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/bb;->a(Landroid/support/v7/widget/RecyclerView$i;II)I
...
.method a()V
    ...
    .line 191
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bb;->a(Landroid/support/v7/widget/RecyclerView$i;)Landroid/view/View;
    ...
    .line 195
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/bb;->a(Landroid/support/v7/widget/RecyclerView$i;Landroid/view/View;)[I
...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 102
    iget-object p1, p0, Landroid/support/v7/widget/bb;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bb;->b:Landroid/widget/Scroller;
...
.method public a(II)Z
    ...
    .line 77
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroid/support/v7/widget/bb;->b(Landroid/support/v7/widget/RecyclerView$i;II)Z
...
.method protected b(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 211
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bb;->c(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/al;
...
.method public b(II)[I
    ...
    .line 142
    iget-object p1, p0, Landroid/support/v7/widget/bb;->b:Landroid/widget/Scroller;
...
.method protected c(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/al;
    .locals 1
    ...
    .line 229
    :cond_0
    new-instance p1, Landroid/support/v7/widget/bb$2;
    ...
    invoke-direct {p1, p0, v0}, Landroid/support/v7/widget/bb$2;-><init>(Landroid/support/v7/widget/bb;Landroid/content/Context;)V
