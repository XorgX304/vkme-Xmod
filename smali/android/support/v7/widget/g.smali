...
.method constructor <init>(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->b:Landroid/support/v7/widget/j;
...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 172
    iget-object v0, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bg;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bg;
    ...
    invoke-static {v1}, Landroid/support/v4/view/t;->u(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/view/t;->v(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
...
.method private d()Z
    ...
    .line 154
    iget-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bg;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .line 99
    iget-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bg;
...
.method a(I)V
    ...
    .line 76
    iget-object v0, p0, Landroid/support/v7/widget/g;->b:Landroid/support/v7/widget/j;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bg;
    ...
    .line 94
    iget-object p1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bg;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 52
    iget-object p2, p0, Landroid/support/v7/widget/g;->b:Landroid/support/v7/widget/j;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bg;
    ...
    .line 142
    iget-object p1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bg;
    ...
    .line 144
    iput-object p1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bg;
...
.method c()V
    ...
    .line 126
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bg;
    ...
    .line 129
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bg;
