...
.field private final f:Landroid/support/v7/widget/t;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    .line 67
    iput v0, p0, Landroid/support/v7/widget/r;->g:I
    ...
    invoke-direct {p1, v0}, Landroid/support/v7/widget/t;-><init>(Landroid/widget/TextView;)V

    iput-object p1, p0, Landroid/support/v7/widget/r;->f:Landroid/support/v7/widget/t;

    return-void
.end method

.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/j;I)Landroid/support/v7/widget/bg;
    .locals 0
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/bi;)V
    ...
    iget v1, p0, Landroid/support/v7/widget/r;->g:I
    ...
    .line 253
    iput-boolean v2, p0, Landroid/support/v7/widget/r;->i:Z
    ...
    iput-object p1, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;
    ...
    .line 215
    iput-object v0, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;
    ...
    .line 234
    :try_start_0
    iget p1, p0, Landroid/support/v7/widget/r;->g:I

    invoke-virtual {p2, v0, p1, v3}, Landroid/support/v7/widget/bi;->a(IILandroid/support/v4/content/b/b$a;)Landroid/graphics/Typeface;
    ...
    .line 236
    iget-object p1, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;
    ...
    .line 245
    iget p2, p0, Landroid/support/v7/widget/r;->g:I
...
.method static synthetic a(Landroid/support/v7/widget/r;Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    .locals 0

    .line 43
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/r;->a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
...
.method private a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    .line 273
    iput-object p2, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;
    ...
    .line 276
    iget v0, p0, Landroid/support/v7/widget/r;->g:I
...
.method private b(IF)V
    ...
    .line 373
    iget-object v0, p0, Landroid/support/v7/widget/r;->f:Landroid/support/v7/widget/t;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/t;->a(IF)V
...
.method a()V
    ...
    .line 314
    iget-object v0, p0, Landroid/support/v7/widget/r;->b:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/r;->c:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/r;->d:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/r;->e:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/r;->b:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/r;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/r;->c:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/r;->d:Landroid/support/v7/widget/bg;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/r;->e:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/r;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
...
.method a(IIII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v7/widget/t;->a(IIII)V
...
.method a(Landroid/content/Context;I)V
    ...
    .line 302
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/r;->a(Landroid/content/Context;Landroid/support/v7/widget/bi;)V
    ...
    .line 305
    iget-object p1, p0, Landroid/support/v7/widget/r;->a:Landroid/widget/TextView;

    iget-object p2, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 87
    invoke-static {v0, v1, v6}, Landroid/support/v7/widget/r;->a(Landroid/content/Context;Landroid/support/v7/widget/j;I)Landroid/support/v7/widget/bg;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/r;->b:Landroid/support/v7/widget/bg;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/r;->c:Landroid/support/v7/widget/bg;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/r;->d:Landroid/support/v7/widget/bg;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/r;->e:Landroid/support/v7/widget/bg;
    ...
    .line 123
    :goto_0
    invoke-direct {p0, v0, v4}, Landroid/support/v7/widget/r;->a(Landroid/content/Context;Landroid/support/v7/widget/bi;)V
    ...
    .line 178
    invoke-virtual {p0, v8}, Landroid/support/v7/widget/r;->a(Z)V

    .line 180
    :cond_11
    iget-object v0, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/r;->h:Landroid/graphics/Typeface;

    iget v2, p0, Landroid/support/v7/widget/r;->g:I
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/t;->a(Landroid/util/AttributeSet;I)V
    ...
    .line 188
    iget-object p1, p0, Landroid/support/v7/widget/r;->f:Landroid/support/v7/widget/t;

    invoke-virtual {p1}, Landroid/support/v7/widget/t;->a()I
    ...
    .line 191
    invoke-virtual {p1}, Landroid/support/v7/widget/t;->e()[I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/r;->f:Landroid/support/v7/widget/t;

    .line 197
    invoke-virtual {p2}, Landroid/support/v7/widget/t;->c()I
    ...
    .line 198
    invoke-virtual {v0}, Landroid/support/v7/widget/t;->d()I

    move-result v0

    iget-object v1, p0, Landroid/support/v7/widget/r;->f:Landroid/support/v7/widget/t;

    .line 199
    invoke-virtual {v1}, Landroid/support/v7/widget/t;->b()I
...
.method a([II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/t;->a([II)V
...
.method b()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/t;->f()V
...
.method c()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/t;->g()Z
...
.method d()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/t;->a()I
...
.method h()[I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/t;->e()[I
