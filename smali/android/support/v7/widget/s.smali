...
.method a()V
    ...
    .line 60
    iget-object v0, p0, Landroid/support/v7/widget/s;->b:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/s;->c:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/s;->b:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/s;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/s;->c:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/s;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 46
    invoke-static {v0, v1, p2}, Landroid/support/v7/widget/s;->a(Landroid/content/Context;Landroid/support/v7/widget/j;I)Landroid/support/v7/widget/bg;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/s;->b:Landroid/support/v7/widget/bg;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/s;->c:Landroid/support/v7/widget/bg;
