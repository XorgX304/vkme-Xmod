...
.method private a(Landroid/support/v7/widget/RecyclerView;)I
    ...
    sget v0, Landroid/support/v7/e/a$a;->item_touch_helper_max_drag_scroll_per_frame:I
...
.method public static b(II)I
    ...
    .line 1489
    invoke-static {v1, v0}, Landroid/support/v7/widget/a/a$a;->c(II)I
    ...
    .line 1491
    invoke-static {v0, p0}, Landroid/support/v7/widget/a/a$a;->c(II)I
...
.method public a(Landroid/support/v7/widget/RecyclerView;IIIJ)I
    ...
    .line 2137
    sget-object p4, Landroid/support/v7/widget/a/a$a;->c:Landroid/view/animation/Interpolator;
...
.method a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;Ljava/util/List;IFF)V
    ...
    .line 1951
    iget-object v3, v0, Landroid/support/v7/widget/a/a$c;->h:Landroid/support/v7/widget/RecyclerView$x;
    ...
    invoke-virtual/range {v0 .. v7}, Landroid/support/v7/widget/a/a$a;->a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;FFIZ)V
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;ILandroid/support/v7/widget/RecyclerView$x;III)V
    ...
    .line 1913
    instance-of v0, p3, Landroid/support/v7/widget/a/a$d;

    if-eqz v0, :cond_0

    .line 1914
    check-cast p3, Landroid/support/v7/widget/a/a$d;
    ...
    invoke-interface {p3, p1, p2, p6, p7}, Landroid/support/v7/widget/a/a$d;->a(Landroid/view/View;Landroid/view/View;II)V
...
.method final b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;)I
    ...
    .line 1568
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/a/a$a;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;)I
    ...
    invoke-virtual {p0, p2, p1}, Landroid/support/v7/widget/a/a$a;->d(II)I
...
.method b(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;Ljava/util/List;IFF)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroid/support/v7/widget/a/a$a;->b(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;FFIZ)V
    ...
    .line 1981
    iget-boolean v2, v1, Landroid/support/v7/widget/a/a$c;->o:Z

    if-eqz v2, :cond_2

    iget-boolean v2, v1, Landroid/support/v7/widget/a/a$c;->k:Z
    ...
    .line 1983
    :cond_2
    iget-boolean v1, v1, Landroid/support/v7/widget/a/a$c;->o:Z
...
.method public b(Landroid/support/v7/widget/RecyclerView$x;I)V
    ...
    .line 1864
    sget-object p2, Landroid/support/v7/widget/a/a$a;->a:Landroid/support/v7/widget/a/b;

    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;

    invoke-interface {p2, p1}, Landroid/support/v7/widget/a/b;->b(Landroid/view/View;)V
...
.method c(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    .line 1573
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/a/a$a;->b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;)I
...
.method public d(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 2006
    sget-object p1, Landroid/support/v7/widget/a/a$a;->a:Landroid/support/v7/widget/a/b;

    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;

    invoke-interface {p1, p2}, Landroid/support/v7/widget/a/b;->a(Landroid/view/View;)V
