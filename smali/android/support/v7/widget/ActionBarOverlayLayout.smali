...
.field private i:Landroid/support/v7/widget/ab;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->C:Landroid/support/v4/view/n;

    return-void
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/ab;
    .locals 3
...
.method public a(I)V
    ...
    .line 638
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/ab;

    invoke-interface {p1}, Landroid/support/v7/widget/ab;->g()V
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ab;->f()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    .line 720
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/ab;

    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/ab;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/ab;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/ab;
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    .line 288
    invoke-static {p0}, Landroid/support/v4/view/t;->p(Landroid/view/View;)I
    ...
    invoke-static {p0, p1, v1}, Landroid/support/v7/widget/bq;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public g()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ab;->j()Z
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ab;->e()Ljava/lang/CharSequence;
...
.method public h()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ab;->k()Z
...
.method public i()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ab;->l()Z
...
.method public j()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ab;->m()V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/ab;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/ab;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/ab;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/ab;->a(Landroid/view/Window$Callback;)V
