...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/al;->a:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/al;->b:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/al;->a(Landroid/util/DisplayMetrics;)F

    move-result p1

    iput p1, p0, Landroid/support/v7/widget/al;->f:F
...
.method protected a(I)I
    ...
    .line 179
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/al;->b(I)I
...
.method public a(Landroid/view/View;I)I
    ...
    .line 302
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->e()Landroid/support/v7/widget/RecyclerView$i;
    ...
    .line 312
    invoke-virtual/range {v4 .. v9}, Landroid/support/v7/widget/al;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    .line 126
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->j()I
    ...
    .line 127
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->f()V

    return-void

    .line 136
    :cond_0
    iget p3, p0, Landroid/support/v7/widget/al;->d:I

    invoke-direct {p0, p3, p1}, Landroid/support/v7/widget/al;->a(II)I
    ...
    .line 137
    iget p1, p0, Landroid/support/v7/widget/al;->e:I

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/al;->a(II)I
    ...
    .line 139
    iget p1, p0, Landroid/support/v7/widget/al;->d:I
    ...
    .line 140
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/al;->a(Landroid/support/v7/widget/RecyclerView$t$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    .line 232
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->i()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/al;->c(I)Landroid/graphics/PointF;
    ...
    .line 239
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/al;->a(Landroid/graphics/PointF;)V

    .line 240
    iput-object v0, p0, Landroid/support/v7/widget/al;->c:Landroid/graphics/PointF;
    ...
    iput v1, p0, Landroid/support/v7/widget/al;->d:I
    ...
    .line 244
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/al;->b(I)I
    ...
    iget v3, p0, Landroid/support/v7/widget/al;->e:I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/al;->a:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    .line 112
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->c()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/al;->b(Landroid/view/View;I)I

    move-result p2

    .line 113
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->d()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/al;->a(Landroid/view/View;I)I
    ...
    .line 115
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/al;->a(I)I
    ...
    .line 117
    iget-object v1, p0, Landroid/support/v7/widget/al;->b:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v0, p0, Landroid/support/v7/widget/al;->f:F
...
.method protected c()I
    ...
    .line 206
    iget-object v0, p0, Landroid/support/v7/widget/al;->c:Landroid/graphics/PointF;
