...
.field final C:Landroid/support/v7/widget/RecyclerView$u;
...
.field G:Landroid/support/v7/widget/at;
...
.field private final P:Landroid/support/v7/widget/RecyclerView$r;
...
.field private aA:Landroid/support/v7/widget/RecyclerView$d;

.field private final aB:[I

.field private aC:Landroid/support/v4/view/k;
...
.field private final aH:Landroid/support/v7/widget/bp$b;
...
.field private ae:Landroid/support/v7/widget/RecyclerView$e;
...
.field private ax:Landroid/support/v7/widget/RecyclerView$n;
...
.field private az:Landroid/support/v7/widget/RecyclerView$f$b;

.field final d:Landroid/support/v7/widget/RecyclerView$p;

.field e:Landroid/support/v7/widget/e;

.field f:Landroid/support/v7/widget/z;

.field final g:Landroid/support/v7/widget/bp;
...
.field l:Landroid/support/v7/widget/RecyclerView$a;

.field m:Landroid/support/v7/widget/RecyclerView$i;

.field n:Landroid/support/v7/widget/RecyclerView$q;
...
.field y:Landroid/support/v7/widget/RecyclerView$f;

.field final z:Landroid/support/v7/widget/RecyclerView$w;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->P:Landroid/support/v7/widget/RecyclerView$r;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v7/widget/RecyclerView$e;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;
    ...
    iput-object v3, p0, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/RecyclerView$w;
    ...
    invoke-direct {v3}, Landroid/support/v7/widget/ai$a;-><init>()V
    ...
    :goto_0
    iput-object v3, p0, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/ai$a;
    ...
    iput-object v3, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;
    ...
    iput-object v3, p0, Landroid/support/v7/widget/RecyclerView;->az:Landroid/support/v7/widget/RecyclerView$f$b;
    ...
    iput-object v4, p0, Landroid/support/v7/widget/RecyclerView;->aH:Landroid/support/v7/widget/bp$b;
    ...
    .line 608
    invoke-static {v4, p1}, Landroid/support/v4/view/u;->a(Landroid/view/ViewConfiguration;Landroid/content/Context;)F
    ...
    .line 610
    invoke-static {v4, p1}, Landroid/support/v4/view/u;->b(Landroid/view/ViewConfiguration;Landroid/content/Context;)F
    ...
    .line 615
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->az:Landroid/support/v7/widget/RecyclerView$f$b;

    invoke-virtual {v3, v4}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$f$b;)V
    ...
    .line 619
    invoke-static {p0}, Landroid/support/v4/view/t;->d(Landroid/view/View;)I
    ...
    .line 621
    invoke-static {p0, v2}, Landroid/support/v4/view/t;->c(Landroid/view/View;I)V
    ...
    invoke-direct {v3, p0}, Landroid/support/v7/widget/at;-><init>(Landroid/support/v7/widget/RecyclerView;)V

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/RecyclerView;->setAccessibilityDelegateCompat(Landroid/support/v7/widget/at;)V
    ...
    .line 633
    sget-object v4, Landroid/support/v7/e/a$c;->RecyclerView:[I
    ...
    .line 635
    sget v5, Landroid/support/v7/e/a$c;->RecyclerView_layoutManager:I
    ...
    .line 636
    sget v5, Landroid/support/v7/e/a$c;->RecyclerView_android_descendantFocusability:I
    ...
    .line 641
    :cond_4
    sget v1, Landroid/support/v7/e/a$c;->RecyclerView_fastScrollEnabled:I
    ...
    .line 643
    sget v1, Landroid/support/v7/e/a$c;->RecyclerView_fastScrollVerticalThumbDrawable:I
    ...
    .line 645
    sget v3, Landroid/support/v7/e/a$c;->RecyclerView_fastScrollVerticalTrackDrawable:I
    ...
    .line 647
    sget v5, Landroid/support/v7/e/a$c;->RecyclerView_fastScrollHorizontalThumbDrawable:I
    ...
    .line 649
    sget v6, Landroid/support/v7/e/a$c;->RecyclerView_fastScrollHorizontalTrackDrawable:I
...
.method private A()V
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/z;-><init>(Landroid/support/v7/widget/z$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;
...
.method private B()Z
    ...
    .line 1776
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;
    ...
    .line 1778
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;

    invoke-virtual {v3, v2}, Landroid/support/v7/widget/z;->b(I)Landroid/view/View;
    ...
    .line 1779
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    .line 1782
    :cond_0
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$x;->y()Z
...
.method private C()V
    ...
    .line 2228
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/RecyclerView$w;

    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$w;->b()V

    .line 2229
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$i;->L()V
...
.method private H()Z
    ...
    .line 3449
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;
...
.method private I()V
    ...
    .line 3462
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/e;
    ...
    .line 3476
    :goto_2
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iget-boolean v4, p0, Landroid/support/v7/widget/RecyclerView;->s:Z

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;

    iget-boolean v4, v4, Landroid/support/v7/widget/RecyclerView$i;->u:Z
    ...
    :goto_3
    iput-boolean v4, v3, Landroid/support/v7/widget/RecyclerView$u;->i:Z

    .line 3483
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;
    ...
    :goto_4
    iput-boolean v1, v3, Landroid/support/v7/widget/RecyclerView$u;->j:Z
...
.method private J()V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->bC_()J
    ...
    :goto_2
    iput-wide v2, v0, Landroid/support/v7/widget/RecyclerView$u;->l:J
    ...
    .line 3559
    :cond_5
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->e()I

    move-result v2

    :goto_3
    iput v2, v0, Landroid/support/v7/widget/RecyclerView$u;->k:I
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$u;->m:I
...
.method private K()V
    ...
    iput-wide v1, v0, Landroid/support/v7/widget/RecyclerView$u;->l:J
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$u;->k:I
...
.method private L()Landroid/view/View;
    ...
    iget v0, v0, Landroid/support/v7/widget/RecyclerView$u;->k:I
    ...
    .line 3585
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->g(I)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 3590
    iget-object v0, v3, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;
    ...
    .line 3595
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->g(I)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 3600
    iget-object v0, v2, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;
...
.method private M()V
    ...
    .line 3638
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/z;->c(Landroid/view/View;)Z
    ...
    iget-wide v0, v0, Landroid/support/v7/widget/RecyclerView$u;->l:J
    ...
    iget-wide v4, v0, Landroid/support/v7/widget/RecyclerView$u;->l:J
    ...
    .line 3652
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;

    iget-object v5, v0, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/z;->c(Landroid/view/View;)Z
    ...
    .line 3661
    invoke-direct {p0}, Landroid/support/v7/widget/RecyclerView;->L()Landroid/view/View;
    ...
    iget v0, v0, Landroid/support/v7/widget/RecyclerView$u;->m:I
...
.method private N()V
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/RecyclerView$u;->h:Z

    .line 3714
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView;->e()V

    .line 3715
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;
    ...
    iget-boolean v3, v3, Landroid/support/v7/widget/RecyclerView$u;->i:Z
    ...
    iget-boolean v1, v1, Landroid/support/v7/widget/RecyclerView$u;->j:Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$a;->aA_()I

    move-result v1

    iput v1, v0, Landroid/support/v7/widget/RecyclerView$u;->d:I
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/z;->b(I)Landroid/view/View;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3736
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$x;->v()Ljava/util/List;

    move-result-object v7

    .line 3734
    invoke-virtual {v4, v5, v3, v6, v7}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$x;ILjava/util/List;)Landroid/support/v7/widget/RecyclerView$f$c;

    move-result-object v4

    .line 3737
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/bp;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    .line 3748
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v6, v4, v5, v3}, Landroid/support/v7/widget/bp;->a(JLandroid/support/v7/widget/RecyclerView$x;)V
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$u;->e:Z

    .line 3761
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iput-boolean v2, v1, Landroid/support/v7/widget/RecyclerView$u;->e:Z

    .line 3763
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    invoke-virtual {v1, v3, v4}, Landroid/support/v7/widget/RecyclerView$i;->c(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)V

    .line 3764
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iput-boolean v0, v1, Landroid/support/v7/widget/RecyclerView$u;->e:Z
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/z;->b(I)Landroid/view/View;
    ...
    .line 3769
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    .line 3772
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v3, v1}, Landroid/support/v7/widget/bp;->d(Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    .line 3775
    invoke-virtual {v1, v4}, Landroid/support/v7/widget/RecyclerView$x;->c(I)Z
    ...
    .line 3779
    :cond_5
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;

    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    .line 3780
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->v()Ljava/util/List;

    move-result-object v7

    .line 3779
    invoke-virtual {v5, v6, v1, v3, v7}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$x;ILjava/util/List;)Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    .line 3782
    invoke-virtual {p0, v1, v3}, Landroid/support/v7/widget/RecyclerView;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V

    goto :goto_4

    .line 3784
    :cond_6
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v4, v1, v3}, Landroid/support/v7/widget/bp;->b(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$u;->c:I
...
.method private O()V
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$u;->b:I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    invoke-virtual {v0, v2, v3}, Landroid/support/v7/widget/RecyclerView$i;->c(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iget-boolean v2, v2, Landroid/support/v7/widget/RecyclerView$u;->i:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;
    ...
    iput v2, v0, Landroid/support/v7/widget/RecyclerView$u;->c:I
...
.method private P()V
    ...
    .line 3838
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/z;->b(I)Landroid/view/View;
    ...
    .line 3839
    invoke-virtual {v5}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    .line 3844
    invoke-virtual {v4, v6, v5}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$x;)Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    invoke-virtual {v6, v2, v3}, Landroid/support/v7/widget/bp;->a(J)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 3846
    invoke-virtual {v6}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    .line 3857
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v7, v6}, Landroid/support/v7/widget/bp;->a(Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    invoke-virtual {v7, v5}, Landroid/support/v7/widget/bp;->a(Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    .line 3862
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v2, v5, v4}, Landroid/support/v7/widget/bp;->c(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    invoke-virtual {v7, v6}, Landroid/support/v7/widget/bp;->b(Landroid/support/v7/widget/RecyclerView$x;)Landroid/support/v7/widget/RecyclerView$f$c;

    move-result-object v7

    .line 3867
    iget-object v10, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v10, v5, v4}, Landroid/support/v7/widget/bp;->c(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V

    .line 3868
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bp;->c(Landroid/support/v7/widget/RecyclerView$x;)Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    .line 3872
    invoke-direct/range {v3 .. v9}, Landroid/support/v7/widget/RecyclerView;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;ZZ)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->aH:Landroid/support/v7/widget/bp$b;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/bp;->a(Landroid/support/v7/widget/bp$b;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/RecyclerView$i;->b(Landroid/support/v7/widget/RecyclerView$p;)V
    ...
    iget v2, v2, Landroid/support/v7/widget/RecyclerView$u;->d:I
    ...
    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$u;->i:Z

    .line 3891
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$u;->j:Z

    .line 3892
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;

    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$i;->u:Z
    ...
    iget-boolean v2, v2, Landroid/support/v7/widget/RecyclerView$i;->y:Z
    ...
    iput v0, v2, Landroid/support/v7/widget/RecyclerView$i;->x:I

    .line 3900
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;

    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$i;->y:Z
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/bp;->a()V
...
.method private a(FFFF)V
    ...
    invoke-static {v1, v4, p3}, Landroid/support/v4/widget/i;->a(Landroid/widget/EdgeEffect;FF)V
    ...
    invoke-static {p3, v1, p1}, Landroid/support/v4/widget/i;->a(Landroid/widget/EdgeEffect;FF)V
    ...
    invoke-static {p3, v1, v2}, Landroid/support/v4/widget/i;->a(Landroid/widget/EdgeEffect;FF)V
...
.method private a(JLandroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/widget/z;->b(I)Landroid/view/View;
    ...
    .line 3942
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->l:Landroid/support/v7/widget/RecyclerView$a;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/RecyclerView;->setLayoutManager(Landroid/support/v7/widget/RecyclerView$i;)V
...
.method private a(Landroid/support/v7/widget/RecyclerView$a;ZZ)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->P:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 1126
    :cond_2
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/e;

    invoke-virtual {p3}, Landroid/support/v7/widget/e;->a()V

    .line 1127
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView;->l:Landroid/support/v7/widget/RecyclerView$a;
    ...
    .line 1130
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->P:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 1133
    :cond_3
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;
    ...
    invoke-virtual {p1, p3, v0}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView$a;Landroid/support/v7/widget/RecyclerView$a;)V

    .line 1136
    :cond_4
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;
    ...
    .line 1137
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    const/4 p2, 0x1

    iput-boolean p2, p1, Landroid/support/v7/widget/RecyclerView$u;->e:Z

    return-void
.end method

.method private a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;ZZ)V
    .locals 1
    ...
    .line 4067
    :cond_1
    iput-object p2, p1, Landroid/support/v7/widget/RecyclerView$x;->h:Landroid/support/v7/widget/RecyclerView$x;

    .line 4069
    invoke-direct {p0, p1}, Landroid/support/v7/widget/RecyclerView;->e(Landroid/support/v7/widget/RecyclerView$x;)V

    .line 4070
    iget-object p5, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;

    invoke-virtual {p5, p1}, Landroid/support/v7/widget/RecyclerView$p;->c(Landroid/support/v7/widget/RecyclerView$x;)V

    .line 4071
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/RecyclerView$x;->c(Z)V

    .line 4072
    iput-object p1, p2, Landroid/support/v7/widget/RecyclerView$x;->i:Landroid/support/v7/widget/RecyclerView$x;

    .line 4074
    :cond_2
    iget-object p5, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;

    invoke-virtual {p5, p1, p2, p3, p4}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)Z
...
.method private a(Landroid/view/View;Landroid/view/View;)V
    ...
    .line 2637
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$j;->e:Z
    ...
    .line 2650
    :cond_2
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;
    ...
    invoke-virtual/range {v5 .. v10}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView;Landroid/view/View;Landroid/graphics/Rect;ZZ)Z
...
.method private a([I)V
    ...
    .line 3988
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;

    invoke-virtual {v6, v3}, Landroid/support/v7/widget/z;->b(I)Landroid/view/View;
    ...
    .line 3992
    :cond_1
    invoke-virtual {v6}, Landroid/support/v7/widget/RecyclerView$x;->d()I
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    .line 2815
    iput-object v2, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;
    ...
    check-cast v5, Landroid/support/v7/widget/RecyclerView$m;

    .line 2821
    invoke-interface {v5, p0, p1}, Landroid/support/v7/widget/RecyclerView$m;->a(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    .line 2822
    iput-object v5, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    .line 2831
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;
    ...
    .line 2834
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;

    goto :goto_0

    .line 2836
    :cond_0
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;

    invoke-interface {v3, p0, p1}, Landroid/support/v7/widget/RecyclerView$m;->b(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    check-cast v4, Landroid/support/v7/widget/RecyclerView$m;

    .line 2851
    invoke-interface {v4, p0, p1}, Landroid/support/v7/widget/RecyclerView$m;->a(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    .line 2852
    iput-object v4, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;
...
.method static c(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 5488
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$x;->b:Ljava/lang/ref/WeakReference;
    ...
    .line 5502
    :cond_2
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$x;->b:Ljava/lang/ref/WeakReference;
...
.method static e(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$x;
    .locals 0
    ...
    iget-object p0, p0, Landroid/support/v7/widget/RecyclerView$j;->c:Landroid/support/v7/widget/RecyclerView$x;
...
.method private e(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 1353
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$x;->bM_()Z
    ...
    .line 1355
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;
    ...
    invoke-virtual {p1, v0, v1, v3, v2}, Landroid/support/v7/widget/z;->a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-virtual {p1, v0, v2}, Landroid/support/v7/widget/z;->a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/z;->d(Landroid/view/View;)V
...
.method private getScrollingChildHelper()Landroid/support/v4/view/k;
    ...
    .line 13035
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->aC:Landroid/support/v4/view/k;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->aC:Landroid/support/v4/view/k;
...
.method a(Landroid/support/v7/widget/RecyclerView$x;)J
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$x;->bC_()J
...
.method a(IZ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/z;->d(I)Landroid/view/View;
    ...
    invoke-virtual {v1, v4}, Landroid/support/v7/widget/z;->c(Landroid/view/View;)Z
...
.method public a(J)Landroid/support/v7/widget/RecyclerView$x;
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$x;->bC_()J
...
.method public a(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/view/k;->c(I)V
...
.method a(IILjava/lang/Object;)V
    ...
    .line 4336
    invoke-virtual {v4}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    .line 4339
    :cond_0
    iget v5, v4, Landroid/support/v7/widget/RecyclerView$x;->c:I
    ...
    .line 4342
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/RecyclerView$x;->d(I)V
    ...
    .line 4348
    :cond_2
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;
...
.method a(IIZ)V
    ...
    iput-boolean v5, v3, Landroid/support/v7/widget/RecyclerView$u;->e:Z
...
.method a(Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct/range {v1 .. v9}, Landroid/support/v7/widget/af;-><init>(Landroid/support/v7/widget/RecyclerView;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;III)V
...
.method final a(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    iput v1, p1, Landroid/support/v7/widget/RecyclerView$u;->n:I
    ...
    iput v1, p1, Landroid/support/v7/widget/RecyclerView$u;->o:I
    ...
    .line 3698
    iput v0, p1, Landroid/support/v7/widget/RecyclerView$u;->n:I

    .line 3699
    iput v0, p1, Landroid/support/v7/widget/RecyclerView$u;->o:I
...
.method a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    .line 3969
    invoke-virtual {p1, v0, v1}, Landroid/support/v7/widget/RecyclerView$x;->c_(II)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    invoke-virtual {v2, v0, v1, p1}, Landroid/support/v7/widget/bp;->a(JLandroid/support/v7/widget/RecyclerView$x;)V

    .line 3975
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bp;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/bp;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V

    return-void
.end method

.method a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v7/widget/RecyclerView$f;->b(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)Z
...
.method a(IILandroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1, v2, v3}, Landroid/support/v7/widget/RecyclerView$i;->a(ILandroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)I
    ...
    .line 1815
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;

    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    invoke-virtual {v3, p2, v4, v5}, Landroid/support/v7/widget/RecyclerView$i;->b(ILandroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)I
    ...
    .line 1838
    invoke-static {p3, v5}, Landroid/support/v4/view/h;->e(Landroid/view/MotionEvent;I)Z
...
.method a(Landroid/support/v7/widget/RecyclerView$x;I)Z
    ...
    .line 11065
    iput p2, p1, Landroid/support/v7/widget/RecyclerView$x;->l:I
...
.method a(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/z;->f(Landroid/view/View;)Z
    ...
    .line 1374
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;
...
.method public b(I)Landroid/support/v7/widget/RecyclerView$h;
    .locals 3
...
.method b()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/e;
...
.method public b(Landroid/support/v7/widget/RecyclerView$m;)V
    ...
    .line 2807
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;
    ...
    .line 2808
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$m;

    :cond_0
    return-void
.end method

.method public b(Landroid/support/v7/widget/RecyclerView$n;)V
    .locals 1
...
.method b(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)Z
...
.method public b(II)Z
    ...
    .line 2192
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ar:Landroid/support/v7/widget/RecyclerView$l;

    if-eqz v3, :cond_9

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ar:Landroid/support/v7/widget/RecyclerView$l;

    invoke-virtual {v3, p1, p2}, Landroid/support/v7/widget/RecyclerView$l;->a(II)Z
...
.method c()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->c(Landroid/support/v7/widget/RecyclerView$p;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->b(Landroid/support/v7/widget/RecyclerView$p;)V
...
.method public computeHorizontalScrollExtent()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->e(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public computeHorizontalScrollOffset()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->c(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public computeHorizontalScrollRange()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->g(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public computeVerticalScrollExtent()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->f(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public computeVerticalScrollOffset()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->d(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public computeVerticalScrollRange()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->h(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method d(Landroid/support/v7/widget/RecyclerView$x;)I
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/e;->c(I)I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v3, p1, p0, v4}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 4156
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;
...
.method public e(I)V
    ...
    invoke-virtual {v0, p0, v1, p1}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;I)V
...
.method e(II)V
    ...
    .line 3291
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/RecyclerView$i;->a(III)I
...
.method f(II)V
    ...
    .line 4256
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/z;

    invoke-virtual {v7, v6}, Landroid/support/v7/widget/z;->d(I)Landroid/view/View;
    ...
    .line 4257
    iget v8, v7, Landroid/support/v7/widget/RecyclerView$x;->c:I
    ...
    .line 4270
    :goto_2
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    iput-boolean v1, v7, Landroid/support/v7/widget/RecyclerView$u;->e:Z
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2, v1, v5}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2, v1, v3}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)Landroid/view/View;
...
.method g()V
    ...
    .line 2355
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v7/widget/RecyclerView$e;
...
.method g(II)V
    ...
    iput-boolean v4, v3, Landroid/support/v7/widget/RecyclerView$u;->e:Z
...
.method protected getChildDrawingOrder(II)I
    ...
    .line 13005
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->aA:Landroid/support/v7/widget/RecyclerView$d;
...
.method public getCompatAccessibilityDelegate()Landroid/support/v7/widget/at;
    ...
    .line 687
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/at;
...
.method public getOnFlingListener()Landroid/support/v7/widget/RecyclerView$l;
    .locals 1

    .line 1294
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ar:Landroid/support/v7/widget/RecyclerView$l;
...
.method i(II)V
    ...
    .line 4839
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ax:Landroid/support/v7/widget/RecyclerView$n;
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v7/widget/RecyclerView$n;->a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    invoke-virtual {v1, p0, p1, p2}, Landroid/support/v7/widget/RecyclerView$n;->a(Landroid/support/v7/widget/RecyclerView;II)V
...
.method j(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    .line 4780
    iget-object p1, v0, Landroid/support/v7/widget/RecyclerView$j;->d:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$j;->k_()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$j;->i_()Z
...
.method k(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$i;->l(I)V
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/RecyclerView$n;->a(Landroid/support/v7/widget/RecyclerView;I)V
    ...
    invoke-virtual {v1, p0, p1}, Landroid/support/v7/widget/RecyclerView$n;->a(Landroid/support/v7/widget/RecyclerView;I)V
...
.method l(Landroid/view/View;)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v7/widget/RecyclerView$k;->b(Landroid/view/View;)V
...
.method m(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/RecyclerView$a;->c(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v7/widget/RecyclerView$k;->a(Landroid/view/View;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v1, p0}, Landroid/support/v7/widget/RecyclerView$i;->c(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 2689
    sget-object v0, Landroid/support/v7/widget/ai;->a:Ljava/lang/ThreadLocal;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ai;

    .line 2690
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ai;
    ...
    .line 2695
    invoke-static {p0}, Landroid/support/v4/view/t;->D(Landroid/view/View;)Landroid/view/Display;
    ...
    .line 2703
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ai;
    ...
    iput-wide v2, v1, Landroid/support/v7/widget/ai;->d:J
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ai;->a(Landroid/support/v7/widget/RecyclerView;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, p0, v1}, Landroid/support/v7/widget/RecyclerView$i;->b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$p;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bp;->b()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ai;->b(Landroid/support/v7/widget/RecyclerView;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v2, p1, p0, v3}, Landroid/support/v7/widget/RecyclerView$h;->b(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 4081
    invoke-static {p1}, Landroid/support/v4/os/c;->a(Ljava/lang/String;)V
...
.method protected onMeasure(II)V
    ...
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;

    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;

    invoke-virtual {v4, v5, v6, p1, p2}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView$i;->d(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView$i;->e(II)V
    ...
    .line 3233
    invoke-virtual {v0, v2, v3}, Landroid/support/v7/widget/RecyclerView$i;->d(II)V
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;II)V
    ...
    invoke-virtual {v0, v1, v3, p1, p2}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;II)V
    ...
    iput-boolean v2, p1, Landroid/support/v7/widget/RecyclerView$u;->f:Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 3082
    :cond_e
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ai;
    ...
    invoke-virtual {p1, p0, v5, v13}, Landroid/support/v7/widget/ai;->a(Landroid/support/v7/widget/RecyclerView;II)V
...
.method q()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/RecyclerView$i;->f(Landroid/support/v7/widget/RecyclerView;)V
...
.method r()V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/widget/z;->d(I)Landroid/view/View;
...
.method protected removeDetachedView(Landroid/view/View;Z)V
    ...
    .line 4014
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$x;->bM_()Z
    ...
    .line 4016
    :cond_0
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v0, p0, v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$i;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Landroid/view/View;Landroid/view/View;)Z
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 2969
    invoke-interface {v2, p1}, Landroid/support/v7/widget/RecyclerView$m;->a(Z)V
...
.method s()V
    ...
    .line 4225
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->au_()Z
    ...
    .line 4226
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->aw_()V
...
.method public setAccessibilityDelegateCompat(Landroid/support/v7/widget/at;)V
    ...
    .line 696
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/at;

    .line 697
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/at;
...
.method public setChildDrawingOrderCallback(Landroid/support/v7/widget/RecyclerView$d;)V
    ...
    .line 1593
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->aA:Landroid/support/v7/widget/RecyclerView$d;

    .line 1594
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->aA:Landroid/support/v7/widget/RecyclerView$d;
...
.method public setEdgeEffectFactory(Landroid/support/v7/widget/RecyclerView$e;)V
    ...
    .line 2418
    invoke-static {p1}, Landroid/support/v4/f/m;->a(Ljava/lang/Object;)Ljava/lang/Object;

    .line 2419
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v7/widget/RecyclerView$e;
...
.method public setItemAnimator(Landroid/support/v7/widget/RecyclerView$f;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$f$b;)V

    .line 3326
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/RecyclerView$f;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->az:Landroid/support/v7/widget/RecyclerView$f$b;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$f$b;)V
...
.method public setLayoutManager(Landroid/support/v7/widget/RecyclerView$i;)V
    ...
    .line 1253
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;
    ...
    .line 1259
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$i;
    ...
    invoke-virtual {p1, p0}, Landroid/support/v7/widget/RecyclerView$i;->b(Landroid/support/v7/widget/RecyclerView;)V
    ...
    invoke-virtual {p1, p0}, Landroid/support/v7/widget/RecyclerView$i;->c(Landroid/support/v7/widget/RecyclerView;)V
...
.method public setOnFlingListener(Landroid/support/v7/widget/RecyclerView$l;)V
    .locals 0

    .line 1284
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->ar:Landroid/support/v7/widget/RecyclerView$l;
...
.method public setOnScrollListener(Landroid/support/v7/widget/RecyclerView$n;)V
    ...
    .line 1607
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->ax:Landroid/support/v7/widget/RecyclerView$n;
...
.method public setRecyclerListener(Landroid/support/v7/widget/RecyclerView$q;)V
    ...
    .line 1161
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->n:Landroid/support/v7/widget/RecyclerView$q;
...
.method t()V
    ...
    .line 4236
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->av_()V
...
.method x()V
    ...
    .line 5158
    iget-object v4, v3, Landroid/support/v7/widget/RecyclerView$x;->i:Landroid/support/v7/widget/RecyclerView$x;

    if-eqz v4, :cond_1

    .line 5159
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$x;->i:Landroid/support/v7/widget/RecyclerView$x;
...
.method y()V
    ...
    .line 11079
    :cond_0
    iget v2, v1, Landroid/support/v7/widget/RecyclerView$x;->l:I
    ...
    .line 11082
    iget-object v4, v1, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;

    invoke-static {v4, v2}, Landroid/support/v4/view/t;->c(Landroid/view/View;I)V

    .line 11083
    iput v3, v1, Landroid/support/v7/widget/RecyclerView$x;->l:I
