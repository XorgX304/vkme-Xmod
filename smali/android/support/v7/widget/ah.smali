...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ah;->i:[I
    ...
    iput p1, p0, Landroid/support/v7/widget/ah;->a:F
    ...
    .line 76
    iget p1, p0, Landroid/support/v7/widget/ah;->b:I
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    .line 190
    :pswitch_0
    iget v1, p0, Landroid/support/v7/widget/ah;->h:I
    ...
    .line 196
    iget v1, p0, Landroid/support/v7/widget/ah;->a:F

    invoke-static {v0, v3, p1, v1}, Landroid/support/v7/widget/ah;->a(Landroid/view/View;FFF)Z
    ...
    iput p1, p0, Landroid/support/v7/widget/ah;->h:I

    .line 179
    iget-object p1, p0, Landroid/support/v7/widget/ah;->e:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ah;->e:Ljava/lang/Runnable;
    ...
    .line 184
    iget-object p1, p0, Landroid/support/v7/widget/ah;->f:Ljava/lang/Runnable;

    if-nez p1, :cond_2

    .line 185
    new-instance p1, Landroid/support/v7/widget/ah$b;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/ah$b;-><init>(Landroid/support/v7/widget/ah;)V

    iput-object p1, p0, Landroid/support/v7/widget/ah;->f:Ljava/lang/Runnable;
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    .line 264
    :cond_0
    invoke-interface {v1}, Landroid/support/v7/view/menu/s;->g()Landroid/widget/ListView;
    ...
    .line 271
    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/ah;->b(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 272
    invoke-direct {p0, v1, v3}, Landroid/support/v7/widget/ah;->a(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method d()V
    ...
    .line 247
    iput-boolean v2, p0, Landroid/support/v7/widget/ah;->g:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 93
    iget-boolean p1, p0, Landroid/support/v7/widget/ah;->g:Z
    ...
    :cond_4
    :goto_2
    iput-boolean p2, p0, Landroid/support/v7/widget/ah;->g:Z
...
.method public onViewDetachedFromWindow(Landroid/view/View;)V
    ...
    .line 120
    iput-boolean p1, p0, Landroid/support/v7/widget/ah;->g:Z
    ...
    .line 124
    iget-object p1, p0, Landroid/support/v7/widget/ah;->c:Landroid/view/View;
