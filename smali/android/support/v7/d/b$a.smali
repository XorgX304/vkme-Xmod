...
.method private b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 914
    iget v1, p0, Landroid/support/v7/d/b$a;->e:I
    ...
    .line 919
    iget v1, p0, Landroid/support/v7/d/b$a;->f:I
...
# virtual methods
.method public a()Landroid/support/v7/d/b;
    .locals 6
    ...
    .line 803
    iget-object v1, p0, Landroid/support/v7/d/b$a;->h:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroid/support/v7/d/b$a;->b:Landroid/graphics/Bitmap;
    ...
    .line 817
    :cond_0
    new-instance v1, Landroid/support/v7/d/a;

    .line 818
    invoke-direct {p0, v0}, Landroid/support/v7/d/b$a;->a(Landroid/graphics/Bitmap;)[I

    move-result-object v2

    iget v3, p0, Landroid/support/v7/d/b$a;->d:I

    iget-object v4, p0, Landroid/support/v7/d/b$a;->g:Ljava/util/List;
    ...
    iget-object v5, p0, Landroid/support/v7/d/b$a;->g:Ljava/util/List;
    ...
    check-cast v4, [Landroid/support/v7/d/b$b;

    :goto_0
    invoke-direct {v1, v2, v3, v4}, Landroid/support/v7/d/a;-><init>([II[Landroid/support/v7/d/b$b;)V
    ...
    .line 827
    :cond_2
    invoke-virtual {v1}, Landroid/support/v7/d/a;->a()Ljava/util/List;
    ...
    iget-object v2, p0, Landroid/support/v7/d/b$a;->c:Ljava/util/List;

    invoke-direct {v1, v0, v2}, Landroid/support/v7/d/b;-><init>(Ljava/util/List;Ljava/util/List;)V

    .line 840
    invoke-virtual {v1}, Landroid/support/v7/d/b;->a()V
