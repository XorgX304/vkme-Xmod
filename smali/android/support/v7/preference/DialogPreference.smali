...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 93
    sget v0, Landroid/support/v7/preference/f$a;->dialogPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 56
    sget-object v0, Landroid/support/v7/preference/f$f;->DialogPreference:[I
    ...
    .line 59
    sget p2, Landroid/support/v7/preference/f$f;->DialogPreference_dialogTitle:I

    sget p3, Landroid/support/v7/preference/f$f;->DialogPreference_android_dialogTitle:I
    ...
    .line 67
    :cond_0
    sget p2, Landroid/support/v7/preference/f$f;->DialogPreference_dialogMessage:I

    sget p3, Landroid/support/v7/preference/f$f;->DialogPreference_android_dialogMessage:I
    ...
    .line 70
    sget p2, Landroid/support/v7/preference/f$f;->DialogPreference_dialogIcon:I

    sget p3, Landroid/support/v7/preference/f$f;->DialogPreference_android_dialogIcon:I

    invoke-static {p1, p2, p3}, Landroid/support/v4/content/b/c;->a(Landroid/content/res/TypedArray;II)Landroid/graphics/drawable/Drawable;
    ...
    .line 73
    sget p2, Landroid/support/v7/preference/f$f;->DialogPreference_positiveButtonText:I

    sget p3, Landroid/support/v7/preference/f$f;->DialogPreference_android_positiveButtonText:I
    ...
    .line 77
    sget p2, Landroid/support/v7/preference/f$f;->DialogPreference_negativeButtonText:I

    sget p3, Landroid/support/v7/preference/f$f;->DialogPreference_android_negativeButtonText:I
    ...
    .line 81
    sget p2, Landroid/support/v7/preference/f$f;->DialogPreference_dialogLayout:I

    sget p3, Landroid/support/v7/preference/f$f;->DialogPreference_android_dialogLayout:I
...
.method protected i()V
    ...
    .line 262
    invoke-virtual {p0}, Landroid/support/v7/preference/DialogPreference;->L()Landroid/support/v7/preference/d;

    move-result-object v0

    invoke-virtual {v0, p0}, Landroid/support/v7/preference/d;->a(Landroid/support/v7/preference/Preference;)V
