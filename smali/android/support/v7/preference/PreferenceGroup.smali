...
.field private final g:Landroid/support/v4/f/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v1, p0, Landroid/support/v7/preference/PreferenceGroup;->g:Landroid/support/v4/f/n;
    ...
    .line 85
    sget-object v1, Landroid/support/v7/preference/f$f;->PreferenceGroup:[I
    ...
    .line 88
    sget p2, Landroid/support/v7/preference/f$f;->PreferenceGroup_orderingFromXml:I

    sget p3, Landroid/support/v7/preference/f$f;->PreferenceGroup_orderingFromXml:I

    .line 89
    invoke-static {p1, p2, p3, v0}, Landroid/support/v4/content/b/c;->a(Landroid/content/res/TypedArray;IIZ)Z
    ...
    .line 92
    sget p2, Landroid/support/v7/preference/f$f;->PreferenceGroup_initialExpandedChildrenCount:I
    ...
    sget p3, Landroid/support/v7/preference/f$f;->PreferenceGroup_initialExpandedChildrenCount:I

    const/4 p4, -0x1

    invoke-static {p1, p2, p3, p4}, Landroid/support/v4/content/b/c;->a(Landroid/content/res/TypedArray;III)I
...
.method static synthetic b(Landroid/support/v7/preference/PreferenceGroup;)Landroid/support/v4/f/n;
    .locals 0

    .line 52
    iget-object p0, p0, Landroid/support/v7/preference/PreferenceGroup;->g:Landroid/support/v4/f/n;
...
.method private f(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 279
    iget-object v2, p0, Landroid/support/v7/preference/PreferenceGroup;->g:Landroid/support/v4/f/n;
    ...
    invoke-virtual {v2, v1, v3}, Landroid/support/v4/f/n;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public d(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 225
    invoke-virtual {p0}, Landroid/support/v7/preference/PreferenceGroup;->L()Landroid/support/v7/preference/d;
    ...
    .line 228
    iget-object v3, p0, Landroid/support/v7/preference/PreferenceGroup;->g:Landroid/support/v4/f/n;

    invoke-virtual {v3, v2}, Landroid/support/v4/f/n;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/f/n;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 230
    iget-object v5, p0, Landroid/support/v7/preference/PreferenceGroup;->g:Landroid/support/v4/f/n;

    invoke-virtual {v5, v2}, Landroid/support/v4/f/n;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    .line 232
    :cond_5
    invoke-virtual {v0}, Landroid/support/v7/preference/d;->a()J

    move-result-wide v3

    .line 234
    :goto_0
    invoke-virtual {p1, v0, v3, v4}, Landroid/support/v7/preference/Preference;->a(Landroid/support/v7/preference/d;J)V
