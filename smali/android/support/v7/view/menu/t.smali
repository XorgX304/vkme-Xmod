...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
    ...
    invoke-direct {p3, p4, v0, p5, p6}, Landroid/support/v7/widget/ap;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private j()Z
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ap;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ap;->e(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ap;->g(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ap;->h(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ap;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ap;->g()Landroid/widget/ListView;
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/view/menu/h;->b(Z)V

    .line 273
    iget-object v2, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ap;

    invoke-virtual {v2}, Landroid/support/v7/widget/ap;->j()I
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/ap;->k()I
