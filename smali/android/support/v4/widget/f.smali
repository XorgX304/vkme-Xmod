...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    .line 150
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/widget/f;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method public a(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .line 420
    :cond_0
    iget-object p1, p0, Landroid/support/v4/widget/f;->c:Landroid/database/Cursor;
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    .line 178
    iput-boolean v2, p0, Landroid/support/v4/widget/f;->b:Z
    ...
    :goto_1
    iput p1, p0, Landroid/support/v4/widget/f;->e:I
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/widget/f$a;-><init>(Landroid/support/v4/widget/f;)V

    iput-object p1, p0, Landroid/support/v4/widget/f;->f:Landroid/support/v4/widget/f$a;

    .line 189
    new-instance p1, Landroid/support/v4/widget/f$b;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/f$b;-><init>(Landroid/support/v4/widget/f;)V

    iput-object p1, p0, Landroid/support/v4/widget/f;->g:Landroid/database/DataSetObserver;
    ...
    .line 196
    iget-object p1, p0, Landroid/support/v4/widget/f;->f:Landroid/support/v4/widget/f$a;
    ...
    .line 197
    :cond_4
    iget-object p1, p0, Landroid/support/v4/widget/f;->g:Landroid/database/DataSetObserver;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    .line 363
    iput-boolean p1, p0, Landroid/support/v4/widget/f;->a:Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 283
    iget-object p1, p0, Landroid/support/v4/widget/f;->d:Landroid/content/Context;

    iget-object p2, p0, Landroid/support/v4/widget/f;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/widget/f;->b(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v4/widget/f;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p2, p1, p3}, Landroid/support/v4/widget/f;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
...
.method public getItemId(I)J
    ...
    iget v0, p0, Landroid/support/v4/widget/f;->e:I
