...
.field private final k:Landroid/support/v4/widget/u;
...
.method private a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    .line 1148
    invoke-static {p1}, Landroid/support/v4/a/a/a;->b(Landroid/graphics/drawable/Drawable;)Z
...
.method public a(II)V
    ...
    .line 590
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;

    goto :goto_1

    :cond_4
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/u;

    .line 591
    :goto_1
    invoke-virtual {p2}, Landroid/support/v4/widget/u;->e()V
...
.method a(IILandroid/view/View;)V
    ...
    .line 755
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;

    invoke-virtual {p1}, Landroid/support/v4/widget/u;->a()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/u;->a()I
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v1, v0}, Landroid/support/v4/widget/u;->a(Landroid/view/View;II)Z
    ...
    .line 1607
    invoke-virtual {p2, p1, v0, v1}, Landroid/support/v4/widget/u;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1557
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;
    ...
    .line 1557
    invoke-virtual {v7, v4, v6, v8}, Landroid/support/v4/widget/u;->a(Landroid/view/View;II)Z
    ...
    .line 1560
    :cond_1
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/u;
    ...
    .line 1560
    invoke-virtual {v6, v4, v7, v8}, Landroid/support/v4/widget/u;->a(Landroid/view/View;II)Z
...
.method b(I)Landroid/view/View;
    ...
    .line 926
    invoke-static {p1, v0}, Landroid/support/v4/view/d;->a(II)I
...
.method public computeScroll()V
    ...
    .line 1257
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/u;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1380
    iget-object v9, v0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;

    invoke-virtual {v9}, Landroid/support/v4/widget/u;->b()I
    ...
    .line 1392
    iget-object v10, v0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/u;

    invoke-virtual {v10}, Landroid/support/v4/widget/u;->b()I
...
.method g(Landroid/view/View;)Z
    ...
    .line 1409
    invoke-static {v0, p1}, Landroid/support/v4/view/d;->a(II)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1428
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;

    invoke-virtual {v1, p1}, Landroid/support/v4/widget/u;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/u;->d(I)Z
    ...
    .line 1440
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/u;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, Landroid/support/v4/widget/u;->d(II)Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v15, v7}, Landroid/support/v4/view/d;->a(II)I

    move-result v15

    .line 1019
    invoke-static {v12}, Landroid/support/v4/view/t;->r(Landroid/view/View;)Z
    ...
    .line 1062
    invoke-static {v12}, Landroid/support/v4/view/t;->m(Landroid/view/View;)F
    ...
    invoke-static {v12, v2}, Landroid/support/v4/view/t;->f(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/widget/u;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/u;->d()I
