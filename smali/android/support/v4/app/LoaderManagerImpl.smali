...
# instance fields
.field private final b:Landroid/arch/lifecycle/d;
...
.method constructor <init>(Landroid/arch/lifecycle/d;Landroid/arch/lifecycle/o;)V
    .locals 0
    ...
    .line 359
    iput-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->b:Landroid/arch/lifecycle/d;

    .line 360
    invoke-static {p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;->a(Landroid/arch/lifecycle/o;)Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;
...
.method private a(ILandroid/os/Bundle;Landroid/support/v4/app/u$a;Landroid/support/v4/content/c;)Landroid/support/v4/content/c;
    .locals 3
    ...
    .line 370
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/u$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/c;
    ...
    invoke-direct {v2, p1, p2, v0, p4}, Landroid/support/v4/app/LoaderManagerImpl$a;-><init>(ILandroid/os/Bundle;Landroid/support/v4/content/c;Landroid/support/v4/content/c;)V
    ...
    .line 383
    iget-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->b:Landroid/arch/lifecycle/d;

    invoke-virtual {v2, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$a;->a(Landroid/arch/lifecycle/d;Landroid/support/v4/app/u$a;)Landroid/support/v4/content/c;
...
# virtual methods
.method public a(ILandroid/os/Bundle;Landroid/support/v4/app/u$a;)Landroid/support/v4/content/c;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    .line 404
    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v4/app/LoaderManagerImpl;->a(ILandroid/os/Bundle;Landroid/support/v4/app/u$a;Landroid/support/v4/content/c;)Landroid/support/v4/content/c;
    ...
    invoke-virtual {v0, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$a;->a(Landroid/arch/lifecycle/d;Landroid/support/v4/app/u$a;)Landroid/support/v4/content/c;
...
.method public toString()Ljava/lang/String;
    ...
    .line 480
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->b:Landroid/arch/lifecycle/d;
