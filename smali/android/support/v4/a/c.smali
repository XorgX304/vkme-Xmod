...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    .line 156
    sget-object p2, Landroid/support/v4/a/c;->b:Landroid/support/v4/f/g;

    invoke-virtual {p2, p1, p0}, Landroid/support/v4/f/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/d/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Landroid/support/v4/a/c$a;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/d/b$b;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/content/b/a$a;Landroid/content/res/Resources;IILandroid/support/v4/content/b/b$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 7

    .line 116
    instance-of v4, p1, Landroid/support/v4/content/b/a$d;
    ...
    check-cast v0, Landroid/support/v4/content/b/a$d;
    ...
    .line 119
    invoke-virtual {v0}, Landroid/support/v4/content/b/a$d;->b()I
    ...
    .line 122
    invoke-virtual {v0}, Landroid/support/v4/content/b/a$d;->c()I
    ...
    .line 124
    :goto_2
    invoke-virtual {v0}, Landroid/support/v4/content/b/a$d;->a()Landroid/support/v4/d/a;
    ...
    invoke-static/range {v0 .. v6}, Landroid/support/v4/d/b;->a(Landroid/content/Context;Landroid/support/v4/d/a;Landroid/support/v4/content/b/b$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    .line 127
    :cond_3
    sget-object v1, Landroid/support/v4/a/c;->a:Landroid/support/v4/a/c$a;

    move-object v0, p1

    check-cast v0, Landroid/support/v4/content/b/a$b;

    invoke-interface {v1, p0, v0, p2, p4}, Landroid/support/v4/a/c$a;->a(Landroid/content/Context;Landroid/support/v4/content/b/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 131
    invoke-virtual {p5, v0, p6}, Landroid/support/v4/content/b/b$a;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 133
    invoke-virtual {p5, v1, p6}, Landroid/support/v4/content/b/b$a;->a(ILandroid/os/Handler;)V
...
.method public static a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/f/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
