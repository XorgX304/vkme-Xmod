...
.field final a:Lcom/db/chart/renderer/a;

.field final b:Lcom/db/chart/renderer/b;
...
.field private t:Lcom/db/chart/b/a;
...
.field private x:Lcom/db/chart/a/a;

.field private y:Lcom/db/chart/a/b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 168
    new-instance v0, Lcom/db/chart/renderer/a;

    invoke-direct {v0}, Lcom/db/chart/renderer/a;-><init>()V

    iput-object v0, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    .line 169
    new-instance v0, Lcom/db/chart/renderer/b;

    invoke-direct {v0}, Lcom/db/chart/renderer/b;-><init>()V

    iput-object v0, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;
...
.method static synthetic a(Lcom/db/chart/view/ChartView;)Lcom/db/chart/b/a;
    .locals 0

    .line 57
    iget-object p0, p0, Lcom/db/chart/view/ChartView;->t:Lcom/db/chart/b/a;
...
.method private f()V
    ...
    iput-object v0, p0, Lcom/db/chart/view/ChartView;->y:Lcom/db/chart/a/b;
...
.method private g()V
    ...
    check-cast v0, Lcom/db/chart/c/b;

    invoke-virtual {v0}, Lcom/db/chart/c/b;->f()I
    ...
    .line 300
    invoke-virtual {v3, v4}, Lcom/db/chart/c/b;->a(I)Lcom/db/chart/c/a;

    move-result-object v5

    iget-object v6, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    .line 301
    invoke-virtual {v3, v4}, Lcom/db/chart/c/b;->b(I)F

    move-result v7

    float-to-double v7, v7

    invoke-virtual {v6, v4, v7, v8}, Lcom/db/chart/renderer/a;->a(ID)F

    move-result v6

    iget-object v7, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;
    ...
    invoke-virtual {v7, v4, v8, v9}, Lcom/db/chart/renderer/b;->a(ID)F

    move-result v7

    .line 301
    invoke-virtual {v5, v6, v7}, Lcom/db/chart/c/a;->a(FF)V
...
.method public a(II)Lcom/db/chart/view/ChartView;
    ...
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;

    invoke-virtual {v0, p1, p2}, Lcom/db/chart/renderer/b;->a(II)V

    goto :goto_0

    .line 1033
    :cond_0
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    invoke-virtual {v0, p1, p2}, Lcom/db/chart/renderer/a;->a(II)V
...
.method public a(Lcom/db/chart/c/b;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lcom/db/chart/c/b;->f()I
    ...
    check-cast v1, Lcom/db/chart/c/b;

    invoke-virtual {v1}, Lcom/db/chart/c/b;->f()I
...
.method public a()Z
    ...
    invoke-virtual {v0, v2, v3}, Lcom/db/chart/renderer/b;->a(Ljava/util/ArrayList;Lcom/db/chart/view/ChartView$b;)V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/db/chart/renderer/a;->a(Ljava/util/ArrayList;Lcom/db/chart/view/ChartView$b;)V
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/db/chart/renderer/b;->a(IIII)V
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/db/chart/renderer/a;->a(IIII)V

    .line 391
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;

    .line 392
    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->h()Landroid/graphics/RectF;

    move-result-object v0

    iget-object v2, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    .line 393
    invoke-virtual {v2}, Lcom/db/chart/renderer/a;->h()Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v2}, Lcom/db/chart/renderer/b;->a(Landroid/graphics/RectF;)V
    ...
    invoke-virtual {v0, v2}, Lcom/db/chart/renderer/a;->a(Landroid/graphics/RectF;)V

    .line 400
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;

    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->a()V

    .line 401
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    invoke-virtual {v0}, Lcom/db/chart/renderer/a;->a()V
    ...
    iget-object v4, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;
    ...
    invoke-virtual {v4, v2, v5, v6}, Lcom/db/chart/renderer/b;->a(ID)F
    ...
    invoke-virtual {v4}, Lcom/db/chart/c/b;->f()I
    ...
    .line 435
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->x:Lcom/db/chart/a/a;

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/db/chart/view/ChartView;->x:Lcom/db/chart/a/a;

    invoke-virtual {v0, p0}, Lcom/db/chart/a/a;->a(Lcom/db/chart/view/ChartView;)Ljava/util/ArrayList;
...
.method public b(F)Lcom/db/chart/view/ChartView;
    ...
    invoke-virtual {v0, p1}, Lcom/db/chart/renderer/a;->a(F)V
    ...
    invoke-virtual {v0, p1}, Lcom/db/chart/renderer/b;->a(F)V
...
.method public b()V
    ...
    .line 447
    invoke-virtual {v1, v2}, Lcom/db/chart/c/b;->a(Z)V
...
.method public c()V
    ...
    invoke-virtual {v0}, Lcom/db/chart/a/a;->b()Z
    ...
    invoke-virtual {v0}, Lcom/db/chart/a/a;->a()V
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/a;->c()V

    .line 524
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;

    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->c()V
...
.method public d()V
    ...
    invoke-virtual {v1}, Lcom/db/chart/c/b;->c()[[F
    ...
    invoke-virtual {v0, v1, v2}, Lcom/db/chart/a/a;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method getBorderSpacing()F
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/a;->j()F
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->j()F
...
.method public getChartAnimation()Lcom/db/chart/a/a;
    .locals 1
...
.method public getInnerChartBottom()F
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->g()F
...
.method public getInnerChartLeft()F
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/a;->d()F
...
.method public getInnerChartRight()F
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/a;->f()F
...
.method public getInnerChartTop()F
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->e()F
...
.method getStep()I
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/b;->i()I
    ...
    invoke-virtual {v0}, Lcom/db/chart/renderer/a;->i()I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    check-cast v2, Lcom/db/chart/c/b;
    ...
    invoke-virtual {v2, v3}, Lcom/db/chart/c/b;->a(I)Lcom/db/chart/c/a;

    move-result-object v2

    invoke-virtual {v2}, Lcom/db/chart/c/a;->e()F
    ...
    invoke-virtual {v0, p1}, Lcom/db/chart/renderer/b;->a(Landroid/graphics/Canvas;)V

    .line 281
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    invoke-virtual {v0, p1}, Lcom/db/chart/renderer/a;->a(Landroid/graphics/Canvas;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/db/chart/view/ChartView;->t:Lcom/db/chart/b/a;
...
.method public setOnEntryClickListener(Lcom/db/chart/b/a;)V
    .locals 0

    .line 1083
    iput-object p1, p0, Lcom/db/chart/view/ChartView;->t:Lcom/db/chart/b/a;
...
.method setOrientation(Lcom/db/chart/view/ChartView$Orientation;)V
    ...
    .line 911
    iget-object p1, p0, Lcom/db/chart/view/ChartView;->b:Lcom/db/chart/renderer/b;

    invoke-virtual {p1, v1}, Lcom/db/chart/renderer/b;->a(Z)V

    goto :goto_0

    .line 913
    :cond_0
    iget-object p1, p0, Lcom/db/chart/view/ChartView;->a:Lcom/db/chart/renderer/a;

    invoke-virtual {p1, v1}, Lcom/db/chart/renderer/a;->a(Z)V
