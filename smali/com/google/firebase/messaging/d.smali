...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v12}, Landroid/support/v4/app/x$c;-><init>(Landroid/content/Context;)V

    .line 172
    invoke-virtual {v4, v3}, Landroid/support/v4/app/x$c;->d(Z)Landroid/support/v4/app/x$c;

    move-result-object v4

    invoke-virtual {v4, v8}, Landroid/support/v4/app/x$c;->a(I)Landroid/support/v4/app/x$c;
    ...
    .line 174
    invoke-virtual {v4, v2}, Landroid/support/v4/app/x$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;
    ...
    .line 176
    invoke-virtual {v4, v5}, Landroid/support/v4/app/x$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {v2, v5}, Landroid/support/v4/app/x$b;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$b;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroid/support/v4/app/x$c;->a(Landroid/support/v4/app/x$g;)Landroid/support/v4/app/x$c;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/app/x$c;->d(I)Landroid/support/v4/app/x$c;

    :cond_21
    if-eqz v7, :cond_22

    .line 181
    invoke-virtual {v4, v7}, Landroid/support/v4/app/x$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/x$c;

    :cond_22
    if-eqz v11, :cond_23

    .line 183
    invoke-virtual {v4, v11}, Landroid/support/v4/app/x$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$c;

    :cond_23
    if-eqz v9, :cond_24

    .line 185
    invoke-virtual {v4, v9}, Landroid/support/v4/app/x$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$c;

    :cond_24
    if-eqz v10, :cond_25

    .line 187
    invoke-virtual {v4, v10}, Landroid/support/v4/app/x$c;->c(Ljava/lang/String;)Landroid/support/v4/app/x$c;
