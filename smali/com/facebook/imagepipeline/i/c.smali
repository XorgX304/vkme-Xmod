...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/facebook/imagepipeline/i/c;->b:Lcom/facebook/common/f/b;
...
.method private a(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 132
    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/i/c;->a(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    ...
    .line 133
    :try_start_1
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/i/c;->a(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;

    move-result-object p2

    .line 134
    iget-object p3, p0, Lcom/facebook/imagepipeline/i/c;->b:Lcom/facebook/common/f/b;
    ...
    invoke-interface {p3, p2, v0, p4}, Lcom/facebook/common/f/b;->a(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Lcom/facebook/common/internal/l;->b(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method private static a(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    ...
    .line 90
    :try_start_1
    new-instance v5, Lcom/facebook/common/e/a;

    invoke-direct {v5, v4, p1}, Lcom/facebook/common/e/a;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    .line 92
    :try_start_3
    invoke-static {v5, v6}, Lcom/facebook/common/internal/a;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .line 101
    invoke-static {v6, v1}, Lcom/facebook/common/internal/b;->a(Ljava/io/Closeable;Z)V
...
.method private a(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    .line 118
    :try_start_0
    invoke-direct {p0}, Lcom/facebook/imagepipeline/i/c;->a()Ljava/lang/reflect/Method;
...
.method private declared-synchronized a()Ljava/lang/reflect/Method;
    ...
    .line 106
    :try_start_0
    sget-object v0, Lcom/facebook/imagepipeline/i/c;->a:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v0, Lcom/facebook/imagepipeline/i/c;->a:Ljava/lang/reflect/Method;
    :try_end_1
...
.method protected decodeByteArrayAsPurgeable(Lcom/facebook/common/references/a;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/i/c;->a(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method protected decodeJPEGByteArrayAsPurgeable(Lcom/facebook/common/references/a;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 74
    invoke-static {p1, p2}, Lcom/facebook/imagepipeline/i/c;->endsWithEOI(Lcom/facebook/common/references/a;I)Z
    ...
    :cond_0
    sget-object v0, Lcom/facebook/imagepipeline/i/c;->EOI:[B

    .line 75
    :goto_0
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/i/c;->a(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
