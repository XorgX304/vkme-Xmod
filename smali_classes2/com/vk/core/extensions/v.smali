.class public final Lcom/vk/core/extensions/v;
...
.method static constructor <clinit>()V
    ...
    .line 168
    new-instance v0, Lcom/vk/core/extensions/aa;

    invoke-direct {v0}, Lcom/vk/core/extensions/aa;-><init>()V

    check-cast v0, Landroid/util/SparseArray;

    sput-object v0, Lcom/vk/core/extensions/v;->a:Landroid/util/SparseArray;
...
.method public static final a()Landroid/util/SparseArray;
    ...
    .line 170
    sget-object v0, Lcom/vk/core/extensions/v;->a:Landroid/util/SparseArray;
...
.method public static final a(Landroid/util/SparseArray;Ljava/util/Collection;)Landroid/util/SparseArray;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v0, p0}, Lcom/vk/core/extensions/v;->a(Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public static final a(Landroid/util/SparseArray;Lkotlin/jvm/a/b;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V:",
...
.method public static final b(Landroid/util/SparseArray;Lkotlin/jvm/a/b;)Landroid/util/SparseArray;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V:",
    ...
    invoke-static {v0, v3, v4}, Lcom/vk/core/extensions/v;->a(Landroid/util/SparseArray;ILjava/lang/Object;)V
...
.method public static final b(Landroid/util/SparseArray;I)Z
    ...
    .line 149
    invoke-static {p0, p1}, Lcom/vk/core/extensions/v;->a(Landroid/util/SparseArray;I)Z
...
.method public static final c(Landroid/util/SparseArray;Lkotlin/jvm/a/b;)Landroid/util/SparseArray;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V:",
    ...
    .line 85
    invoke-static {v0, v4, v3}, Lcom/vk/core/extensions/v;->a(Landroid/util/SparseArray;ILjava/lang/Object;)V
...
.method public static final d(Landroid/util/SparseArray;)Ljava/util/List;
    ...
    .line 120
    invoke-static {p0}, Lcom/vk/core/extensions/v;->e(Landroid/util/SparseArray;)Ljava/lang/Iterable;
...
.method public static final e(Landroid/util/SparseArray;)Ljava/lang/Iterable;
    ...
    .line 131
    new-instance v0, Lcom/vk/core/extensions/v$b;

    invoke-direct {v0, p0}, Lcom/vk/core/extensions/v$b;-><init>(Landroid/util/SparseArray;)V
...
.method public static final f(Landroid/util/SparseArray;)Ljava/util/Iterator;
    ...
    .line 134
    new-instance v0, Lcom/vk/core/extensions/w;

    invoke-direct {v0, p0}, Lcom/vk/core/extensions/w;-><init>(Landroid/util/SparseArray;)V
...
.method public static final g(Landroid/util/SparseArray;)Ljava/util/Collection;
    ...
    .line 184
    new-instance v0, Lcom/vk/core/extensions/v$a;

    invoke-direct {v0, p0}, Lcom/vk/core/extensions/v$a;-><init>(Landroid/util/SparseArray;)V
...
.method public static final h(Landroid/util/SparseArray;)Ljava/util/Set;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/f/b;->add(Ljava/lang/Object;)Z
