...
.method public static final a(Ljava/util/Collection;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/vk/core/extensions/c$a;->get()Ljava/lang/Object;
...
.method public static final a(Landroid/support/v4/f/n;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-virtual {p0, v4}, Landroid/support/v4/f/n;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final a(Ljava/util/Collection;I)Ljava/util/List;
    ...
    invoke-direct {v2, p0, v3}, Lkotlin/e/d;-><init>(II)V

    check-cast v2, Lkotlin/e/b;

    invoke-static {v2, p1}, Lkotlin/e/e;->a(Lkotlin/e/b;I)Lkotlin/e/b;

    move-result-object p0

    invoke-virtual {p0}, Lkotlin/e/b;->a()I

    move-result v2

    invoke-virtual {p0}, Lkotlin/e/b;->b()I

    move-result v3

    invoke-virtual {p0}, Lkotlin/e/b;->c()I
...
.method public static final a(Ljava/util/Collection;Lkotlin/jvm/a/b;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static final a(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/f/b;->addAll(Ljava/util/Collection;)Z
...
.method public static final b(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Set;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/f/b;->removeAll(Ljava/util/Collection;)Z
...
.method public static final b(Ljava/util/Collection;Lkotlin/jvm/a/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
