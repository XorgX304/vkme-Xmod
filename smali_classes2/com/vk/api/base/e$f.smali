.class final Lcom/vk/api/base/e$f;
...
.field final synthetic b:Lcom/vk/api/base/f;


# direct methods
.method constructor <init>(Lcom/vk/api/base/e;Lcom/vk/api/base/f;)V
    .locals 0

    iput-object p1, p0, Lcom/vk/api/base/e$f;->a:Lcom/vk/api/base/e;

    iput-object p2, p0, Lcom/vk/api/base/e$f;->b:Lcom/vk/api/base/f;
...
.method public final a(Lio/reactivex/k;)V
    ...
    .line 146
    iget-object v0, p0, Lcom/vk/api/base/e$f;->b:Lcom/vk/api/base/f;

    invoke-virtual {v0, p1}, Lcom/vk/api/base/f;->a(Lio/reactivex/k;)V

    .line 149
    :try_start_0
    iget-object v0, p0, Lcom/vk/api/base/e$f;->a:Lcom/vk/api/base/e;

    invoke-virtual {v0}, Lcom/vk/api/base/e;->j()V

    .line 150
    iget-object v0, p0, Lcom/vk/api/base/e$f;->a:Lcom/vk/api/base/e;

    sget-object v1, Lcom/vk/api/base/c;->f:Lcom/vk/api/internal/b;
    ...
    invoke-virtual {v0, v1}, Lcom/vk/api/base/e;->b(Lcom/vk/api/sdk/f;)Ljava/lang/Object;
    ...
    .line 157
    :try_start_1
    iget-object v1, p0, Lcom/vk/api/base/e$f;->b:Lcom/vk/api/base/f;

    invoke-virtual {v1, p1}, Lcom/vk/api/base/f;->b(Lio/reactivex/k;)V
    ...
    iget-object v1, p0, Lcom/vk/api/base/e$f;->a:Lcom/vk/api/base/e;

    invoke-virtual {v1}, Lcom/vk/api/base/e;->v()Ljava/lang/String;
    ...
    sget v5, Lcom/vkontakte/android/api/o$a;->err_text:I
