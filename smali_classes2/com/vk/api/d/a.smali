.class public final Lcom/vk/api/d/a;
...
.method public constructor <init>(Ljava/lang/String;Lcom/vk/dto/discover/DiscoverIntent;)V
    ...
    iput-object p1, p0, Lcom/vk/api/d/a;->a:Ljava/lang/String;

    iput-object p2, p0, Lcom/vk/api/d/a;->b:Lcom/vk/dto/discover/DiscoverIntent;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/vk/api/d/a;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/e;

    .line 49
    iget-object p1, p0, Lcom/vk/api/d/a;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/vk/api/d/a;->a:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Lcom/vk/api/d/a;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/e;

    :cond_2
    const-string p1, "extended"

    .line 50
    invoke-virtual {p0, p1, p2}, Lcom/vk/api/d/a;->a(Ljava/lang/String;I)Lcom/vk/api/base/e;
    ...
    .line 54
    iget-object p1, p0, Lcom/vk/api/d/a;->b:Lcom/vk/dto/discover/DiscoverIntent;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/vk/api/d/a;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/e;
...
.method private final a(Landroid/util/SparseArray;Lorg/json/JSONArray;)Landroid/util/SparseArray;
    ...
    invoke-direct {v4, v3}, Lcom/vkontakte/android/UserProfile;-><init>(Lorg/json/JSONObject;)V
...
.method static synthetic a(Lcom/vk/api/d/a;Landroid/util/SparseArray;Lorg/json/JSONArray;ILjava/lang/Object;)Landroid/util/SparseArray;
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/vk/api/d/a;->a(Landroid/util/SparseArray;Lorg/json/JSONArray;)Landroid/util/SparseArray;
...
.method public static final synthetic a(Lcom/vk/api/d/a;Lorg/json/JSONArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)Ljava/util/ArrayList;
    .locals 0

    .line 37
    invoke-direct {p0, p1, p2, p3}, Lcom/vk/api/d/a;->a(Lorg/json/JSONArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)Ljava/util/ArrayList;
...
.method private final b(Landroid/util/SparseArray;Lorg/json/JSONArray;)Landroid/util/SparseArray;
    ...
    invoke-direct {v4, v3}, Lcom/vkontakte/android/api/models/Group;-><init>(Lorg/json/JSONObject;)V

    iget v3, v4, Lcom/vkontakte/android/api/models/Group;->a:I
...
.method static synthetic b(Lcom/vk/api/d/a;Landroid/util/SparseArray;Lorg/json/JSONArray;ILjava/lang/Object;)Landroid/util/SparseArray;
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/vk/api/d/a;->b(Landroid/util/SparseArray;Lorg/json/JSONArray;)Landroid/util/SparseArray;
...
.method public a(Lorg/json/JSONObject;)Lcom/vk/discover/DiscoverItemsResponse;
    ...
    :goto_0
    invoke-static {v0, v3, v4, v6, v3}, Lcom/vk/api/d/a;->a(Lcom/vk/api/d/a;Landroid/util/SparseArray;Lorg/json/JSONArray;ILjava/lang/Object;)Landroid/util/SparseArray;
    ...
    :goto_1
    invoke-static {v0, v3, v7, v6, v3}, Lcom/vk/api/d/a;->b(Lcom/vk/api/d/a;Landroid/util/SparseArray;Lorg/json/JSONArray;ILjava/lang/Object;)Landroid/util/SparseArray;
    ...
    check-cast v11, Lcom/vkontakte/android/api/models/Group;

    .line 74
    iget v12, v11, Lcom/vkontakte/android/api/models/Group;->a:I

    neg-int v12, v12

    new-instance v15, Lcom/vk/dto/newsfeed/Owner;

    iget v13, v11, Lcom/vkontakte/android/api/models/Group;->a:I

    neg-int v14, v13

    iget-object v13, v11, Lcom/vkontakte/android/api/models/Group;->b:Ljava/lang/String;

    iget-object v3, v11, Lcom/vkontakte/android/api/models/Group;->c:Ljava/lang/String;

    iget-object v2, v11, Lcom/vkontakte/android/api/models/Group;->p:Lcom/vk/dto/common/VerifyInfo;
    ...
    invoke-direct/range {v13 .. v20}, Lcom/vk/dto/newsfeed/Owner;-><init>(ILjava/lang/String;Ljava/lang/String;Lcom/vk/dto/common/VerifyInfo;Lcom/vk/dto/common/Image;ILkotlin/jvm/internal/h;)V

    invoke-static {v8, v12, v6}, Lcom/vk/core/extensions/v;->a(Landroid/util/SparseArray;ILjava/lang/Object;)V

    .line 75
    iget v2, v11, Lcom/vkontakte/android/api/models/Group;->a:I
    ...
    iget-boolean v3, v11, Lcom/vkontakte/android/api/models/Group;->e:Z
    ...
    .line 79
    iget v9, v6, Lcom/vkontakte/android/UserProfile;->n:I

    new-instance v15, Lcom/vk/dto/newsfeed/Owner;

    iget v11, v6, Lcom/vkontakte/android/UserProfile;->n:I

    iget-object v12, v6, Lcom/vkontakte/android/UserProfile;->p:Ljava/lang/String;

    iget-object v13, v6, Lcom/vkontakte/android/UserProfile;->r:Ljava/lang/String;

    iget-object v14, v6, Lcom/vkontakte/android/UserProfile;->G:Lcom/vk/dto/common/VerifyInfo;
    ...
    invoke-direct/range {v10 .. v17}, Lcom/vk/dto/newsfeed/Owner;-><init>(ILjava/lang/String;Ljava/lang/String;Lcom/vk/dto/common/VerifyInfo;Lcom/vk/dto/common/Image;ILkotlin/jvm/internal/h;)V

    invoke-static {v8, v9, v5}, Lcom/vk/core/extensions/v;->a(Landroid/util/SparseArray;ILjava/lang/Object;)V

    .line 80
    iget v5, v6, Lcom/vkontakte/android/UserProfile;->n:I
    ...
    new-instance v5, Lcom/vk/api/d/a$a;

    invoke-direct {v5, v0, v4, v7, v8}, Lcom/vk/api/d/a$a;-><init>(Lcom/vk/api/d/a;Landroid/util/SparseArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    check-cast v5, Lcom/vkontakte/android/data/f;

    invoke-direct {v3, v1, v5}, Lcom/vkontakte/android/data/VKList;-><init>(Lorg/json/JSONObject;Lcom/vkontakte/android/data/f;)V

    invoke-virtual {v2, v3}, Lcom/vk/discover/DiscoverLayoutParams$b;->a(Lcom/vkontakte/android/data/VKList;)Lcom/vkontakte/android/data/VKList;
    ...
    .line 145
    invoke-virtual {v1}, Lcom/vkontakte/android/data/VKList;->size()I
    ...
    .line 146
    invoke-virtual {v1, v4}, Lcom/vkontakte/android/data/VKList;->get(I)Ljava/lang/Object;
    ...
    .line 147
    invoke-virtual {v1, v6}, Lcom/vkontakte/android/data/VKList;->get(I)Ljava/lang/Object;
    ...
    .line 149
    iget-object v7, v0, Lcom/vk/api/d/a;->a:Ljava/lang/String;
...
.method public synthetic b(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 37
    invoke-virtual {p0, p1}, Lcom/vk/api/d/a;->a(Lorg/json/JSONObject;)Lcom/vk/discover/DiscoverItemsResponse;
