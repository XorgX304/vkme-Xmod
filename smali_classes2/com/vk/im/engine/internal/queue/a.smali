.class public final Lcom/vk/im/engine/internal/queue/a;
.super Ljava/lang/Object;
.source "QueueIdGenerator.kt"


# static fields
.field public static final a:Lcom/vk/im/engine/internal/queue/a;
...
.method static constructor <clinit>()V
    ...
    .line 15
    new-instance v0, Lcom/vk/im/engine/internal/queue/a;

    invoke-direct {v0}, Lcom/vk/im/engine/internal/queue/a;-><init>()V

    sput-object v0, Lcom/vk/im/engine/internal/queue/a;->a:Lcom/vk/im/engine/internal/queue/a;
...
.method private final a(Lcom/vk/im/engine/models/attaches/Attach;Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1}, Lcom/vk/im/engine/internal/queue/a;->a(Lcom/vk/im/engine/models/content/MoneyRequest;)Ljava/lang/String;
...
.method private final a(Lcom/vk/im/engine/models/dialogs/Dialog;Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/vk/im/engine/internal/queue/a;->a(Lcom/vk/im/engine/models/messages/g;Ljava/util/Set;)V
...
.method private final a(Lcom/vk/im/engine/models/messages/g;Ljava/util/Set;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, p2}, Lcom/vk/im/engine/internal/queue/a;->d(Ljava/util/Collection;Ljava/util/Set;)V

    .line 72
    :cond_0
    invoke-interface {p1}, Lcom/vk/im/engine/models/messages/g;->N()Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/vk/im/engine/internal/queue/a;->c(Ljava/util/Collection;Ljava/util/Set;)V
...
.method private final a(Ljava/util/Collection;Ljava/util/Set;)V
    ...
    .line 44
    sget-object v1, Lcom/vk/im/engine/internal/queue/a;->a:Lcom/vk/im/engine/internal/queue/a;

    invoke-direct {v1, v0, p2}, Lcom/vk/im/engine/internal/queue/a;->a(Lcom/vk/im/engine/models/dialogs/Dialog;Ljava/util/Set;)V
...
.method private final b(Ljava/util/Collection;Ljava/util/Set;)V
    ...
    invoke-direct {v1, v0, p2}, Lcom/vk/im/engine/internal/queue/a;->a(Lcom/vk/im/engine/models/messages/Msg;Ljava/util/Set;)V
...
.method private final c(Ljava/util/Collection;Ljava/util/Set;)V
    ...
    invoke-direct {v1, v0, p2}, Lcom/vk/im/engine/internal/queue/a;->a(Lcom/vk/im/engine/models/messages/g;Ljava/util/Set;)V
...
.method private final d(Ljava/util/Collection;Ljava/util/Set;)V
    ...
    invoke-direct {v1, v0, p2}, Lcom/vk/im/engine/internal/queue/a;->a(Lcom/vk/im/engine/models/attaches/Attach;Ljava/util/Set;)V
...
.method public final a(Ljava/util/Collection;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, v0}, Lcom/vk/im/engine/internal/queue/a;->a(Ljava/util/Collection;Ljava/util/Set;)V
...
.method public final b(Ljava/util/Collection;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, v0}, Lcom/vk/im/engine/internal/queue/a;->b(Ljava/util/Collection;Ljava/util/Set;)V
