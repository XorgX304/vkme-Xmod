...
.method private final a(Lcom/vk/im/engine/models/messages/g;Lcom/vk/im/engine/models/messages/g;)V
    .locals 10

    .line 36
    invoke-interface {p2}, Lcom/vk/im/engine/models/messages/g;->D()Ljava/util/List;
    ...
    invoke-direct {p0, p2, v4}, Lcom/vk/im/engine/internal/match/b;->a(Ljava/util/List;Lcom/vk/im/engine/models/attaches/AttachWithId;)Lcom/vk/im/engine/models/attaches/AttachWithId;
    ...
    invoke-virtual {v5, v4, v3}, Lcom/vk/im/engine/internal/match/a;->a(Lcom/vk/im/engine/models/attaches/AttachImage;Lcom/vk/im/engine/models/attaches/AttachImage;)Lcom/vk/im/engine/models/attaches/AttachImage;
    ...
    invoke-virtual {v5, v4, v3}, Lcom/vk/im/engine/internal/match/a;->a(Lcom/vk/im/engine/models/attaches/AttachVideo;Lcom/vk/im/engine/models/attaches/AttachVideo;)Lcom/vk/im/engine/models/attaches/AttachVideo;
    ...
    invoke-virtual {v5, v4, v3}, Lcom/vk/im/engine/internal/match/a;->a(Lcom/vk/im/engine/models/attaches/AttachDoc;Lcom/vk/im/engine/models/attaches/AttachDoc;)Lcom/vk/im/engine/models/attaches/AttachDoc;
    ...
    invoke-virtual {v5, v4, v3}, Lcom/vk/im/engine/internal/match/a;->a(Lcom/vk/im/engine/models/attaches/AttachAudioMsg;Lcom/vk/im/engine/models/attaches/AttachAudioMsg;)Lcom/vk/im/engine/models/attaches/AttachAudioMsg;
    ...
    invoke-virtual {v5, v4, v3}, Lcom/vk/im/engine/internal/match/a;->a(Lcom/vk/im/engine/models/attaches/AttachGraffiti;Lcom/vk/im/engine/models/attaches/AttachGraffiti;)Lcom/vk/im/engine/models/attaches/AttachGraffiti;
    ...
    sget-object v6, Lcom/vk/im/engine/internal/match/a;->a:Lcom/vk/im/engine/internal/match/a;

    const-string v8, "accessKey"

    invoke-static {v4, v8}, Lkotlin/jvm/internal/l;->a(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v6, v7, v3, v4}, Lcom/vk/im/engine/internal/match/a;->a(Lcom/vk/im/engine/models/attaches/AttachStory;Lcom/vk/im/engine/models/attaches/AttachLink;Ljava/lang/String;)Lcom/vk/im/engine/models/attaches/AttachStory;
...
# virtual methods
.method public final a(Lcom/vk/im/engine/g;Lcom/vk/im/engine/models/t;Lcom/vk/im/engine/models/t;)V
    .locals 1
    ...
    invoke-interface {p2, v0}, Lcom/vk/im/engine/models/t;->a(I)V

    .line 23
    instance-of v0, p2, Lcom/vk/im/engine/models/messages/g;

    if-eqz v0, :cond_1

    instance-of v0, p3, Lcom/vk/im/engine/models/messages/g;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/vk/im/engine/internal/match/b;->a(Lcom/vk/im/engine/g;Ljava/util/Collection;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/vk/im/engine/internal/match/b;->a(Lcom/vk/im/engine/g;Ljava/util/List;)V

    .line 30
    check-cast p3, Lcom/vk/im/engine/models/messages/g;

    invoke-direct {p0, p2, p3}, Lcom/vk/im/engine/internal/match/b;->a(Lcom/vk/im/engine/models/messages/g;Lcom/vk/im/engine/models/messages/g;)V
...
.method public final a(Lcom/vk/im/engine/g;Ljava/util/Collection;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final a(Lcom/vk/im/engine/g;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, p1, v2}, Lcom/vk/im/engine/internal/match/b;->a(Lcom/vk/im/engine/g;Ljava/util/Collection;)V
    ...
    invoke-virtual {v1, p1, v0}, Lcom/vk/im/engine/internal/match/b;->a(Lcom/vk/im/engine/g;Ljava/util/List;)V
