...
.method private final a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v0, p2}, Lcom/vk/im/engine/internal/c/c;->a(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    check-cast v0, Lcom/vk/im/engine/internal/a$a;

    invoke-direct {v0, p1, p2}, Lcom/vk/im/engine/internal/a$a;->a(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    check-cast p2, Lcom/vk/im/engine/internal/a$a;

    invoke-direct {p2, p1, v0}, Lcom/vk/im/engine/internal/a$a;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
...
.method public final a(Landroid/content/Context;Lcom/vk/im/engine/models/Member;Lcom/vk/im/engine/models/attaches/Attach;)Lcom/vk/im/engine/models/attaches/Attach;
    ...
    invoke-direct {v0, v2}, Lcom/vk/im/engine/models/attaches/AttachImage;-><init>(Lcom/vk/im/engine/models/attaches/AttachImage;)V
    ...
    .line 34
    invoke-virtual {v0}, Lcom/vk/im/engine/models/attaches/AttachImage;->i()Ljava/util/List;
    ...
    check-cast v3, Lcom/vk/im/engine/internal/a$a;

    invoke-virtual {v2}, Lcom/vk/im/engine/models/Image;->d()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v3, p1, v2}, Lcom/vk/im/engine/internal/a$a;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v2

    .line 36
    invoke-static {p1, v2}, Lcom/vk/im/engine/internal/c/b;->a(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/im/engine/internal/c/b$a;
    ...
    iget v5, p1, Lcom/vk/im/engine/internal/c/b$a;->a:I

    iget p1, p1, Lcom/vk/im/engine/internal/c/b$a;->b:I
    ...
    invoke-direct {v4, v5, p1, v2}, Lcom/vk/im/engine/models/Image;-><init>(IILjava/lang/String;)V
    ...
    invoke-direct {v3, p1, v4}, Lcom/vk/im/engine/internal/a$a;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v3

    .line 50
    invoke-static {p1, v3}, Lcom/vk/im/engine/internal/c/d;->a(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/im/engine/internal/c/d$a;
    ...
    .line 52
    new-array v2, v2, [Lcom/vk/im/engine/models/Image;

    new-instance v4, Lcom/vk/im/engine/models/Image;

    iget v5, p1, Lcom/vk/im/engine/internal/c/d$a;->a:I

    iget v6, p1, Lcom/vk/im/engine/internal/c/d$a;->b:I
    ...
    .line 65
    invoke-static {p1, v3}, Lcom/vk/im/engine/internal/c/a;->a(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/im/engine/internal/c/a$a;
    ...
    .line 67
    iget-object v4, p1, Lcom/vk/im/engine/internal/c/a$a;->a:Ljava/lang/String;
    ...
    .line 68
    iget v4, p1, Lcom/vk/im/engine/internal/c/a$a;->b:I

    invoke-virtual {v0, v4}, Lcom/vk/im/engine/models/attaches/AttachDoc;->d(I)V

    .line 69
    iget-object v4, p1, Lcom/vk/im/engine/internal/c/a$a;->c:Ljava/lang/String;
    ...
    .line 70
    iget-boolean v4, p1, Lcom/vk/im/engine/internal/c/a$a;->d:Z

    if-nez v4, :cond_6

    iget-boolean v4, p1, Lcom/vk/im/engine/internal/c/a$a;->e:Z
    ...
    invoke-virtual {v0, v4}, Lcom/vk/im/engine/models/attaches/AttachDoc;->c(Ljava/util/List;)V
    ...
    :cond_6
    :goto_0
    new-array v4, v2, [Lcom/vk/im/engine/models/Image;
    ...
    invoke-direct {v5, v6, v7, v8}, Lcom/vk/im/engine/models/Image;-><init>(IILjava/lang/String;)V
    ...
    .line 77
    iget v5, p1, Lcom/vk/im/engine/internal/c/a$a;->f:I

    invoke-virtual {v4, v5}, Lcom/vk/im/engine/models/VideoPreview;->a(I)V

    .line 78
    iget v5, p1, Lcom/vk/im/engine/internal/c/a$a;->g:I

    invoke-virtual {v4, v5}, Lcom/vk/im/engine/models/VideoPreview;->b(I)V

    .line 79
    iget p1, p1, Lcom/vk/im/engine/internal/c/a$a;->b:I
    ...
    .line 81
    new-array p1, v2, [Lcom/vk/im/engine/models/VideoPreview;
    ...
    invoke-direct {v0, v2}, Lcom/vk/im/engine/models/attaches/AttachAudioMsg;-><init>(Lcom/vk/im/engine/models/attaches/AttachAudioMsg;)V
    ...
    invoke-direct {v2, p1, v3}, Lcom/vk/im/engine/internal/a$a;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v2

    .line 94
    invoke-static {p1, v2}, Lcom/vk/im/engine/internal/c/a;->a(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/im/engine/internal/c/a$a;
    ...
    iget-object p1, p1, Lcom/vk/im/engine/internal/c/a$a;->c:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/vk/im/engine/models/attaches/AttachGraffiti;->g()Ljava/util/List;
    ...
    .line 108
    invoke-static {p1, v3}, Lcom/vk/im/engine/internal/c/b;->a(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/im/engine/internal/c/b$a;
    ...
    invoke-direct {v4, v5, p1, v3}, Lcom/vk/im/engine/models/Image;-><init>(IILjava/lang/String;)V
    ...
    .line 137
    :goto_3
    instance-of p1, p3, Lcom/vk/im/engine/models/t;
    ...
    :cond_1e
    check-cast p3, Lcom/vk/im/engine/models/t;

    if-eqz p3, :cond_1f

    invoke-interface {p3}, Lcom/vk/im/engine/models/t;->b()I
