.class public final Lcom/vk/im/engine/commands/etc/i;
...
.method public constructor <init>(Lcom/vk/dto/polls/Poll;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    iput-object p2, p0, Lcom/vk/im/engine/commands/etc/i;->b:Ljava/lang/Object;

    return-void
.end method

.method private final a(Ljava/util/List;)Lcom/vk/im/engine/events/af;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 91
    :cond_1
    new-instance p1, Lcom/vk/im/engine/events/af;

    iget-object v1, p0, Lcom/vk/im/engine/commands/etc/i;->b:Ljava/lang/Object;

    invoke-direct {p1, v1, v0}, Lcom/vk/im/engine/events/af;-><init>(Ljava/lang/Object;Landroid/util/SparseArray;)V
...
.method private final a(Lcom/vk/im/engine/g;Lcom/vk/dto/polls/Poll;)V
    .locals 5
    ...
    invoke-direct {v1, p2, v2}, Lcom/vk/im/engine/commands/g/a;-><init>(Lcom/vk/im/engine/utils/collection/d;Lcom/vk/im/engine/models/Source;)V
    ...
    invoke-virtual {v2}, Lcom/vk/im/engine/models/users/User;->v()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2}, Lcom/vk/im/engine/models/users/User;->D()Lcom/vk/im/engine/models/ImageList;
...
.method public synthetic a(Lcom/vk/im/engine/g;)Ljava/lang/Object;
    ...
    .line 25
    invoke-virtual {p0, p1}, Lcom/vk/im/engine/commands/etc/i;->b(Lcom/vk/im/engine/g;)Ljava/lang/Boolean;
...
.method public b(Lcom/vk/im/engine/g;)Ljava/lang/Boolean;
    ...
    iget-object v3, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    invoke-virtual {v3}, Lcom/vk/dto/polls/Poll;->n()I

    move-result v3

    iget-object v4, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    invoke-virtual {v4}, Lcom/vk/dto/polls/Poll;->o()I

    move-result v4

    invoke-virtual {v0, v2, v3, v4}, Lcom/vk/im/engine/internal/storage/delegates/dialogs/e;->a(Ljava/lang/Class;II)Landroid/util/SparseArray;
    ...
    iget-object v5, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    invoke-virtual {v5}, Lcom/vk/dto/polls/Poll;->o()I

    move-result v5

    invoke-virtual {v1, v3, v4, v5}, Lcom/vk/im/engine/internal/storage/delegates/messages/entry/a;->a(Ljava/lang/Class;II)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v4}, Lcom/vk/im/engine/commands/etc/i;->a(Lcom/vk/im/engine/g;Lcom/vk/dto/polls/Poll;)V

    .line 40
    iget-object v4, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    invoke-direct {p0, v4}, Lcom/vk/im/engine/commands/etc/i;->a(Lcom/vk/dto/polls/Poll;)Lkotlin/jvm/a/b;

    move-result-object v4

    .line 41
    iget-object v6, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    invoke-direct {p0, v6}, Lcom/vk/im/engine/commands/etc/i;->b(Lcom/vk/dto/polls/Poll;)Lkotlin/jvm/a/b;
    ...
    .line 43
    invoke-virtual {v9, v8, v4, v6}, Lcom/vk/im/engine/models/messages/PinnedMsg;->a(ZLkotlin/jvm/a/b;Lkotlin/jvm/a/b;)V
    ...
    .line 47
    invoke-virtual {v7, v8, v4, v6}, Lcom/vk/im/engine/models/messages/MsgFromUser;->a(ZLkotlin/jvm/a/b;Lkotlin/jvm/a/b;)V
    ...
    new-instance v5, Lcom/vk/im/engine/commands/etc/i$a;

    invoke-direct {v5, v0, v2, v1, v3}, Lcom/vk/im/engine/commands/etc/i$a;-><init>(Lcom/vk/im/engine/internal/storage/delegates/dialogs/e;Landroid/util/SparseArray;Lcom/vk/im/engine/internal/storage/delegates/messages/entry/a;Ljava/util/List;)V

    check-cast v5, Lcom/vk/im/engine/internal/storage/h;

    invoke-virtual {v4, v5}, Lcom/vk/im/engine/internal/storage/d;->a(Lcom/vk/im/engine/internal/storage/h;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Lcom/vk/im/engine/utils/collection/e;->a(Landroid/util/SparseArray;)Lcom/vk/im/engine/utils/collection/h;
    ...
    .line 58
    invoke-direct {p0, v3}, Lcom/vk/im/engine/commands/etc/i;->a(Ljava/util/List;)Lcom/vk/im/engine/events/af;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v0, Lcom/vk/im/engine/commands/etc/i;
    ...
    .line 96
    :cond_0
    instance-of v0, p1, Lcom/vk/im/engine/commands/etc/i;
    ...
    .line 97
    :cond_1
    iget-object v0, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;

    check-cast p1, Lcom/vk/im/engine/commands/etc/i;

    iget-object p1, p1, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/vk/im/engine/commands/etc/i;->a:Lcom/vk/dto/polls/Poll;
