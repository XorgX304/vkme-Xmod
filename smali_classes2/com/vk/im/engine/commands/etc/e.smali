...
# static fields
.field public static final a:Lcom/vk/im/engine/commands/etc/e$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/vk/im/engine/commands/etc/e$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/vk/im/engine/commands/etc/e$a;-><init>(Lkotlin/jvm/internal/h;)V

    sput-object v0, Lcom/vk/im/engine/commands/etc/e;->a:Lcom/vk/im/engine/commands/etc/e$a;
    ...
    sput-object v0, Lcom/vk/im/engine/commands/etc/e;->e:Landroid/util/SparseLongArray;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v0, v1, v0}, Lcom/vk/im/engine/commands/etc/e;-><init>(Ljava/util/Collection;Ljava/util/Collection;ILkotlin/jvm/internal/h;)V
...
.method public constructor <init>(Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    iput-object p1, p0, Lcom/vk/im/engine/commands/etc/e;->b:Ljava/util/Collection;

    iput-object p2, p0, Lcom/vk/im/engine/commands/etc/e;->c:Ljava/util/Collection;
...
.method public synthetic constructor <init>(Ljava/util/Collection;Ljava/util/Collection;ILkotlin/jvm/internal/h;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/vk/im/engine/commands/etc/e;-><init>(Ljava/util/Collection;Ljava/util/Collection;)V

    return-void
.end method

.method public static final synthetic a(Lcom/vk/im/engine/commands/etc/e;Lcom/vk/im/engine/models/messages/g;)Lkotlin/sequences/i;
    .locals 0

    .line 18
    invoke-direct {p0, p1}, Lcom/vk/im/engine/commands/etc/e;->a(Lcom/vk/im/engine/models/messages/g;)Lkotlin/sequences/i;
...
.method private final a(Lcom/vk/im/engine/models/messages/g;)Lkotlin/sequences/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0}, Lcom/vk/im/engine/commands/etc/NotifyContentVisibleViaBgCmd$yieldAttaches$1;-><init>(Lcom/vk/im/engine/commands/etc/e;)V
...
.method private final c(Lcom/vk/im/engine/g;)V
    ...
    .line 35
    iget-object v0, p0, Lcom/vk/im/engine/commands/etc/e;->c:Ljava/util/Collection;
    ...
    .line 36
    const-class v1, Lcom/vk/im/engine/models/messages/g;
    ...
    invoke-direct {v1, p0}, Lcom/vk/im/engine/commands/etc/NotifyContentVisibleViaBgCmd$updatePollsIfNeeded$2;-><init>(Lcom/vk/im/engine/commands/etc/e;)V
    ...
    .line 42
    sget-object v2, Lcom/vk/im/engine/commands/etc/e;->e:Landroid/util/SparseLongArray;
    ...
    invoke-virtual {v2}, Lcom/vk/im/engine/b;->o()J
    ...
    .line 47
    new-instance v2, Lcom/vk/im/engine/commands/etc/d;
    ...
    sget-object v4, Lcom/vk/im/engine/commands/etc/e;->d:Ljava/lang/String;

    invoke-direct {v2, v1, v3, v4}, Lcom/vk/im/engine/commands/etc/d;-><init>(Lcom/vk/dto/polls/Poll;ZLjava/lang/Object;)V
...
.method public synthetic a(Lcom/vk/im/engine/g;)Ljava/lang/Object;
    ...
    .line 18
    invoke-virtual {p0, p1}, Lcom/vk/im/engine/commands/etc/e;->b(Lcom/vk/im/engine/g;)Ljava/lang/Boolean;
...
.method public b(Lcom/vk/im/engine/g;)Ljava/lang/Boolean;
    ...
    .line 27
    invoke-interface {p1}, Lcom/vk/im/engine/g;->l()Lcom/vk/im/engine/internal/queue/c;

    move-result-object v0

    iget-object v1, p0, Lcom/vk/im/engine/commands/etc/e;->b:Ljava/util/Collection;

    invoke-virtual {v0, v1}, Lcom/vk/im/engine/internal/queue/c;->a(Ljava/util/Collection;)V
    ...
    iget-object v1, p0, Lcom/vk/im/engine/commands/etc/e;->c:Ljava/util/Collection;

    invoke-virtual {v0, v1}, Lcom/vk/im/engine/internal/queue/c;->b(Ljava/util/Collection;)V

    .line 30
    invoke-direct {p0, p1}, Lcom/vk/im/engine/commands/etc/e;->c(Lcom/vk/im/engine/g;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v0, Lcom/vk/im/engine/commands/etc/e;
    ...
    .line 59
    :cond_1
    iget-object v0, p0, Lcom/vk/im/engine/commands/etc/e;->b:Ljava/util/Collection;

    check-cast p1, Lcom/vk/im/engine/commands/etc/e;

    iget-object v3, p1, Lcom/vk/im/engine/commands/etc/e;->b:Ljava/util/Collection;
    ...
    iget-object p1, p1, Lcom/vk/im/engine/commands/etc/e;->c:Ljava/util/Collection;
