.class public final Lcom/vk/im/bridge/im/a;
...
# static fields
.field public static final a:Lcom/vk/im/bridge/im/a;
...
.method static constructor <clinit>()V
    ...
    .line 46
    new-instance v0, Lcom/vk/im/bridge/im/a;

    invoke-direct {v0}, Lcom/vk/im/bridge/im/a;-><init>()V

    sput-object v0, Lcom/vk/im/bridge/im/a;->a:Lcom/vk/im/bridge/im/a;
...
.method private final a(Lcom/vk/cameraui/entities/CameraPhotoParameters;)Lcom/vk/im/engine/models/camera/PhotoParams;
    .locals 1
...
.method private final a(Lcom/vk/dto/stories/model/StoryUploadParams;)Lcom/vk/im/engine/models/camera/UploadParams;
    .locals 9
    ...
    .line 290
    invoke-direct/range {v0 .. v7}, Lcom/vk/im/engine/models/camera/UploadParams;-><init>(Ljava/lang/String;ILandroid/location/Location;ZLjava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;)V

    return-object v8
.end method

.method private final a(Lcom/vk/cameraui/entities/CameraVideoParameters;)Lcom/vk/im/engine/models/camera/VideoParams;
    .locals 9

    if-eqz p1, :cond_0

    .line 276
    new-instance v8, Lcom/vk/im/engine/models/camera/VideoParams;
    ...
    .line 276
    invoke-direct/range {v0 .. v7}, Lcom/vk/im/engine/models/camera/VideoParams;-><init>(Ljava/io/File;ILjava/io/File;ZZFI)V
...
.method private final a(Landroid/content/Context;Lcom/vk/im/engine/models/attaches/Attach;)V
    .locals 4

    .line 99
    invoke-interface {p2}, Lcom/vk/im/engine/models/attaches/Attach;->e()Ljava/lang/String;
...
.method public static synthetic a(Lcom/vk/im/bridge/im/a;Landroid/content/Context;Ljava/lang/String;ZLkotlin/jvm/a/a;ILjava/lang/Object;)Z
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/vk/im/bridge/im/a;->a(Landroid/content/Context;Ljava/lang/String;ZLkotlin/jvm/a/a;)Z
...
.method public a(Landroid/content/Intent;)Lcom/vk/im/engine/models/camera/PhotoParams;
    ...
    invoke-direct {p0, p1}, Lcom/vk/im/bridge/im/a;->a(Lcom/vk/cameraui/entities/CameraPhotoParameters;)Lcom/vk/im/engine/models/camera/PhotoParams;
...
.method public a(Landroid/app/Activity;Lkotlin/jvm/a/a;Lkotlin/jvm/a/a;)V
    ...
    .line 320
    new-instance v0, Lcom/vk/im/bridge/im/AppImActionBridge$requestPhotoVideoPermission$1;

    invoke-direct {v0, p3}, Lcom/vk/im/bridge/im/AppImActionBridge$requestPhotoVideoPermission$1;-><init>(Lkotlin/jvm/a/a;)V
...
.method public a(Landroid/content/Context;Lcom/vk/im/engine/models/attaches/Attach;Lcom/vk/im/engine/models/messages/g;)V
    ...
    .line 76
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachAudio;
    ...
    .line 77
    :cond_0
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachAudioMsg;
    ...
    .line 78
    :cond_1
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachGraffiti;
    ...
    .line 79
    :cond_2
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachStory;

    if-eqz v1, :cond_3

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachStory;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachStory;)V

    goto/16 :goto_0

    .line 80
    :cond_3
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachVideo;

    if-eqz v1, :cond_4

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachVideo;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachVideo;)V

    goto/16 :goto_0

    .line 81
    :cond_4
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachArticle;

    if-eqz v1, :cond_5

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachArticle;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachArticle;)V

    goto/16 :goto_0

    .line 82
    :cond_5
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachMap;

    if-eqz v1, :cond_6

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachMap;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachMap;)V

    goto/16 :goto_0

    .line 83
    :cond_6
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachLink;
    ...
    invoke-virtual {p2}, Lcom/vk/im/engine/models/attaches/AttachLink;->j()Lcom/vk/im/engine/models/attaches/AMP;

    move-result-object p3

    if-eqz p3, :cond_7

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachLink;)V

    goto :goto_0

    .line 85
    :cond_7
    sget-object p3, Lcom/vk/im/bridge/im/a;->a:Lcom/vk/im/bridge/im/a;

    invoke-virtual {p2}, Lcom/vk/im/engine/models/attaches/AttachLink;->a()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p3, p1, p2}, Lcom/vk/im/bridge/im/a;->b(Landroid/content/Context;Ljava/lang/String;)V

    goto :goto_0

    .line 87
    :cond_8
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachMoneyTransfer;

    if-eqz v1, :cond_9

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachMoneyTransfer;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachMoneyTransfer;)V

    goto :goto_0

    .line 88
    :cond_9
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachSticker;

    if-eqz v1, :cond_a

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachSticker;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachSticker;)V

    goto :goto_0

    .line 89
    :cond_a
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachGiftSimple;

    if-eqz v1, :cond_b

    sget-object p2, Lcom/vk/im/bridge/im/a;->a:Lcom/vk/im/bridge/im/a;

    const-string p3, "https://vk.com/gifts"

    invoke-virtual {p2, p1, p3}, Lcom/vk/im/bridge/im/a;->b(Landroid/content/Context;Ljava/lang/String;)V

    goto :goto_0

    .line 90
    :cond_b
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachPoll;

    if-eqz v1, :cond_c

    check-cast p2, Lcom/vk/im/engine/models/attaches/AttachPoll;

    invoke-virtual {v0, p2}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachPoll;)V

    goto :goto_0

    .line 91
    :cond_c
    instance-of v1, p2, Lcom/vk/im/engine/models/attaches/AttachMoneyRequest;
    ...
    invoke-virtual {v0, p2, p3}, Lcom/vkontakte/android/im/h;->a(Lcom/vk/im/engine/models/attaches/AttachMoneyRequest;Lcom/vk/im/engine/models/messages/g;)V

    goto :goto_0

    .line 92
    :cond_d
    instance-of p3, p2, Lcom/vk/im/engine/models/attaches/AttachUnsupported;
    ...
    invoke-direct {p3, p1, p2}, Lcom/vk/im/bridge/im/a;->a(Landroid/content/Context;Lcom/vk/im/engine/models/attaches/Attach;)V
...
.method public a(Landroid/content/Context;Lcom/vk/im/ui/a/a$c;)V
    ...
    .line 57
    new-instance v0, Lcom/vk/im/bridge/im/AppImActionBridge$openGallery$1;

    invoke-direct {v0, p1, p2}, Lcom/vk/im/bridge/im/AppImActionBridge$openGallery$1;-><init>(Landroid/content/Context;Lcom/vk/im/ui/a/a$c;)V
...
.method public a(Lcom/vk/navigation/a;Lcom/vk/im/engine/models/camera/CameraState;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
    ...
    .line 223
    sget-object v4, Lcom/vk/im/bridge/im/b;->$EnumSwitchMapping$0:[I

    invoke-virtual/range {p2 .. p2}, Lcom/vk/im/engine/models/camera/CameraState;->ordinal()I
    ...
    invoke-virtual {v2}, Lcom/vk/im/ui/a/f$a;->a()Landroid/content/ComponentName;
...
.method public a(Lcom/vk/navigation/a;Lkotlin/jvm/a/a;)V
    ...
    .line 203
    new-instance p2, Lcom/vk/im/bridge/im/AppImActionBridge$openSystemCamera$1;

    invoke-direct {p2, v1, p1}, Lcom/vk/im/bridge/im/AppImActionBridge$openSystemCamera$1;-><init>(Landroid/content/Context;Lcom/vk/navigation/a;)V
...
.method public final a(Landroid/content/Context;Ljava/lang/String;ZLkotlin/jvm/a/a;)Z
    ...
    new-instance p3, Lcom/vk/im/bridge/im/a$a;

    invoke-direct {p3, v0, p4, p1, p2}, Lcom/vk/im/bridge/im/a$a;-><init>(Ljava/lang/String;Lkotlin/jvm/a/a;Landroid/content/Context;Ljava/lang/String;)V
...
.method public b(Landroid/content/Intent;)Lcom/vk/im/engine/models/camera/VideoParams;
    ...
    invoke-direct {p0, p1}, Lcom/vk/im/bridge/im/a;->a(Lcom/vk/cameraui/entities/CameraVideoParameters;)Lcom/vk/im/engine/models/camera/VideoParams;
...
.method public b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 110
    invoke-static/range {v1 .. v7}, Lcom/vk/im/bridge/im/a;->a(Lcom/vk/im/bridge/im/a;Landroid/content/Context;Ljava/lang/String;ZLkotlin/jvm/a/a;ILjava/lang/Object;)Z
...
.method public c(Landroid/content/Intent;)Lcom/vk/im/engine/models/camera/StoryParams;
    ...
    .line 267
    sget-object v1, Lcom/vk/im/bridge/im/a;->a:Lcom/vk/im/bridge/im/a;

    invoke-virtual {p1}, Lcom/vk/cameraui/entities/CameraStoryParams;->a()Lcom/vk/cameraui/entities/CameraVideoParameters;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/vk/im/bridge/im/a;->a(Lcom/vk/cameraui/entities/CameraVideoParameters;)Lcom/vk/im/engine/models/camera/VideoParams;
    ...
    invoke-direct {v2, v3}, Lcom/vk/im/bridge/im/a;->a(Lcom/vk/cameraui/entities/CameraPhotoParameters;)Lcom/vk/im/engine/models/camera/PhotoParams;

    move-result-object v2

    .line 269
    sget-object v3, Lcom/vk/im/bridge/im/a;->a:Lcom/vk/im/bridge/im/a;
    ...
    :cond_0
    invoke-direct {v3, p1}, Lcom/vk/im/bridge/im/a;->a(Lcom/vk/dto/stories/model/StoryUploadParams;)Lcom/vk/im/engine/models/camera/UploadParams;

    move-result-object p1

    .line 266
    invoke-direct {v0, v1, v2, p1}, Lcom/vk/im/engine/models/camera/StoryParams;-><init>(Lcom/vk/im/engine/models/camera/VideoParams;Lcom/vk/im/engine/models/camera/PhotoParams;Lcom/vk/im/engine/models/camera/UploadParams;)V
