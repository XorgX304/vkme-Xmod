.class public final Lcom/vk/messenger/engine/utils/o;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vk/messenger/engine/utils/o$a;
    }
.end annotation


# static fields
.field public static final a:Lcom/vk/messenger/engine/utils/o;
...
.method static constructor <clinit>()V
    ...
    .line 18
    new-instance v0, Lcom/vk/messenger/engine/utils/o;

    invoke-direct {v0}, Lcom/vk/messenger/engine/utils/o;-><init>()V

    sput-object v0, Lcom/vk/messenger/engine/utils/o;->a:Lcom/vk/messenger/engine/utils/o;
...
.method private final f(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/Integer;
    ...
    invoke-static {v1, v2}, Lcom/vk/core/sqlite/b;->b(Landroid/database/Cursor;I)Ljava/lang/Integer;
    ...
    invoke-direct {p0, p1, p2}, Lcom/vk/messenger/engine/utils/o;->g(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/Integer;
...
.method private final g(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/Integer;
    ...
    .line 78
    :try_start_0
    new-instance p1, Landroid/support/e/a;

    invoke-virtual {p2}, Landroid/net/Uri;->getPath()Ljava/lang/String;

    move-result-object p2

    invoke-direct {p1, p2}, Landroid/support/e/a;-><init>(Ljava/lang/String;)V
    ...
    .line 79
    invoke-virtual {p1, p2, v0}, Landroid/support/e/a;->a(Ljava/lang/String;I)I
...
.method public final a(Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    .line 111
    invoke-virtual {p0, p1, p2}, Lcom/vk/messenger/engine/utils/o;->b(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/messenger/engine/utils/o$a;

    move-result-object v0

    .line 112
    invoke-virtual {v0}, Lcom/vk/messenger/engine/utils/o$a;->a()I

    move-result v1

    if-gt v1, p3, :cond_0

    invoke-virtual {v0}, Lcom/vk/messenger/engine/utils/o$a;->b()I
    ...
    .line 113
    invoke-virtual {p0, p1, p2}, Lcom/vk/messenger/engine/utils/o;->e(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    .line 117
    invoke-virtual {p0, p1, p2}, Lcom/vk/messenger/engine/utils/o;->a(Landroid/content/Context;Landroid/net/Uri;)Landroid/content/res/AssetFileDescriptor;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 96
    invoke-virtual {v0, p3}, Landroid/support/e/a;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p3, v1}, Landroid/support/e/a;->a(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 100
    :cond_1
    invoke-virtual {p1}, Landroid/support/e/a;->a()V

    return-void
.end method

.method public final b(Landroid/content/Context;Landroid/net/Uri;)Lcom/vk/messenger/engine/utils/o$a;
    .locals 4
    ...
    .line 34
    :cond_0
    new-instance p2, Lcom/vk/messenger/engine/utils/o$a;

    iget v1, v2, Landroid/graphics/BitmapFactory$Options;->outWidth:I

    iget v2, v2, Landroid/graphics/BitmapFactory$Options;->outHeight:I

    invoke-direct {p2, v1, v2}, Lcom/vk/messenger/engine/utils/o$a;-><init>(II)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    :try_start_1
    new-instance p2, Lcom/vk/messenger/engine/exceptions/FileFormatException;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Unable to decode image. Fount size is "
    ...
    invoke-direct {p2, v1}, Lcom/vk/messenger/engine/exceptions/FileFormatException;-><init>(Ljava/lang/String;)V
...
.method public final c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p2, v1, v3}, Lkotlin/text/l;->c(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method public final d(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 50
    invoke-direct {p0, p1, p2}, Lcom/vk/messenger/engine/utils/o;->f(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/Integer;
